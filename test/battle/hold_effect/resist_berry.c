...
static const u16 sMoveItemTable[][4] =
{
    ...
    { TYPE_FLYING,   MOVE_WING_ATTACK,     ITEM_COBA_BERRY,   SPECIES_KRICKETUNE },
    ...
    { TYPE_STEEL,    MOVE_METAL_CLAW,      ITEM_BABIRI_BERRY, SPECIES_REGICE },
    { TYPE_FIRE,     MOVE_EMBER,           ITEM_OCCA_BERRY,   SPECIES_GOGOAT },
    { TYPE_WATER,    MOVE_WATER_GUN,       ITEM_PASSHO_BERRY, SPECIES_RAMPARDOS },
    { TYPE_GRASS,    MOVE_VINE_WHIP,       ITEM_RINDO_BERRY,  SPECIES_DIGLETT },
    { TYPE_ELECTRIC, MOVE_THUNDER_SHOCK,   ITEM_WACAN_BERRY,  SPECIES_PSYDUCK },
    ...
    // { TYPE_DRAGON,   MOVE_DRAGON_BREATH,   ITEM_HABAN_BERRY,  SPECIES_WOBBUFFET },
    { TYPE_DARK,     MOVE_CRUNCH,          ITEM_COLBUR_BERRY, SPECIES_WOBBUFFET },
...
SINGLE_BATTLE_TEST("Weakness berries decrease the base power of moves by half", s16 damage)
{
    ...
    GIVEN {
        ...
        if (type != TYPE_NORMAL && type != TYPE_DRAGON) {
