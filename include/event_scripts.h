...
extern const u8 Common_Movement_CreepUp[];
extern const u8 Common_Movement_CreepDown[];
extern const u8 Common_Movement_CreepRight[];
extern const u8 Common_Movement_CreepLeft[];
...
extern const u8 Common_Movement_SprintUp[];
extern const u8 Common_Movement_SprintDown[];
extern const u8 Common_Movement_SprintRight[];
extern const u8 Common_Movement_SprintLeft[];
