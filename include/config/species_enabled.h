...
#define P_PROMISE_POKEMON                TRUE // New Original Pokemon
...
// New settings
#define P_DISABLE_CERTAIN_FAMILY_MEMBERS TRUE  // Disables certain evos and pre-evos for Divergent Emerald
#define P_MEGA_TO_EVOLUTION              TRUE  // Determines wheether certain Mega are turned into evolutions
...
#define P_FAMILY_GRAFAIAI                P_PROMISE_POKEMON
