...
#define WE_FLAG_NO_ENCOUNTER        FLAG_DISABLE_ENCOUNTERS       // If this flag is set, wild encounters will be disabled.

// Double Wild Battles
#define WE_DOUBLE_WILD_CHANCE            6          // % chance of encountering two Pokémon in a Wild Encounter.
...
// Wild Battle Flags
#define WE_FLAG_FORCE_DOUBLE_WILD    FLAG_FORCE_DOUBLE_WILD     // If this flag is set, all land and surfing wild battles will be double battles.
#define WE_SMART_WILD_AI_FLAG        FLAG_SMART_WILD_MON     // If this flag is set, wild Pokémon will become smart, with all AI flags enabled.
#define WE_FLAG_NO_CATCHING          FLAG_NO_CATCHING     // If this flag is set, the ability to catch wild Pokémon is disabled.
#define WE_FLAG_NO_RUNNING           FLAG_NO_RUNNING     // If this flag is set, the ability to escape from wild battles is disabled. Also makes Roar/Whirlwind and Teleport (under Gen8) fail.
