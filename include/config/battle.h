...
#define B_ABSORBING_ABILITY_STRING  GEN_4 // In Gen5+, the abilities that absorb moves of a certain type use a generic string for stat increases and decreases.
...
#define B_STEAL_WILD_ITEMS          GEN_7 // In Gen9, Thief and Covet steal a wild pokemon's item and send it to the bag. Before Gen9, the stolen item would be held by the Thief/Covet user.
...
#define B_SMART_WILD_AI_FLAG        FLAG_SMART_WILD_MON     // If this flag is set, wild Pokémon will become smart, with all AI flags enabled.
...
// Other settings
#define B_DOUBLE_WILD_CHANCE            6          // % chance of encountering two Pokémon in a Wild Encounter.
