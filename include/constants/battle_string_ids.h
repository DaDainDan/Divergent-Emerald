...
enum StringID
{
    ...
    STRINGID_PKMNCUTHPMAXEDSTAT,
    STRINGID_PKMNCUTHPMINIMIZEDSTAT,
    STRINGID_PKMNREMOVEDPARTSMAXEDSTAT,
    STRINGID_PKMNREMOVEDPARTSMINIMIZEDSTAT,
    ...
    STRINGID_BUGGYTERRAINENDS,
    STRINGID_FAULTYTERRAINENDS,
    STRINGID_SPOOKYTERRAINENDS,
    ...
    STRINGID_DEFENDERACQUIREDABILITY,
    ...
    STRINGID_TERRAINBECOMESBUGGY,
    STRINGID_TERRAINBECOMESFAULTY,
    STRINGID_TERRAINBECOMESSPOOKY,
    ...
    STRINGID_SUPERCRITONDEF,
    STRINGID_S,
    STRINGID_LOSTSOMEOFITSHP,
    STRINGID_BELCHCANTUSE,
    STRINGID_METALLICENTERS,
    STRINGID_WICKEDENTERS,
    STRINGID_DRACONICENTERS,
    STRINGID_TECTONICENTERS,
    STRINGID_PURITYENTERS,
    STRINGID_VENOMOUSENTERS,
    STRINGID_AQUATICENTERS,
    STRINGID_COLDHEARTENTERS,
    STRINGID_STAKEOUTENTERS,
    STRINGID_PKMNHURTSITSELF,
    STRINGID_KUSANAGIENTERS,
    STRINGID_SUNLIGHTMELTING,
    STRINGID_PKMNREINFORCEDWITHSAND,
    STRINGID_PKMNNOURISHEDBYRAIN,
    STRINGID_PKMNREINFORCEDWITHSNOW,
    STRINGID_PKMNABSORBEDSUNLIGHT,
    STRINGID_VICTORYAURA,
    STRINGID_PKMNFROSTBITTENBY,
    STRINGID_COSMICENTERS,
    STRINGID_PKMNHURTSTARGET,
    STRINGID_PKMNSTATSCANTCHANGE,
    STRINGID_USERSTATCHANGESGONE,
    STRINGID_PKMNHEALCLEARSTATS,
    STRINGID_PKMNTRAPPEDINSWARM,
    STRINGID_PKMNRAMPAGES,
    STRINGID_PKMNRAMPAGECONTINUES,
    STRINGID_ITEMDISABLESSLOT4,
    STRINGID_SUPPORTVESTDOESNTALLOW,
    STRINGID_ITEMPREVENTSLOVE,
    STRINGID_ITEMPREVENTSFLINCHING,
    STRINGID_FINELENSBROKEN,
    STRINGID_PREDICTSATTACK,
    STRINGID_PKMNRAISEDBOTHDEFS,
    STRINGID_PKMNLOSTMEMORY,
    STRINGID_BADDREAMSENTERS,
    STRINGID_STRONGWINDSPREVENT, 
    STRINGID_PREPAREDFORATTACK,
    STRINGID_USERBADSTATSGONE,
    STRINGID_TARGETGOODSTATSGONE,
    STRINGID_PKMNNASTYPLOT,
    STRINGID_PKMNSPATKCRITUP,
    STRINGID_PKMNATKCRITUP,
    STRINGID_PKMNHONEEDGE,
    STRINGID_GAINEDVEILOFWATER,
    STRINGID_WATERVEILBURNPREVENTION,
    STRINGID_CANTBURNUNDERWATER,
    STRINGID_PKMNTAKESMOREDAMAGE,
    STRINGID_PKMNSWAPPEDSTATCHANGES,
    STRINGID_PKMNTURNWORLDUPSIDEDOWN,
    STRINGID_PKMNMELTEDBYTENTACLES,
    STRINGID_PKMNSTORINGWATER,
    STRINGID_REVEALPKMNITEM,
    STRINGID_PKMNWASCURSED,
    STRINGID_PKMNCURSEDBY,
    STRINGID_PKMNSITEMCUREDCURSE,
    STRINGID_PKMNISFROSTBITTEN,
    STRINGID_PKMNALREADYHASFROSTBITE,
    STRINGID_PKMNALREADYHASCURSE,
    STRINGID_PKMNCURSEHEALED,
    STRINGID_LUNARVEILPROTECTED,
    STRINGID_PKMNBURNWENTOUT,
    STRINGID_PKMNRAINCUREDBURN,
    STRINGID_PKMNWATERMOVECUREDBURN,
    STRINGID_PKMNFROSTBITEIMPROVED,
    STRINGID_PKMNSUNCUREDFROSBITE,
    STRINGID_PKMNFIREMOVECUREDFROST,
    STRINGID_PKMNPARALYSISENDED,
    STRINGID_PKMNCURSEDENDED,
    STRINGID_PKMNGAVEUPITEM,
    STRINGID_PKMNSQUEEZEDBYVINES,
    STRINGID_PKMNCALLINGAMETEOR,
    STRINGID_PKMNHAUSTELLHEAL,
    STRINGID_PKMNAFFLICTEDBYPLAGUE,
    STRINGID_PKMNSHROUDEDINHAZE,
    STRINGID_PKMNHAZESTOPPEDBOOST,
    STRINGID_PKMNSTOODINFRONT,
    STRINGID_PKMNGOTFOESATTENTION,
    STRINGID_STATICROOMPREVENTSCHANGE,
    STRINGID_GRIMROOMINVERTEDHEALING,
    STRINGID_PKMNCANTUSESAMEMOVE,
    STRINGID_PKMNSTATSWEREFROZEN,
    STRINGID_FLIPPEDTYPEEFFECTIVENESS,
    STRINGID_HEALINGTURNEDTODAMAGE,
    STRINGID_ERRORROOMENDS,
    STRINGID_STATICROOMENDS,
    STRINGID_REVERSEROOMENDS,
    STRINGID_GRIMROOMENDS,
    STRINGID_TRAPWASLAID,
    STRINGID_TRAPCAUGHTTARGET,
    STRINGID_TRAPDAMAGEDTARGET,
    STRINGID_BOOBYTRAPDISAPPEAREDFROMTEAM,
    STRINGID_PKMNBLEWAWAYBOOBYTRAP,
    STRINGID_PERMAFROSTENTERS,
    STRINGID_POISONINGWORSENED,
    STRINGID_PKMNSSNACKTOLEFTOVERS,
    STRINGID_PKMNSPEEDBOOSTED,
    STRINGID_BARRIERWOREOFF,
    STRINGID_PKMNTRAPPEDBYICECHAIN,
    STRINGID_FAULTYTERRAINPREVENTS,
    STRINGID_AURABREAKTERRAIN,
...
enum StatChangedStringID
{
    ...
    B_MSG_STAT_CHANGED_AUTOTOMIZE,
    B_MSG_USED_DIRE_HIT,
};

// There was a section for MissStrings that was here before
// I had added a special message for Detect that I don't know where to put
...
// gWeatherHealingStringIds
enum WeatherHealingStringID
{
    B_MSG_SANDHEAL,
    B_MSG_RAIN,
    B_MSG_SNOW,
...
enum ReflectLightScreenSafeguardStringID
{
    ...
    B_MSG_SET_BARRIER_SINGLE,
    B_MSG_SET_BARRIER_DOUBLE,
    B_MSG_SET_SAFEGUARD,
...
// gBurnEndStringIds
enum BurnEndStringID
{
    B_MSG_FIRE_WENT_OUT,
    B_MSG_FIZZLED_IN_RAIN,
    B_MSG_WATER_PUT_OUT,
};

// gFrostbiteEndStringIds
enum FrostbiteEndStringID
{
    B_MSG_FROSTBITE_GOT_BETTER,
    B_MSG_SUN_CURED_FROST,
    B_MSG_FIRE_SCORCHED_FROST,
};
...
enum RoomsStringID
{
    B_MSG_ROOM_TRICK_ROOM,
    B_MSG_ROOM_END_TRICK_ROOM,
    B_MSG_ROOM_WONDER_ROOM,
    B_MSG_ROOM_END_WONDER_ROOM,
    B_MSG_ROOM_MAGIC_ROOM,
    B_MSG_ROOM_END_MAGIC_ROOM,
    B_MSG_ROOM_ERROR_ROOM,
    B_MSG_ROOM_END_ERROR_ROOM,
    B_MSG_ROOM_STATIC_ROOM,
    B_MSG_ROOM_END_STATIC_ROOM,
    B_MSG_ROOM_REVERSE_ROOM,
    B_MSG_ROOM_END_REVERSE_ROOM,
    B_MSG_ROOM_GRIM_ROOM,
    B_MSG_ROOM_END_GRIM_ROOM,
    B_MSG_ROOM_EMPTY,
};
...
enum SwitchInAbilityStringID
{
    ...
    B_MSG_SWITCHIN_METALLIC,
    B_MSG_SWITCHIN_WICKED,
    B_MSG_SWITCHIN_DRACONIC,
    B_MSG_SWITCHIN_TECTONIC,
    B_MSG_SWITCHIN_PURITY,
    B_MSG_SWITCHIN_VENOMOUS,
    B_MSG_SWITCHIN_AQUATIC,
    B_MSG_SWITCHIN_COLD_HEART,
    B_MSG_SWITCHIN_STAKEOUT,
    B_MSG_SWITCHIN_KUSANAGI,
    B_MSG_SWITCHIN_COSMIC,
    B_MSG_SWITCHIN_REVOCATION,
    B_MSG_SWITCHIN_PERMAFROST,
};
...
enum TerrainStringID
{
    ...
    B_MSG_TERRAIN_END_BUGGY,
    B_MSG_TERRAIN_END_FAULTY,
    B_MSG_TERRAIN_END_SPOOKY,
    B_MSG_TERRAIN_COUNT
};
...
{
    B_MSG_SET_TRICK_ROOM = (B_MSG_TERRAIN_SET_SPOOKY + 1),
...
enum WrappedStringID
{
    ...
    B_MSG_WRAPPED_ATTACK_ORDER,
    B_MSG_WRAPPED_TETHER_VINE,
    B_MSG_WRAPPED_ICE_BEAM,
    NUM_TRAPPING_MOVES,
};
...
{
    B_MSG_HURT,
    B_MSG_HURT_ATTACKER_ABILITY,
    B_MSG_HURT_BY_ITEM,
    B_MSG_HURT_TARGET_ABILITY,
    B_MSG_HURT_ITSELF,
};
...
// gStatChangesRemovedStringIds
enum StatChangesRemovedStringID
{
    B_MSG_ALL_BATTLER_STATS_GONE,
    B_MSG_ALL_USER_STATS_GONE,
    B_MSG_USER_MINUS_STATS_GONE,
    B_MSG_FOE_PLUS_STATS_GONE,
};
