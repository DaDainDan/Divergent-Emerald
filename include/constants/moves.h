...
enum __attribute__((packed)) Move
{
    ...
    MOVE_KARATE_CHOP = 2,
    MOVE_DOUBLE_SLAP = 3,
    MOVE_SLAP_ATHON = MOVE_DOUBLE_SLAP, // Promise Name
    MOVE_DOUBLESLAP = MOVE_DOUBLE_SLAP, // Pre-Gen VI name
    MOVE_COMET_PUNCH = 4,
    MOVE_COMBO_PUNCH = MOVE_COMET_PUNCH, // Promise Name
    MOVE_MEGA_PUNCH = 5,
    MOVE_PAY_DAY = 6,
    MOVE_JACKPOT = MOVE_PAY_DAY, // Promise Name
    MOVE_FIRE_PUNCH = 7,
    MOVE_ICE_PUNCH = 8,
    ...
    MOVE_MEGA_KICK = 25,
    MOVE_JUMP_KICK = 26,
    MOVE_DROPKICK = MOVE_JUMP_KICK, // Promise Name
    MOVE_ROLLING_KICK = 27,
    MOVE_WHEEL_KICK = MOVE_ROLLING_KICK, // Promise Name
    MOVE_SAND_ATTACK = 28,
    MOVE_HEADBUTT = 29,
    MOVE_HORN_ATTACK = 30,
    MOVE_FURY_ATTACK = 31,
    ...
    MOVE_DOUBLE_EDGE = 38,
    MOVE_TAIL_WHIP = 39,
    MOVE_TAIL_WAG = MOVE_TAIL_WHIP, // Promise Name
    MOVE_POISON_STING = 40,
    MOVE_POISON_NEEDLE = MOVE_POISON_STING, // Promise Name
    MOVE_TWINEEDLE = 41,
    MOVE_PIN_MISSILE = 42,
    MOVE_LEER = 43,
    MOVE_BITE = 44,
    ...
    MOVE_SING = 47,
    MOVE_SUPERSONIC = 48,
    MOVE_ULTRASOUND = MOVE_SUPERSONIC, // Promise Name
    MOVE_SONIC_BOOM = 49,
    MOVE_SONICBOOM = MOVE_SONIC_BOOM, // Pre-Gen VI name
    MOVE_DISABLE = 50,
    MOVE_ACID = 51,
    MOVE_ACID_BOMB = MOVE_ACID, // Promise Name
    MOVE_EMBER = 52,
    ...
    MOVE_DRILL_PECK = 65,
    MOVE_SUBMISSION = 66,
    MOVE_HELL_WHEEL = MOVE_SUBMISSION, // Promise Name
    MOVE_LOW_KICK = 67,
    MOVE_COUNTER = 68,
    ...
    MOVE_STUN_SPORE = 78,
    MOVE_STUN_POWDER = MOVE_STUN_SPORE, // Promise Name
    MOVE_SLEEP_POWDER = 79,
    MOVE_PETAL_DANCE = 80,
    MOVE_STRING_SHOT = 81,
    MOVE_DRAGON_RAGE = 82,
    MOVE_FIRE_SPIN = 83,
    MOVE_FLAME_VORTEX = MOVE_FIRE_SPIN, // Promise Name
    MOVE_THUNDER_SHOCK = 84,
    MOVE_SHOCK = MOVE_THUNDER_SHOCK, // Promise Name
    MOVE_THUNDERSHOCK = MOVE_THUNDER_SHOCK, // Pre-Gen VI name
    MOVE_THUNDERBOLT = 85,
    MOVE_THUNDER_WAVE = 86,
    MOVE_MAGNETIC_WAVE = MOVE_THUNDER_WAVE, // Promise Name
    MOVE_THUNDER = 87,
    MOVE_SMITE = MOVE_THUNDER, // Promise Name
    MOVE_ROCK_THROW = 88,
    MOVE_EARTHQUAKE = 89,
    MOVE_FISSURE = 90,
    MOVE_DIG = 91,
    MOVE_TOXIC = 92,
    MOVE_CONFUSION = 93,
    MOVE_TK = MOVE_CONFUSION, // Promise Name
    MOVE_PSYCHIC = 94,
    MOVE_HYPNOSIS = 95,
    MOVE_MEDITATE = 96,
    MOVE_YOGA_POSE = MOVE_MEDITATE, // Promise Name
    MOVE_AGILITY = 97,
    ...
    MOVE_RECOVER = 105,
    MOVE_REGENERATE = MOVE_RECOVER, // Promise Name
    MOVE_HARDEN = 106,
    MOVE_MINIMIZE = 107,
    MOVE_SMOKESCREEN = 108,
    MOVE_CONFUSE_RAY = 109,
    MOVE_NIGHT_LIGHT = MOVE_CONFUSE_RAY, // Promise Name
    MOVE_WITHDRAW = 110,
    MOVE_DEFENSE_CURL = 111,
    MOVE_CURL_UP = MOVE_DEFENSE_CURL, // Promise Name
    MOVE_BARRIER = 112,
    ...
    MOVE_PARROT = MOVE_MIRROR_MOVE, // Promise Name
    ...
    MOVE_BONE_CLUB = 125,
    MOVE_FIRE_BLAST = 126,
    MOVE_PYROGLYPH = MOVE_FIRE_BLAST, // Promise Name
    MOVE_WATERFALL = 127,
    MOVE_CLAMP = 128,
    MOVE_SWIFT = 129,
    MOVE_SUPER_STAR = MOVE_SWIFT, // Promise Name
    MOVE_SKULL_BASH = 130,
    ...
    MOVE_ROCKET_KNEE = MOVE_HIGH_JUMP_KICK, // Promise Name
    MOVE_GLARE = 137,
    ...
    MOVE_SIRENS_KISS = MOVE_LOVELY_KISS, // Promise Name
    MOVE_SKY_ATTACK = 143,
    MOVE_HEAVENS_FLIGHT = MOVE_SKY_ATTACK, // Promise Name
    MOVE_TRANSFORM = 144,
    MOVE_BUBBLE = 145,
    ...
    MOVE_PSYWAVE = 149,
    MOVE_SPLASH = 150,
    MOVE_HOP = MOVE_SPLASH, // Promise Name
    MOVE_ACID_ARMOR = 151,
    MOVE_CRABHAMMER = 152,
    MOVE_EXPLOSION = 153,
    ...
    MOVE_ROCK_SLIDE = 157,
    MOVE_HYPER_FANG = 158,
    MOVE_FATAL_FANG = MOVE_HYPER_FANG, // Promise Name
    MOVE_SHARPEN = 159,
    MOVE_CONVERSION = 160,
    MOVE_TRI_ATTACK = 161,
    MOVE_SUPER_FANG = 162,
    ...
    MOVE_SNEAK_ATTACK = MOVE_FEINT_ATTACK, // Promise Name
    MOVE_FAINT_ATTACK = MOVE_FEINT_ATTACK, // Pre-Gen VI name
    MOVE_SWEET_KISS = 186,
    MOVE_ANGELS_KISS = MOVE_SWEET_KISS, // Promise Name
    MOVE_BELLY_DRUM = 187,
    MOVE_SLUDGE_BOMB = 188,
    MOVE_MUD_SLAP = 189,
    MOVE_MUD_SPEW = MOVE_MUD_SLAP, // Promise Name
    MOVE_OCTAZOOKA = 190,
    MOVE_INK_BOMB = MOVE_OCTAZOOKA, // Promise Name
    MOVE_SPIKES = 191,
    MOVE_CALTROPS = MOVE_SPIKES, // Promise Name
    MOVE_ZAP_CANNON = 192,
    MOVE_MAGNET_CANNON = MOVE_ZAP_CANNON, // Promise Name
    MOVE_FORESIGHT = 193,
    MOVE_DESTINY_BOND = 194,
    MOVE_DOOM_PACT = MOVE_DESTINY_BOND, // Promise Name
    ...
    MOVE_LOCK_ON = 199,
    MOVE_OUTRAGE = 200,
    MOVE_RAMPAGE = MOVE_OUTRAGE, // Promise Name
    MOVE_SANDSTORM = 201,
    MOVE_GIGA_DRAIN = 202,
    MOVE_ENDURE = 203,
    MOVE_CHARM = 204,
    ...
    MOVE_BLUNT_EDGE = MOVE_FALSE_SWIPE, // Promise Name
    MOVE_SWAGGER = 207,
    MOVE_MILK_DRINK = 208,
    MOVE_SPARK = 209,
    ...
    MOVE_STEEL_WING = 211,
    MOVE_MEAN_LOOK = 212,
    MOVE_EVIL_EYE = MOVE_MEAN_LOOK, // Promise Name
    MOVE_ATTRACT = 213,
    MOVE_SLEEP_TALK = 214,
    MOVE_HEAL_BELL = 215,
    MOVE_RETURN = 216,
    ...
    MOVE_ROCKET_PUNCH = MOVE_DYNAMIC_PUNCH, // Promise Name
    ...
    MOVE_PSYCH_UP = 244,
    MOVE_EMPATHIZE = MOVE_PSYCH_UP, // Promise Name
    ...
    MOVE_ROCK_SMASH = 249,
    MOVE_SMASH = MOVE_ROCK_SMASH, // Promise Name
    MOVE_WHIRLPOOL = 250,
    MOVE_MAELSTROM = MOVE_WHIRLPOOL, // Promise Name
    MOVE_BEAT_UP = 251,
    MOVES_COUNT_GEN2,
    ...
    MOVE_IMPRISON = 286,
    MOVE_REFRESH = 287,
    MOVE_REJUVENATE = MOVE_REFRESH, // Promise Name
    MOVE_GRUDGE = 288,
    MOVE_SNATCH = 289,
    ...
    MOVE_COMET_PUNCH_NEW = MOVE_METEOR_MASH, // Promise Name
    MOVE_ASTONISH = 310,
    MOVE_JUMPSCARE = MOVE_ASTONISH, // Promise Name
    ...
    MOVE_SAND_TOMB = 328,
    MOVE_SHEER_COLD = 329,
    MOVE_ABSOLUTE_ZERO = MOVE_SHEER_COLD, // Promise Name
    MOVE_MUDDY_WATER = 330,
    MOVE_BULLET_SEED = 331,
    MOVE_AERIAL_ACE = 332,
    MOVE_SWALLOW_REVERSAL = MOVE_AERIAL_ACE, // Promise Name
    MOVE_ICICLE_SPEAR = 333,
    MOVE_IRON_DEFENSE = 334,
    MOVE_BLOCK = 335,
    MOVE_IMPEDE = MOVE_BLOCK, // Promise Name
    MOVE_HOWL = 336,
    ...
    MOVE_CALM_MIND = 347,
    MOVE_MEDITATION = MOVE_CALM_MIND, // Promise Name
    MOVE_LEAF_BLADE = 348,
    ...
    MOVE_GRAND_FINALE = MOVE_LAST_RESORT, // Promise Name
    MOVE_WORRY_SEED = 388,
    MOVE_SUCKER_PUNCH = 389,
    MOVE_BLINDSIDE = MOVE_SUCKER_PUNCH, // Promise Name
    ...
    MOVE_CUT_DOWN = MOVE_NIGHT_SLASH, // Promise Name
    MOVE_AQUA_TAIL = 401,
    MOVE_SEED_BOMB = 402,
    MOVE_AIR_SLASH = 403,
    MOVE_X_SCISSOR = 404,
    ...
    MOVE_AVALANCHE = 419,
    MOVE_ICE_SHARD = 420,
    MOVE_ICE_SHOT = MOVE_ICE_SHARD, // Promise Name
    ...
    MOVE_STONE_CANNON = MOVE_ROCK_WRECKER, // Promise Name
    ...
    MOVE_HONE_EDGE = MOVE_HONE_CLAWS, // Promise Name
    MOVE_WIDE_GUARD = 469,
    ...
    MOVE_CHIP_AWAY = 498,
    MOVE_CLEAR_SMOG = 499,
    MOVE_SEDATIVE_FUMES = MOVE_CLEAR_SMOG, // Promise Name
    ...
    MOVE_RETALIATE = 514,
    MOVE_RETRIBUTION = MOVE_RETALIATE, // Promise Name
    ...
    MOVE_GEAR_GRIND = 544,
    MOVE_GRINDER = MOVE_GEAR_GRIND, // Promise Name
    ...
    MOVE_BELCH = 562,
    MOVE_ROTOTILLER = 563,
    MOVE_PLOW = MOVE_ROTOTILLER, // Promise Name
    MOVE_STICKY_WEB = 564,
    MOVE_FELL_STINGER = 565,
    MOVE_PHANTOM_FORCE = 566,
    MOVE_TRICK_OR_TREAT = 567,
    MOVE_DAMNATION = MOVE_TRICK_OR_TREAT, // Promise Name
    MOVE_NOBLE_ROAR = 568,
    MOVE_ION_DELUGE = 569,
    ...
    MOVE_STEADY_SHOT = MOVE_SMART_STRIKE, // Promise Name
    MOVE_PURIFY = 648,
    ...
    MOVE_NO_RETREAT = 694,
    MOVE_LAST_STAND = MOVE_NO_RETREAT, // Promise Name
    MOVE_TAR_SHOT = 695,
    MOVE_MAGIC_POWDER = 696,
    MOVE_DRAGON_DARTS = 697,
    MOVE_TEATIME = 698,
    MOVE_OCTOLOCK = 699,
    MOVE_CAUSTIC_TENDRILS = MOVE_OCTOLOCK, // Promise Name
    MOVE_BOLT_BEAK = 700,
    ...
    MOVE_STEAMROLL = MOVE_STEEL_ROLLER, // Promise Name
    MOVE_SCALE_SHOT = 727,
    MOVE_SCALE_BURST = MOVE_SCALE_SHOT, // Promise Name
    MOVE_METEOR_BEAM = 728,
    MOVE_SHELL_SIDE_ARM = 729,
    MOVE_MISTY_EXPLOSION = 730,
    MOVE_KA_BOOM = MOVE_MISTY_EXPLOSION, // Promise Name
    ...
    MOVE_FURIOUS_FLAME = MOVE_RAGING_FURY, // Promise Name
    MOVE_WAVE_CRASH = 762,
    MOVE_CHLOROBLAST = 763,
    MOVE_MOUNTAIN_GALE = 764,
    MOVE_VICTORY_DANCE = 765,
    MOVE_HEADLONG_RUSH = 766,
    MOVE_HEAD_RAM = MOVE_HEADLONG_RUSH, // Promise Name
    MOVE_BARB_BARRAGE = 767,
    MOVE_ESPER_WING = 768,
    MOVE_BITTER_MALICE = 769,
    MOVE_PURGATORY = MOVE_BITTER_MALICE, // Promise Name
    MOVE_SHELTER = 770,
    MOVE_BARRICADE = MOVE_SHELTER, // Promise Name
    MOVE_TRIPLE_ARROWS = 771,
    MOVE_INFERNAL_PARADE = 772,
    MOVE_PANDEMONIUM = MOVE_INFERNAL_PARADE, // Promise Name
    ...
    MOVE_GRAVE_POWER = MOVE_LAST_RESPECTS, // Promise Name
    ...
    // Promise Moves
    MOVE_RAGING_DEMON = MOVES_COUNT_GEN9,
    MOVE_BELLY_FLOP = 849,
    MOVE_BERRY_TOSS = 850,
    MOVE_POWER_BALL = 851,
    MOVE_HEAD_SMACK = 852,
    MOVE_ROLLING_KICKS = 853,
    MOVE_STORM_CALL = 854,
    MOVE_DIRE_OMEN = 855,
    MOVE_LIMIT_BREAK = 856,
    MOVE_BITTER_COLD = 857,
    MOVE_DIAMOND_DUST = 858,
    MOVE_KI_CHARGE = 859,
    MOVE_CRIPPLE = 860,
    MOVE_BLOCK_NEW = 861,
    MOVE_FROST_CHARGE = 862,
    MOVE_BOULDER_RUSH = 863,
    MOVE_ADAMANT_ASSAULT = 864,
    MOVE_OVERLOAD = 865,
    MOVE_FORCE_OF_WILL = 866,
    MOVE_METEOR_SHOWER = 867,
    MOVE_SHINING_SLASH = 868,
    MOVE_WATER_WHIP = 869,
    MOVE_RIME_HEAD = 870,
    MOVE_LIGHTNING_TAIL = 871,
    MOVE_TORCH_TAIL = 872,
    MOVE_SICKLE_CLAW = 873,
    MOVE_CIRCUIT_KICKS = 874,
    MOVE_BURNING_GRASP = 875,
    MOVE_LIGHTNING_GRASP = 876,
    MOVE_GLACIAL_GRASP = 877,
    MOVE_PUTRID_GRASP = 878,
    MOVE_DARK_GRASP = 879,
    MOVE_SUPERNOVA = 880,
    MOVE_OSMOTIC_BURST = 881,
    MOVE_ARC_BLAST = 882,
    MOVE_BRUMAL_BURST = 883,
    MOVE_NOXIOUS_BLOWOUT = 884,
    MOVE_SAND_BURST = 885,
    MOVE_WITS_END = 886,
    MOVE_ROCK_RUPTURE = 887,
    MOVE_BLAST_SHELL = 888,
    MOVE_SHATTER = 889,
    MOVE_HIT_AND_RUN = 890,
    MOVE_MIND_GAMES = 891,
    MOVE_FESTIVE_DANCE = 892,
    MOVE_PEARL_DANCE = 893,
    MOVE_UNBURDEN = 894,
    MOVE_SUBVERT = 895,
    MOVE_TRIP = 896,
    MOVE_ENCHANT = 897,
    ...
    MOVE_SEWER_SLAP = 901,
    MOVE_ACID_BLIND = 902,
    MOVE_SACRIFICIAL_FLAME = 903,
    MOVE_SAND_TSUNAMI = 904,
    MOVE_MUD_MASH = 905,
    MOVE_TREMORS = 906,
    MOVE_FLIP_KICK = 907,
    MOVE_PRESSURE_POINTS = 908,
    MOVE_LIFE_FORCE = 909,
    MOVE_EXPEND = 910,
    MOVE_BIG_GULP = 911,
    MOVE_LURING_LIGHT = 912,
    MOVE_BAD_INFLUENCE = 913,
    MOVE_MIND_CRUSH = 914,
    MOVE_FIRESTORM = 915,
    MOVE_SPIRIT_AWAY = 916,
    MOVE_IGNITE = 917,
    MOVE_OVERCHARGE = 918,
    MOVE_POOF = 919,
    MOVE_TEST_OF_HONOR = 920,
    MOVE_POWDERPUFF_PUNCH = 921,
    MOVE_PERSECUTION = 922,
    MOVE_INSULT_TO_INJURY = 923,
    MOVE_TETHER_VINE = 924,
    MOVE_HOCUS_POCUS = 925,
    MOVE_EMBRACE_ESCAPE = 926,
    MOVE_PATCHWORK = 927,
    MOVE_TOUGH_LOVE = 928,
    MOVE_SOOTHING_GUARD = 929,
    MOVE_ICE_SHARDS = 930,
    MOVE_MANGLE = 931,
    MOVE_FERVENT_FRENZY = 932,
    MOVE_AURA_BURST = 933,
    MOVE_CRYSTAL_FLARE = 934,
    MOVE_MOUNTAIN_SMASH = 935,
    MOVE_METEOR_DROP = 936,
    MOVE_ROCK_JAW = 937,
    MOVE_IRON_JAW = 938,
    MOVE_GALVANIC_FIELD = 939,
    MOVE_BUG_OUT = 940,
    MOVE_STAR_DESCENT = 941,
    MOVE_BLACK_HOLE = 942,
    MOVE_CORKSCREW_CROSS = 943,
    MOVE_SPIRIT_SAP = 944,
    MOVE_DRAGON_MAW = 945,
    MOVE_SUNDER = 946,
    MOVE_EYE_JAB = 947,
    MOVE_DEATH_THREAT = 948,
    MOVE_FAN_THE_FLAMES = 949,
    MOVE_HAUSTELL = 950,
    MOVE_PLAGUE = 951,
    MOVE_MONSOON = 952,
    MOVE_SQUALL = 953,
    MOVE_LIGHTNING_STORM = 954,
    MOVE_RAPID_CYCLONE = 955,
    MOVE_BODY_GUARD = 956,
    MOVE_HAILSTORM = 957,
    MOVE_PYRO_TECHNIQUES = 958,
    MOVE_CHOKE_SLAM = 959,
    MOVE_WHIRLPOOL_NEW = 960,
    MOVE_QUICKSAND = 961,
    MOVE_FLASH_FLOOD = 962,
    MOVE_SNOWBALL = 963,
    MOVE_BREAKING_WAVE = 964,
    MOVE_AFTERSHOCK = 965,
    MOVE_FLAMING_EDGE = 966,
    MOVE_WRECKING_BALL = 967,
    MOVE_LANDSLIDE = 968,
    MOVE_SOUL_DRAIN = 969,
    MOVE_MIASMA = 970,
    MOVE_SPELL_CHAIN = 971,
    MOVE_BUGGY_TERRAIN = 972,
    MOVE_FAULTY_TERRAIN = 973,
    MOVE_SPOOKY_TERRAIN = 974,
    MOVE_BUG_BURST = 975,
    MOVE_RECKLESS_UPHEAVAL = 976,
    MOVE_SOUL_SHATTER = 977,
    MOVE_ERROR_ROOM = 978,
    MOVE_STATIC_ROOM = 979,
    MOVE_REVERSE_ROOM = 980,
    MOVE_GRIM_ROOM = 981,
    MOVE_BOOBY_TRAP = 982,
    MOVE_SHADOW_VEIL = 983,
    MOVE_ICE_CHAINS = 984,
    MOVES_COUNT_PROMISE,

    MOVES_COUNT = MOVES_COUNT_PROMISE,
