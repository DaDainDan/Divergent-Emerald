...
enum __attribute__((packed)) Ability
{
    ...
    // New Abilties
    ABILITY_AQUATIC = ABILITIES_COUNT_GEN9,
    ABILITY_AVENGER = 320,
    ABILITY_BLACK_FUMES = 321,
    ABILITY_COLD_HEART = 322,
    ABILITY_COMBUSTION = 323,
    ABILITY_CONDUCTOR = 324,
    ABILITY_COSMIC = 325,
    ABILITY_CRAFTY = 326,
    ABILITY_CULTIVATOR = 327,
    ABILITY_DOOM_DESIRE = 328,
    ABILITY_DRACONIC = 329,
    ABILITY_ELECTROLIGHT = 330,
    ABILITY_FORBIDDEN = 331,
    ABILITY_FROST_ARMOR = 332,
    ABILITY_GRAPPLER = 333,
    ABILITY_GUNK_MUNCHER = 334,
    ABILITY_HEAT_TREATMENT = 335,
    ABILITY_HYPER_FOCUS = 336,
    ABILITY_ICE_ABSORB = 337,
    ABILITY_INFLATE = 338,
    ABILITY_IRRITABILITY = 339,
    ABILITY_JET_LEG = 340,
    ABILITY_KUSANAGI = 341,
    ABILITY_MAJESTY = 342,
    ABILITY_MALICE = 343,
    ABILITY_METALLIC = 344,
    ABILITY_MINSTREL = 345,
    ABILITY_MIRACLE_EYE = 346,
    ABILITY_MOON_PRESENCE = 347,
    ABILITY_NULL = 348,
    ABILITY_PACIFIER = 349,
    ABILITY_POTENCY = 350,
    ABILITY_PROVOCATEUR = 351,
    ABILITY_PURITY = 352,
    ABILITY_REBOUND = 353,
    ABILITY_RESILIENCE = 354,
    ABILITY_SCATTERBRAIN = 355,
    ABILITY_SILK_SPEW = 356,
    ABILITY_STONEMASON = 357,
    ABILITY_TECTONIC = 358,
    ABILITY_TOXIC_BODY = 359,
    ABILITY_VENGEFUL = 360,
    ABILITY_VENOMOUS = 361,
    ABILITY_WICKED = 362,
    ABILITY_LUCKY_SURGE = 363,
    ABILITY_FAULTY_SURGE = 364,
    ABILITY_SPOOKY_SURGE = 365,
    ABILITY_SUPERIOR = 366,
    ABILITY_SEA_GUARDIAN = 367,
    ABILITY_GOD_PHOENIX = 368,
    ABILITY_ORIGIN_OF_LAND = 369,
    ABILITY_ORIGIN_OF_SEA = 370,
    ABILITY_ORIGIN_OF_SKY = 371,
    ABILITY_SPACE_WARP = 372,
    ABILITY_TIME_ALTER = 373,
    ABILITY_REVOCATION = 374,
    ABILITY_ETERNAL = 375,
    ABILITY_PERMAFROST = 376,
    ABILITY_FROZEN_VALOR = 377,
    ABILITY_BITTER_LOGIC = 378,
    ABILITY_TREE_OF_LIFE = 379,
    ABILITY_DEATHWING = 380,
    ABILITY_RADIANT_SUN = 381,
    ABILITY_DARK_MOON = 382,
    ABILITY_STOLEN_SUNLIGHT = 383,
    ABILITY_STOLEN_MOONLIGHT = 384,
    ABILITY_MAX_LUMINOUS = 385,
    ABILITY_ENERGY_SINK = 386,

    ABILITY_CHATTER = 387,
    ABILITY_ICE_CHAINS = 388,
    ABILITY_SHOOTING_STAR = 389,
    ABILITY_LUNAR_VEIL = 390,
    ABILITY_SPECTRAL_THIEF = 391,

    ABILITY_GENEROSITY = 392,
    ABILITY_RECIPROCAL = 393,
    ABILITY_MY_LIEGE = 394,

    ABILITIES_COUNT_PROMISE = 395,

    ABILITIES_COUNT = ABILITIES_COUNT_PROMISE,
};
