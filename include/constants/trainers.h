...
enum TrainerClassID
{
    ...
    TRAINER_CLASS_ACE_TRAINER,
    TRAINER_CLASS_COOLTRAINER = TRAINER_CLASS_ACE_TRAINER, // Pre-Gen 4 name
    ...
    TRAINER_CLASS_INTERVIEWER = TRAINER_CLASS_INTERVIEWERS, // Gen 3 name
    TRAINER_CLASS_TUBER_F,
    TRAINER_CLASS_TUBER_M,
    TRAINER_CLASS_LADY,
    TRAINER_CLASS_BEAUTY,
    TRAINER_CLASS_RICH_BOY,
    TRAINER_CLASS_POKE_MANIAC,
    TRAINER_CLASS_POKEMANIAC = TRAINER_CLASS_POKE_MANIAC, // Pre-Gen 4 name
    ...
    TRAINER_CLASS_LEADER = TRAINER_CLASS_GYM_LEADER, // Pre-Gen 7 name
    TRAINER_CLASS_SCHOOL_KID,
    TRAINER_CLASS_SCHOOLKID = TRAINER_CLASS_SCHOOL_KID, // Gen 6 name
    TRAINER_CLASS_TEAMMATES,
    TRAINER_CLASS_SR_AND_JR = TRAINER_CLASS_TEAMMATES, // Gen 3 name
    TRAINER_CLASS_WINSTRATE,
    TRAINER_CLASS_POKE_FAN,
    TRAINER_CLASS_POKEFAN = TRAINER_CLASS_POKE_FAN, // Pre-Gen 6 name
    TRAINER_CLASS_YOUNGSTER,
    TRAINER_CLASS_CHAMPION,
    TRAINER_CLASS_FISHER,
    TRAINER_CLASS_FISHERMAN = TRAINER_CLASS_FISHER, // Gen 1,3-7 name
    ...
    TRAINER_CLASS_ACE_TRAINER_2, // Used for only one Trainer, Jazmyn on Route 123.
    TRAINER_CLASS_COOLTRAINER_2 = TRAINER_CLASS_ACE_TRAINER_2, // Pre-Gen 4 name
    ...
    TRAINER_CLASS_MASTER,
    TRAINER_CLASS_TOWER_TYCOON,
    TRAINER_CLASS_SALON_MAIDEN = TRAINER_CLASS_TOWER_TYCOON, // Gen 3 name
    ...
    TRAINER_CLASS_POKE_MANIAC_FRLG,
    TRAINER_CLASS_POKEMANIAC_FRLG = TRAINER_CLASS_POKE_MANIAC_FRLG, // Pre-Gen 4 name
    ...
    TRAINER_CLASS_FISHER_FRLG,
    TRAINER_CLASS_FISHERMAN_FRLG = TRAINER_CLASS_FISHER_FRLG, // Gen 1 and Gen 3-7 name
    TRAINER_CLASS_SWIMMER_M_FRLG,
    TRAINER_CLASS_ROUGHNECK_FRLG,
    TRAINER_CLASS_CUE_BALL_FRLG = TRAINER_CLASS_ROUGHNECK_FRLG, // Pre-Gen 4 name
    ...
    TRAINER_CLASS_ROCKET_BOSS_FRLG,
    TRAINER_CLASS_BOSS_FRLG = TRAINER_CLASS_ROCKET_BOSS_FRLG, // Gen 3 name
    TRAINER_CLASS_GYM_LEADER_FRLG,
    TRAINER_CLASS_LEADER_FRLG = TRAINER_CLASS_GYM_LEADER_FRLG, // Pre-Gen 7 name
    TRAINER_CLASS_TEAM_ROCKET_FRLG,
    TRAINER_CLASS_ACE_TRAINER_FRLG,
    TRAINER_CLASS_COOLTRAINER_FRLG = TRAINER_CLASS_ACE_TRAINER_FRLG, // Pre-Gen 4 name
...
#define TRAINER_GENDER_BOTH_GENDERS 2
