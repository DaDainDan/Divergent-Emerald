...
// Kept for reference in case the vanilla Emerald Hoenn Dex order/membership is needed again.
#if 0
#define FOREACH_SPECIES_IN_HOENN_DEX_ORDER_VANILLA(F) \
    F(TREECKO) \
    F(GROVYLE) \
    F(SCEPTILE) \
    F(TORCHIC) \
...
#define HOENN_DEX_COUNT (HOENN_DEX_OGERPON + 1) // DEOXYS
