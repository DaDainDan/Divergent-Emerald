...
#define NATURE_SMOOTH   25 //  +.4 AllStats - HP
...
// Nature Aliases
#define NATURE_GROUCHY   NATURE_IMPISH
#define NATURE_SCRAPPY   NATURE_BOLD
#define NATURE_SELFISH   NATURE_MODEST
#define NATURE_NOBLE     NATURE_MILD
#define NATURE_CURIOUS   NATURE_RELAXED
#define NATURE_WILD      NATURE_HASTY
#define NATURE_SHREWD    NATURE_LAX
#define NATURE_AFFABLE   NATURE_NAIVE
...
#define MAX_PER_STAT_EVS ((P_EV_CAP >= GEN_6) ? 192 : 255)
#define MAX_TOTAL_EVS 480
