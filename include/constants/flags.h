...
// Free Block 1 (SCRIPTING)
#define FLAG_MET_HYPER_TRAINER                   0x20
...
#define FLAG_MET_DOJO_FIGHTING_TUTOR             0x46 // Unused Flag
#define FLAG_MET_ROUTE_119_FERAL_TUTOR           0x47 // Unused Flag
#define FLAG_MET_ROUTE_114_BIDEPAL_TUTOR         0x48 // Unused Flag
#define FLAG_MET_WEATHER_INSTITUTE_TUTOR         0x49 // Unused Flag
#define FLAG_MET_ALTERING_CAVE_TERRAIN_TUTOR     0x4A // Unused Flag
#define FLAG_MET_FORTREE_NINJA_TUTOR             0x4B // Unused Flag
#define FLAG_MET_SLATEPORT_SWAP_TUTOR            0x4C // Unused Flag
#define FLAG_MET_TRICK_HOUSE_ROOM_TUTOR          0x4D // Unused Flag
#define FLAG_MET_BATTLE_FRONTIER_EXPLOSION_TUTOR 0x4E // Unused Flag
#define FLAG_MET_BATTLE_FRONTIER_ULTIMATE_TUTOR  0x4F // Unused Flag
...
#define FLAG_RECEIVED_EVIOLITE                           0x85
...
#define FLAG_RECEIVED_LOADED_DICE            0xE1
...
#define FLAG_RECEIVED_DAYCARE_EGG            0xE9 // Unused Flag
...
#define FLAG_RECEIVED_KEE_BERRY                0xF8
#define FLAG_RECEIVED_MARANGA_BERRY            0xF9
#define FLAG_RECEIVED_STARF_BERRY              0xFA
#define FLAG_RECEIVED_ENIGMA_BERRY             0xFB
#define FLAG_RECEIVED_CUSTAP_BERRY             0xFC
...
#define FLAG_CHOSE_HELIX_FOSSIL              0x14F
#define FLAG_CHOSE_DOME_FOSSIL               0x150
...
#define FLAG_REGISTERED_OSCAR                (TRAINER_REGISTERED_FLAGS_START + REMATCH_OSCAR)
...
#define FLAG_REGISTERED_NICOLE               (TRAINER_REGISTERED_FLAGS_START + REMATCH_NICOLE)
#define FLAG_REGISTERED_ANNA_AND_MEG         (TRAINER_REGISTERED_FLAGS_START + REMATCH_ANNA_AND_MEG)
#define FLAG_REGISTERED_KELLY                (TRAINER_REGISTERED_FLAGS_START + REMATCH_KELLY)
...
#define FLAG_REGISTERED_SERGIO               (TRAINER_REGISTERED_FLAGS_START + REMATCH_SERGIO)
...
#define FLAG_REGISTERED_GISELLE              (TRAINER_REGISTERED_FLAGS_START + REMATCH_GISELLE)
...
// Free Block Hidden Items
#define FLAG_HIDDEN_ITEM_ROUTE_101_ORAN_BERRY         (FLAG_HIDDEN_ITEMS_START + 0x70) // Unused Flag
#define FLAG_HIDDEN_ITEM_ROUTE_125_BIG_PEARL          (FLAG_HIDDEN_ITEMS_START + 0x71) // Unused Flag
#define FLAG_HIDDEN_ITEM_118_RIVER_PATH_LIGHT_CLAY    (FLAG_HIDDEN_ITEMS_START + 0x72) // Unused Flag
#define FLAG_HIDDEN_ITEM_118_RIVER_PATH_BOTTLE_CAP    (FLAG_HIDDEN_ITEMS_START + 0x73) // Unused Flag
#define FLAG_HIDDEN_ITEM_DUNE_CAVERN_NUGGET           (FLAG_HIDDEN_ITEMS_START + 0x74) // Unused Flag
#define FLAG_HIDDEN_ITEM_ALTERING_CAVE_NUGGET         (FLAG_HIDDEN_ITEMS_START + 0x75) // Unused Flag
#define FLAG_HIDDEN_ITEM_ALTERING_CAVE_RARE_CANDY     (FLAG_HIDDEN_ITEMS_START + 0x76) // Unused Flag
#define FLAG_HIDDEN_ITEM_DUNE_CAVERN_B2F_YELLOW_SHARD (FLAG_HIDDEN_ITEMS_START + 0x77) // Unused Flag
#define FLAG_HIDDEN_ITEM_DUNE_CAVERN_B2F_NUGGET       (FLAG_HIDDEN_ITEMS_START + 0x78) // Unused Flag
#define FLAG_HIDDEN_ITEM_DUNE_CAVERN_YELLOW_SHARD     (FLAG_HIDDEN_ITEMS_START + 0x79) // Unused Flag
#define FLAG_HI_RUSTURF_TUNNEL_GREEN_SHARD_1          (FLAG_HIDDEN_ITEMS_START + 0x7A) // Unused Flag
#define FLAG_HI_RUSTURF_TUNNEL_GREEN_SHARD_2          (FLAG_HIDDEN_ITEMS_START + 0x7B) // Unused Flag
#define FLAG_HI_RUSTURF_TUNNEL_GREEN_SHARD_3          (FLAG_HIDDEN_ITEMS_START + 0x7C) // Unused Flag
#define FLAG_HIDDEN_ITEM_ROUTE_123_POWER_HERB         (FLAG_HIDDEN_ITEMS_START + 0x7D) // Unused Flag
#define FLAG_UNUSED_0x272                             (FLAG_HIDDEN_ITEMS_START + 0x7E) // Unused Flag
#define FLAG_UNUSED_0x273                             (FLAG_HIDDEN_ITEMS_START + 0x7F) // Unused Flag
#define FLAG_UNUSED_0x274                             (FLAG_HIDDEN_ITEMS_START + 0x80) // Unused Flag
#define FLAG_UNUSED_0x275                             (FLAG_HIDDEN_ITEMS_START + 0x81) // Unused Flag
#define FLAG_UNUSED_0x276                             (FLAG_HIDDEN_ITEMS_START + 0x82) // Unused Flag
#define FLAG_UNUSED_0x277                             (FLAG_HIDDEN_ITEMS_START + 0x83) // Unused Flag
#define FLAG_UNUSED_0x278                             (FLAG_HIDDEN_ITEMS_START + 0x84) // Unused Flag
#define FLAG_UNUSED_0x279                             (FLAG_HIDDEN_ITEMS_START + 0x85) // Unused Flag
#define FLAG_UNUSED_0x27A                             (FLAG_HIDDEN_ITEMS_START + 0x86) // Unused Flag
#define FLAG_UNUSED_0x27B                             (FLAG_HIDDEN_ITEMS_START + 0x87) // Unused Flag
#define FLAG_UNUSED_0x27C                             (FLAG_HIDDEN_ITEMS_START + 0x88) // Unused Flag
#define FLAG_UNUSED_0x27D                             (FLAG_HIDDEN_ITEMS_START + 0x89) // Unused Flag
#define FLAG_UNUSED_0x27E                             (FLAG_HIDDEN_ITEMS_START + 0x8A) // Unused Flag
#define FLAG_UNUSED_0x27F                             (FLAG_HIDDEN_ITEMS_START + 0x8B) // Unused Flag
#define FLAG_UNUSED_0x280                             (FLAG_HIDDEN_ITEMS_START + 0x8C) // Unused Flag
#define FLAG_UNUSED_0x281                             (FLAG_HIDDEN_ITEMS_START + 0x8D) // Unused Flag

// Free Block 2 (SCRIPTING)
...
#define FLAG_RECEIVED_TWISTED_SPOON        0x295 // Unused Flag
#define FLAG_RECEIVED_LIFE_ORB             0x296 // Unused Flag
#define FLAG_RECEIVED_PROTECTIVE_PADS      0x297 // Unused Flag
#define FLAG_RECEIVED_MICLE_BERRY          0x298 // Unused Flag
#define FLAG_RECEIVED_RIVAL_STARTER        0x299 // Unused Flag
#define FLAG_RECEIVED_SHELMET_KARRABLAST   0x29A // Unused Flag
#define FLAG_RECEIVED_HEAVY_DUTY_BOOTS     0x29B // Unused Flag
#define FLAG_RECEIVED_DAYCARE_DESTINY_KNOT 0x29C // Unused Flag
#define FLAG_RECEIVED_SAFETY_GOGGLES       0x29D // Unused Flag
#define FLAG_RECEIVED_BINDING_BAND         0x29E // Unused Flag
#define FLAG_RECEIVED_BLACK_BELT           0x29F // Unused Flag
#define FLAG_RECEIVED_BIKE_VOUCHER         0x2A0 // Unused Flag
#define FLAG_RECEIVED_TM_PETAL_DANCE       0x2A1 // Unused Flag
#define FLAG_RECEIVED_TM_HYPNOSIS          0x2A2 // Unused Flag
#define FLAG_RECEIVED_TM_YAWN              0x2A3 // Unused Flag
#define FLAG_RECEIVED_TM_TOXIC             0x2A4 // Unused Flag
#define FLAG_RECEIVED_TM_REVIVAL_BLESSING  0x2A5 // Unused Flag
#define FLAG_RECEIVED_TM_REJUVENATE        0x2A6 // Unused Flag
#define FLAG_RECEIVED_TM_FRUSTRATION       0x2A7 // Unused Flag
#define FLAG_RECEIVED_TM_RAPID_SPIN        0x2A8 // Unused Flag
#define FLAG_RECEIVED_TM_DAZZLING_GLEAM    0x2A9 // Unused Flag
#define FLAG_RECEIVED_TM_TAUNT             0x2AA // Unused Flag
#define FLAG_RECEIVED_TM_CHARM             0x2AB // Unused Flag
#define FLAG_RECEIVED_TM_FAKE_TEARS        0x2AC // Unused Flag
#define FLAG_RECEIVED_TM_CONFUSE_RAY       0x2AD // Unused Flag
#define FLAG_RECEIVED_TM_INCINERATE        0x2AE // Unused Flag
#define FLAG_RECEIVED_TM_SAFEGUARD         0x2AF // Unused Flag
#define FLAG_RECEIVED_TM_DEFOG             0x2B0 // Unused Flag
#define FLAG_RECEIVED_TM_MOONBLAST         0x2B1 // Unused Flag
#define FLAG_RECEIVED_TM_HYPER_VOICE       0x2B2 // Unused Flag
#define FLAG_RECEIVED_TM_TAKE_HEART        0x2B3 // Unused Flag
#define FLAG_CUTTER_REQUIREMENT            0x2B4 // Unused Flag
#define FLAG_MET_RUSTBORO_CUTTING_TUTOR    0x2B5 // Unused Flag
#define FLAG_MET_LILYCOVE_GRAB_TUTOR       0x2B6 // Unused Flag
#define FLAG_HIDE_TRICK_HOUSE_TUTOR        0x2B7 // Unused Flag
#define FLAG_MET_LAVARIDGE_WHIP_TUTOR      0x2B8 // Unused Flag
#define FLAG_RARE_CANDY_GIRL               0x2B9 // Unused Flag
#define FLAG_RARE_CANDY_GIRL2              0x2BA // Unused Flag
#define FLAG_RARE_CANDY_GIRL3              0x2BB // Unused Flag
...
#define FLAG_HIDE_EVERGRANDE_CITY_MEADOW_LADY                       0x2D9 // Unused Flag
...
#define FLAG_HIDE_MIRAGE_ISLAND_MEADOW_LADY                         0x339 // Unused, leftover from R/S
...
#define FLAG_HIDE_MIRAGE_TOWER_HELIX_FOSSIL                         0x3C3
#define FLAG_HIDE_MIRAGE_TOWER_DOME_FOSSIL                          0x3C4
...
#define FLAG_ITEM_ROUTE_101_BIG_ROOT                                0x468 // Unused Flag
...
#define FLAG_ITEM_DUNE_CAVERN_SMOOTH_ROCK                           0x470 // Unused Flag
#define FLAG_ITEM_ROUTE_103_PP_UP                                   0x471
#define FLAG_ITEM_DUNE_CAVERN_SMACK_DOWN_TM                         0x472 // Unused Flag
...
#define FLAG_HIDE_EVERGRANDE_CITY_WALLACE                           0x496 // Unused Flag
#define FLAG_HIDE_HIKER_ALTERING_CAVE_B1F_1R                        0x497 // Unused Flag
#define FLAG_HIDE_HIKER_ALTERING_CAVE_B1F_2R                        0x498 // Unused Flag
#define FLAG_HIDE_PETALBURG_POKEMART_CLERK                          0x499 // Unused Flag
#define FLAG_HIDE_ROUTE_111_TEAM_MAGMA                              0x49A // Unused Flag
#define FLAG_HIDE_FIERY_PATH_TEAM_MAGMA                             0x49B // Unused Flag
#define FLAG_HIDE_DAYCARE_GIRL                                      0x49C // Unused Flag
#define FLAG_HIDE_DAYCARE_OLD_MAN                                   0x49D // Unused Flag
#define FLAG_HIDE_PETALBURG_CITY_DOJO_GUARDS                        0x49E // Unused Flag
#define FLAG_HIDE_LAVARIDGE_TOWN_OLD_MAN                            0x49F // Unused Flag
#define FLAG_HIDE_LODGE_NORMAN                                      0x4A0 // Unused Flag
#define FLAG_HIDE_CHAMPION_ROOM_WALLY                               0x4A1 // Unused Flag
#define FLAG_HIDE_CHAMPION_ROOM_WALLACE                             0x4A2 // Unused Flag
#define FLAG_HIDE_BALL_TERRAIN_EXTENDER                             0x4A3 // Unused Flag
#define FLAG_HIDE_NEW_MAUVILLE_TRAINERS                             0x4A4 // Unused Flag
#define FLAG_HIDE_SEA_MAUVILLE_ROTOM                                0x4A5 // Unused Flag
#define FLAG_HIDE_RUSTBORO_MAGMA_GRUNT                              0x4A6 // Unused Flag
#define FLAG_HIDE_ROUTE_116_MAGMA_GRUNT                             0x4A7 // Unused Flag
#define FLAG_HIDE_RUSTURF_TUNNEL_HOUNDOUR                           0x4A8 // Unused Flag
...
#define FLAG_HIDE_BIKE_SHOP_BALL                                    0x4CC // Unused Flag
#define FLAG_HIDE_ROUTE_107_FOSSIL                                  0x4CD // Unused Flag
#define FLAG_HIDE_VICTORY_ROAD_FOSSIL                               0x4CE // Unused Flag
#define FLAG_HIDE_ROUTE_124_FOSSIL                                  0x4CF // Unused Flag
#define FLAG_HIDE_GRANITE_CAVE_FOSSIL                               0x4D0 // Unused Flag
#define FLAG_HIDE_DESERT_UNDERPASS_JAW_FOSSIL                       0x4D1 // Unused Flag
#define FLAG_HIDE_DUNE_CAVERN_FOSSIL                                0x4D2 // Unused Flag
#define FLAG_HIDE_SHOAL_CAVE_FOSSIL                                 0x4D3 // Unused Flag
...
#define FLAG_ITEM_TRICK_HOUSE_PUZZLE_4_POWER_HERB                   0x4DA // Unused Flag
#define FLAG_ITEM_TRICK_HOUSE_PUZZLE_6_MIRROR_HERB                  0x4DB // Unused Flag
#define FLAG_ITEM_TRICK_HOUSE_PUZZLE_5_STARDUST                     0x4DC // Unused Flag
#define FLAG_ITEM_METEOR_FALLS_1F_2R_MASTER_BALL                    0x4DD // Unused Flag
#define FLAG_ITEM_LAVARIDGE_TOWN_YOGA_POSE                          0x4DE // Unused Flag
#define FLAG_ITEM_RUSTURF_TUNNEL_MIST                               0x4DF // Unused Flag
#define FLAG_ITEM_ROUTE_114_IRON_DEFENSE                            0x4E0 // Unused Flag
#define FLAG_ITEM_METEOR_FALLS_QUICK_POWDER                         0x4E1 // Unused Flag
#define FLAG_ITEM_LANETTE_UPGRADE                                   0x4E2 // Unused Flag
#define FLAG_ITEM_ROUTE_112_POISON_BARB                             0x4E3 // Unused Flag
#define FLAG_ITEM_LAVARIDGE_TOWN_FIRE_STONE                         0x4E4 // Unused Flag
#define FLAG_ITEM_ROUTE_129_LUCKY_VEST                              0x4E5 // Unused Flag
#define FLAG_ITEM_ALTERING_CAVE_METAL_POWDER                        0x4E6 // Unused Flag
#define FLAG_ITEM_FALLARBOR_TOXIC_ORB                               0x4E7 // Unused Flag
#define FLAG_ITEM_MT_PYRE_CALAMITY_CHARM                            0x4E8 // Unused Flag
#define FLAG_ITEM_118_RIVER_PATH_WATER_STONE                        0x4E9 // Unused Flag
#define FLAG_ITEM_ALTERING_CAVE_ICE_STONE                           0x4EA // Unused Flag
#define FLAG_ITEM_ALTERING_CAVE_MAX_REVIVE                          0x4EB // Unused Flag
#define FLAG_ITEM_TM_EERIE_IMPULSE                                  0x4EC // Unused Flag
#define FLAG_ITEM_MT_CHIMNEY_HEAT_ROCK                              0x4ED // Unused Flag
#define FLAG_ITEM_NEW_MAUVILLE_B1F_DUBIOUS_DISC                     0x4EE // Unused Flag
#define FLAG_ITEM_NEW_MAUVILLE_B1F_LIGHT_BALL                       0x4EF // Unused Flag
...
#define FLAG_WALLY_DRIVE                            (SYSTEM_FLAGS + 0x21) // Unused Flag
#define FLAG_RECEIVED_SHINY_CHARM                   (SYSTEM_FLAGS + 0x22) // Unused Flag
...
// Free Block System Flags
#define FLAG_NO_TRAINER_SEE                         (SYSTEM_FLAGS + 0x85) // Unused Flag
#define FLAG_NO_COLLISION                           (SYSTEM_FLAGS + 0x86) // Unused Flag
#define FLAG_DISABLE_ENCOUNTERS                     (SYSTEM_FLAGS + 0x87) // Unused Flag
#define FLAG_NO_CATCHING                            (SYSTEM_FLAGS + 0x88) // Unused Flag
#define FLAG_NO_RUNNING                             (SYSTEM_FLAGS + 0x89) // Unused Flag
#define FLAG_NO_WHITEOUT                            (SYSTEM_FLAGS + 0x8A) // Unused Flag
#define FLAG_INVERSE_BATTLE                         (SYSTEM_FLAGS + 0x8B) // Unused Flag
#define FLAG_NO_BAG_USE                             (SYSTEM_FLAGS + 0x8C) // Unused Flag
#define FLAG_FORCE_DOUBLE_WILD                      (SYSTEM_FLAGS + 0x8D) // Unused Flag
#define FLAG_SMART_WILD_MON                         (SYSTEM_FLAGS + 0x8E) // Unused Flag
#define FLAG_ACTIVATE_SEEKER                        (SYSTEM_FLAGS + 0x8F) // Unused Flag
#define FLAG_FORCED_SHINY                           (SYSTEM_FLAGS + 0x90) // Unused Flag
#define FLAG_ACTIVATE_EXP_SHARE                     (SYSTEM_FLAGS + 0x91) // Unused Flag
...
#define FLAG_COMPLETED_DOJO_RIGHT                   (SYSTEM_FLAGS + 0xB9) // Unused Flag
#define FLAG_COMPLETED_DOJO_LEFT                    (SYSTEM_FLAGS + 0xBA) // Unused Flag
...
#define FLAG_MOVE_RELEARNER_ACTIVE                  (SYSTEM_FLAGS + 0xBF) // Unused Flag

// Daily Flags
// These flags are cleared once per day
// The start and end are byte-aligned because the flags are cleared in byte increments
#define DAILY_FLAGS_START                           (FLAG_MOVE_RELEARNER_ACTIVE + (8 - FLAG_MOVE_RELEARNER_ACTIVE % 8))
...
#define FLAG_DEFEATED_ROXANNE_FINAL                 (DAILY_FLAGS_START + 0x15) // Unused Flag
#define FLAG_DEFEATED_WATTSON_FINAL                 (DAILY_FLAGS_START + 0x16) // Unused Flag
#define FLAG_DEFEATED_FLANNERY_FINAL                (DAILY_FLAGS_START + 0x17) // Unused Flag
#define FLAG_DEFEATED_WINONA_FINAL                  (DAILY_FLAGS_START + 0x18) // Unused Flag
#define FLAG_DEFEATED_NORMAN_FINAL                  (DAILY_FLAGS_START + 0x19) // Unused Flag
#define FLAG_DEFEATED_BRAWLY_FINAL                  (DAILY_FLAGS_START + 0x1A) // Unused Flag
#define FLAG_DEFEATED_TATE_LIZA_FINAL               (DAILY_FLAGS_START + 0x1B) // Unused Flag
#define FLAG_DEFEATED_JUAN_FINAL                    (DAILY_FLAGS_START + 0x1C) // Unused Flag
