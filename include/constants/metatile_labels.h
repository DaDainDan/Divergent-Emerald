...
#define METATILE_BikeShop_SidewaysStairs_Entrance  0x23D
...
#define METATILE_Cave_ShoalCave_IcyDirtPile_Large        0x397
...
#define METATILE_General_LongGrassRoot_General  0x135
