...
#define AI_FLAG_BASIC_TRAINER         (AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY | AI_FLAG_HP_AWARE | AI_FLAG_PP_STALL_PREVENTION | AI_FLAG_RANDOMIZE_SWITCHIN)
#define AI_FLAG_SMART_TRAINER         (AI_FLAG_BASIC_TRAINER | AI_FLAG_SMART_SWITCHING | AI_FLAG_SMART_MON_CHOICES | AI_FLAG_ASSUMPTIONS | AI_FLAG_PREDICTION | AI_FLAG_SMART_TERA)
#define AI_FLAG_ELITE_TRAINER         (AI_FLAG_BASIC_TRAINER | AI_FLAG_SMART_SWITCHING | AI_FLAG_SMART_MON_CHOICES | AI_FLAG_OMNISCIENT | AI_FLAG_PREDICTION | AI_FLAG_SMART_TERA)
...
#define AI_FLAG_KAMIKAZE              (AI_FLAG_PREFER_HIGHEST_DAMAGE_MOVE | AI_FLAG_RISKY | AI_FLAG_WILL_SUICIDE)
