...
enum MoveEffects
{
    ...
    MOVE_EFFECT_ATK_PLUS_3,
    MOVE_EFFECT_DEF_PLUS_3,
    MOVE_EFFECT_SPD_PLUS_3,
    MOVE_EFFECT_SP_ATK_PLUS_3,
    MOVE_EFFECT_SP_DEF_PLUS_3,
    MOVE_EFFECT_ACC_PLUS_3,
    MOVE_EFFECT_EVS_PLUS_3,
    MOVE_EFFECT_ATK_MINUS_3,
    MOVE_EFFECT_DEF_MINUS_3,
    MOVE_EFFECT_SPD_MINUS_3,
    MOVE_EFFECT_SP_ATK_MINUS_3,
    MOVE_EFFECT_SP_DEF_MINUS_3,
    MOVE_EFFECT_ACC_MINUS_3,
    MOVE_EFFECT_EVS_MINUS_3,
    MOVE_EFFECT_RANDOM_STAT_PLUS_1,
    MOVE_EFFECT_RANDOM_STAT_MINUS_1,
