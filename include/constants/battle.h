...
#define VOLATILE_DEFINITIONS(F) \
    ...
    // F(VOLATILE_GUARD_SWAP,               guardSwapped,                  (u32, 1))
    // F(VOLATILE_POWER_SWAP,               powerSwapped,                  (u32, 1))
...
#define STATUS_FIELD_ERROR_ROOM                     (1 << 8)
#define STATUS_FIELD_STATIC_ROOM                    (1 << 9)
#define STATUS_FIELD_REVERSE_ROOM                   (1 << 10)
#define STATUS_FIELD_GRIM_ROOM                      (1 << 11)
