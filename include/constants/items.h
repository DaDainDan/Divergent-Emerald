...
enum __attribute__((packed)) Item
{
    ...
    // PROMISE
    ITEM_SUPPORT_VEST = 874,
    ITEM_CALAMITY_CHARM = 875,
    ITEM_SNACK = 876,
    ITEM_LUCKY_VEST = 877,
    ITEM_HAPLESS_POLICY = 878,
    ITEM_FINE_LENS = 879,
    ITEM_BLANK_SLATE = 880,
    ITEM_CURSED_ORB = 881,
    ITEM_FROZEN_ORB = 882,
    ITEM_LUCKY_SEED = 883,
    ITEM_MOUNTAIN_SEED = 884,
    ITEM_SPOOKY_SEED = 885,
    ITEM_JADE_ORB = 886,
// GODSBANE
// MUSIC BOX
// SAFETY HARNESS
...
#define CONFUSE_BERRY_HP_FRACTION ((B_CONFUSE_BERRIES_HEAL >= GEN_7) ? 3 : 2)
