...
#define MOVE_LIMITATION_NO_FOURTH_MOVE          (1 << 15)
#define MOVE_LIMITATION_SUPPORT_VEST            (1 << 16)
#define MOVE_LIMITATION_TRUCE                   (1 << 17)

#define MOVE_LIMITATION_PLACEHOLDER             (1 << 31)
#define MOVE_LIMITATIONS_ALL                    0xFFFFFFFF
