...
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_BikerIntro[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_BikerMon1[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_BikerMon2Ask[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_BikerAccept[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_BikerReject[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_GamerIntro[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_GamerMon1[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_GamerMon2Ask[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_GamerAccept[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_GamerReject[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_BurglarIntro[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_BurglarMon1[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_BurglarMon2Ask[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_BurglarAccept[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_BurglarReject[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_ScientistIntro[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_ScientistMon1[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_ScientistMon2Ask[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_ScientistAccept[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_ScientistReject[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_JugglerIntro[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_JugglerMon1[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_JugglerMon2Ask[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_JugglerAccept[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_JugglerReject[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_EngineerIntro[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_EngineerMon1[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_EngineerMon2Ask[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_EngineerAccept[];
extern const u8 BattleFrontier_BattleTowerMultiPartnerRoom_Text_EngineerReject[];
