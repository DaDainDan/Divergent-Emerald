...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_PKMN_TRAINER_2] =    { _("{PKMN} TRAINER") }, // Unused
    [TRAINER_CLASS_HIKER] =             { _("HIKER"), 12, BALL_SAFARI },
    [TRAINER_CLASS_TEAM_AQUA] =         { _("TEAM AQUA"), 6, BALL_DIVE },
    [TRAINER_CLASS_PKMN_BREEDER] =      { _("{PKMN} BREEDER"), 4, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_FRIEND : BALL_HEAL},
    [TRAINER_CLASS_COOLTRAINER] =       { _("ACE TRAINER"), 20, BALL_PREMIER },
    [TRAINER_CLASS_BIRD_KEEPER] =       { _("BIRD KEEPER"), 12, BALL_QUICK },
    [TRAINER_CLASS_COLLECTOR] =         { _("COLLECTOR"), 12 },
    [TRAINER_CLASS_SWIMMER_M] =         { _("SWIMMER"), 8, BALL_DIVE },
    [TRAINER_CLASS_TEAM_MAGMA] =        { _("TEAM MAGMA"), 6, BALL_TIMER },
    [TRAINER_CLASS_EXPERT] =            { _("EXPERT"), 16, BALL_ULTRA },
    [TRAINER_CLASS_AQUA_ADMIN] =        { _("AQUA ADMIN"), 20, BALL_DIVE},
    [TRAINER_CLASS_BLACK_BELT] =        { _("BLACK BELT"), 12, BALL_ULTRA },
    [TRAINER_CLASS_AQUA_LEADER] =       { _("AQUA LEADER"), 30, BALL_LURE },
    [TRAINER_CLASS_HEX_MANIAC] =        { _("HEX MANIAC"), 12, BALL_DUSK },
    [TRAINER_CLASS_AROMA_LADY] =        { _("AROMA LADY"), 8, BALL_HEAL },
    [TRAINER_CLASS_RUIN_MANIAC] =       { _("RUIN MANIAC"), 16, BALL_SAFARI },
    [TRAINER_CLASS_INTERVIEWER] =       { _("INTERVIEWERS"), 16, BALL_PREMIER },
    [TRAINER_CLASS_TUBER_F] =           { _("TUBER"), 1, BALL_DIVE },
    [TRAINER_CLASS_TUBER_M] =           { _("TUBER"), 1, BALL_DIVE },
    [TRAINER_CLASS_LADY] =              { _("LADY"), 24, BALL_LUXURY },
    [TRAINER_CLASS_BEAUTY] =            { _("BEAUTY"), 16, BALL_PREMIER },
    [TRAINER_CLASS_RICH_BOY] =          { _("RICH BOY"), 24, BALL_LUXURY },
    [TRAINER_CLASS_POKEMANIAC] =        { _("POKé MANIAC"), 6, BALL_LURE },
    [TRAINER_CLASS_GUITARIST] =         { _("GUITARIST"), 8, BALL_FAST },
    [TRAINER_CLASS_KINDLER] =           { _("KINDLER"), 6, BALL_FAST },
    [TRAINER_CLASS_CAMPER] =            { _("BOY SCOUT"), 3, BALL_NEST },
    [TRAINER_CLASS_PICNICKER] =         { _("GIRL SCOUT"), 3, BALL_NEST },
    [TRAINER_CLASS_BUG_MANIAC] =        { _("BUG MANIAC"), 12, BALL_NET },
    [TRAINER_CLASS_PSYCHIC] =           { _("PSYCHIC"), 12, BALL_DREAM },
    [TRAINER_CLASS_GENTLEMAN] =         { _("GENTLEMAN"), 36, BALL_LUXURY },
    [TRAINER_CLASS_ELITE_FOUR] =        { _("ELITE FOUR"), 60, BALL_CHERISH },
    [TRAINER_CLASS_LEADER] =            { _("GYM LEADER"), 30, BALL_CHERISH },
    [TRAINER_CLASS_MASTER] =            { _("GYM LEADER"), 25, BALL_ULTRA },
    [TRAINER_CLASS_SCHOOL_KID] =        { _("SCHOOL KID"), 2 },
    [TRAINER_CLASS_SR_AND_JR] =         { _("CLASSMATES"), 4 },
    [TRAINER_CLASS_WINSTRATE] =         { _("WINSTRATE"), 12 },
    [TRAINER_CLASS_POKEFAN] =           { _("POKé FAN"), 4, BALL_FRIEND },
    [TRAINER_CLASS_YOUNGSTER] =         { _("YOUNGSTER"), 2, BALL_GREAT },
    [TRAINER_CLASS_CHAMPION] =          { _("CHAMPION"), 120, BALL_CHERISH },
    [TRAINER_CLASS_FISHERMAN] =         { _("FISHER"), 4, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_NET : BALL_LURE },
    [TRAINER_CLASS_TRIATHLETE] =        { _("TRIATHLETE"), 8, BALL_FAST },
    [TRAINER_CLASS_DRAGON_TAMER] =      { _("DRAGON TAMER"), 20, BALL_LURE },
    [TRAINER_CLASS_NINJA_BOY] =         { _("NINJA BOY"), 3, BALL_DUSK },
    [TRAINER_CLASS_BATTLE_GIRL] =       { _("BATTLE GIRL"), 6, BALL_FAST },
    [TRAINER_CLASS_PARASOL_LADY] =      { _("PARASOL LADY"), 8, BALL_PREMIER },
    [TRAINER_CLASS_SWIMMER_F] =         { _("SWIMMER"), 8, BALL_DIVE },
    [TRAINER_CLASS_TWINS] =             { _("TWINS"), 1, BALL_FRIEND },
    [TRAINER_CLASS_SAILOR] =            { _("SAILOR"), 8, BALL_NET },
    [TRAINER_CLASS_COOLTRAINER_2] =     { _("ACE TRAINER"), 20, BALL_PREMIER },
    [TRAINER_CLASS_MAGMA_ADMIN] =       { _("MAGMA ADMIN"), 20, BALL_TIMER },
    [TRAINER_CLASS_RIVAL] =             { _("RIVAL"), 16, BALL_GREAT },
    [TRAINER_CLASS_BUG_CATCHER] =       { _("BUG CATCHER"), 2, BALL_NET },
    [TRAINER_CLASS_PKMN_RANGER] =       { _("{PKMN} RANGER"), 16, BALL_SAFARI },
    [TRAINER_CLASS_MAGMA_LEADER] =      { _("MAGMA LEADER"), 20, BALL_TIMER },
    [TRAINER_CLASS_LASS] =              { _("LASS"), 4 },
    [TRAINER_CLASS_YOUNG_COUPLE] =      { _("YOUNG COUPLE"), 4, BALL_LOVE },
    [TRAINER_CLASS_OLD_COUPLE] =        { _("OLD COUPLE"), 16, BALL_LOVE },
    [TRAINER_CLASS_SIS_AND_BRO] =       { _("SIS & BRO"), 4, BALL_DIVE },
    [TRAINER_CLASS_SALON_MAIDEN] =      { _("TOWER MAIDEN") },
    ...
    [TRAINER_CLASS_BIKER_FRLG] =           { _("BIKER"), 12, BALL_HEAVY },
    [TRAINER_CLASS_BURGLAR_FRLG] =         { _("BURGLAR"), 6, BALL_MOON },
    [TRAINER_CLASS_ENGINEER_FRLG] =        { _("ENGINEER"), 8, BALL_TIMER },
    [TRAINER_CLASS_FISHERMAN_FRLG] =       { _("FISHER"), 9, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_DIVE : BALL_LURE },
    [TRAINER_CLASS_SWIMMER_M_FRLG] =       { _("SWIMMER"), 1 },
    [TRAINER_CLASS_CUE_BALL_FRLG] =        { _("ROUGHNECK"), 6 },
    [TRAINER_CLASS_GAMER_FRLG] =           { _("GAMBLER"), 12, BALL_NEST },
    ...
    [TRAINER_CLASS_JUGGLER_FRLG] =         { _("JUGGLER"), 12, BALL_REPEAT },
    ...
    [TRAINER_CLASS_SCIENTIST_FRLG] =       { _("SCIENTIST"), 16, BALL_TIMER },
    [TRAINER_CLASS_BOSS_FRLG] =            { _("ROCKET BOSS"), 25 },
    [TRAINER_CLASS_LEADER_FRLG] =          { _("GYM LEADER"), 25 },
    ...
    [TRAINER_CLASS_SIS_AND_BRO_FRLG] =     { _("SIS & BRO"), 1 },
...
static void ClearSetDataOnLeave(enum BattlerId battler)
{
    ...
    gProtectStructs[battler].direOmen = 0;
    ...
    gProtectStructs[battler].usedFuryCutter = FALSE;
    gProtectStructs[battler].soloFollowMeTimer = FALSE;
    gProtectStructs[battler].howlActive = FALSE;
...
bool32 EndTurnEvents(void) // Called from Battle Script
{
    ...
    for (enum BattlerId battler = 0; battler < gBattlersCount; battler++)
    {
        ...
        gBattleMons[battler].volatiles.block = FALSE;
        gBattleMons[battler].volatiles.flinched = FALSE;
                ...
                case B_ACTION_USE_MOVE:
                    ...
                    default:
                        ...
                        else
                        {
                            ...
                            if (GetBattlerHoldEffect(battler) == HOLD_EFFECT_LAGGING_TAIL || GetBattlerHoldEffect(battler) == HOLD_EFFECT_ZOOM_LENS)
                                gProtectStructs[battler].slowItem = TRUE;
...
u32 GetBattlerTotalSpeedStat(enum BattlerId battler, enum Ability ability, enum HoldEffect holdEffect)
{
    ...
    if (ability == ABILITY_SWIFT_SWIM       && holdEffect != HOLD_EFFECT_UTILITY_UMBRELLA && weather  & B_WEATHER_RAIN)
        ...
        speed = (speed * 125) / 100;
    else if (ability == ABILITY_SOLAR_POWER && holdEffect != HOLD_EFFECT_UTILITY_UMBRELLA && weather & B_WEATHER_SUN)
        speed = (speed * 120) / 100;
    else if (ability == ABILITY_SAND_RUSH   && holdEffect != HOLD_EFFECT_UTILITY_UMBRELLA && weather & B_WEATHER_SANDSTORM)
        speed = (speed * 133) / 100;
    else if (ability == ABILITY_SLUSH_RUSH  && holdEffect != HOLD_EFFECT_UTILITY_UMBRELLA && weather & B_WEATHER_ICY_ANY)
        speed = (speed * 133) / 100;

    // other abilities
    if (ability == ABILITY_QUICK_FEET && IsBattlerGrounded(battler, ability, holdEffect)) // && gBattleMons[battler].status1 & STATUS1_ANY
        speed = (speed * 125) / 100;
    ...
    if (holdEffect == HOLD_EFFECT_MACHO_BRACE || holdEffect == HOLD_EFFECT_POWER_ITEM)
        ...
        speed /= 2;
    else if ((holdEffect == HOLD_EFFECT_CHOICE_SCARF || holdEffect == HOLD_EFFECT_CHOICE_SCARF_NEW) && GetActiveGimmick(battler) != GIMMICK_DYNAMAX)
        speed = (speed * 133) / 100;
        ...
        speed = (speed * 125) / 100;
    else if (holdEffect == HOLD_EFFECT_EVIOLITE && CanEvolve(gBattleMons[battler].species))
        speed = (speed * 115) / 100;
    else if (holdEffect == HOLD_EFFECT_FLOAT_STONE)
        speed = (speed * 110) / 100;
    else if (holdEffect == HOLD_EFFECT_PROTECTOR)
        speed = (speed * 60) / 100;
    else if (holdEffect == HOLD_EFFECT_LUSTROUS_ORB && GET_BASE_SPECIES_ID(gBattleMons[battler].species) == SPECIES_PALKIA
    ...
    if (gFieldStatuses & STATUS_FIELD_GRAVITY && 
       (!IS_BATTLER_OF_TYPE(battler, TYPE_PSYCHIC) || IsSpookyTerrainAffected(battler, gFieldTimers.terrain)))
        speed = (speed * 60) / 100;
...
s32 GetBattleMovePriority(enum BattlerId battler, enum Ability ability, enum Move move)
{
    ...
    // Move Effect
    if (effect == EFFECT_GRASSY_GLIDE
          && IsGrassyTerrainAffected(battler, gFieldTimers.terrain)
          && GetActiveGimmick(gBattlerAttacker) != GIMMICK_DYNAMAX && !IsGimmickSelected(battler, GIMMICK_DYNAMAX))
    {
        priority++;
    }
    else if (effect == EFFECT_FLASH_FLOOD 
          && IsBattlerWeatherAffected(GetBattlerHoldEffect(battler), GetWeather(), B_WEATHER_RAIN)
          && GetActiveGimmick(gBattlerAttacker) != GIMMICK_DYNAMAX && !IsGimmickSelected(battler, GIMMICK_DYNAMAX))
    {
        priority++;
    }
    else if (effect == EFFECT_ACROBATICS && (gBattleMons[battler].item == ITEM_NONE
            // Edge case, because removal of items happens after damage calculation.
            || (gSpecialStatuses[battler].gemBoost && GetBattlerHoldEffect(battler) == HOLD_EFFECT_GEMS)))
    {
        priority++;
    }
    else if (effect == EFFECT_ROLLOUT && gBattleMons[battler].volatiles.defenseCurl)
    {
        priority++;
    }
    else if (effect == EFFECT_AFTERSHOCK 
         && (GetMoveEffect(gLastPrintedMoves[battler]) == EFFECT_EARTHQUAKE || IsFaultyTerrainAffected(battler, gFieldTimers.terrain)))
    {
        priority++;
    }
    else if (effect == EFFECT_FLORAL_HEALING && IsGrassyTerrainAffected(battler, gFieldTimers.terrain))
    {    
        priority += 3;
    }

    if (!IS_BATTLER_ANY_TYPE(battler, TYPE_GROUND, TYPE_TERRA, TYPE_SAND, TYPE_MUD) && effect != EFFECT_EARTHQUAKE && IsBattlerGrounded(battler, ability, GetBattlerHoldEffect(battler))
        && IsFaultyTerrainAffected(battler, gFieldTimers.terrain) && !RandomPercentage(RNG_FAULTY_TERRAIN, 50))
    {
        priority--;
    }

    if (ability == ABILITY_OWN_TEMPO || IsPsychicTerrainAffected(battler, gFieldTimers.terrain)
        || gProtectStructs[battler].eatPowerHerb) // Might need to prevent this from affecting Roar
        priority = 0;
...
s32 GetWhichBattlerFasterArgs(struct BattleCalcValues *calcValues, bool32 ignoreChosenMoves, u32 speedBattler1, u32 speedBattler2, s32 priority1, s32 priority2)
{
    ...
    if (priority1 == priority2)
    {
        ...
        bool32 battler1HasSlowEffect = battler1HasStallingAbility || gProtectStructs[calcValues->battlerAtk].slowItem;
        bool32 battler2HasSlowEffect = battler2HasStallingAbility || gProtectStructs[calcValues->battlerDef].slowItem;

        if (calcValues->abilities[calcValues->battlerAtk] == ABILITY_MAJESTY && calcValues->abilities[calcValues->battlerDef] != ABILITY_MAJESTY)
            strikesFirst = 1;
        else if (calcValues->abilities[calcValues->battlerDef] == ABILITY_MAJESTY && calcValues->abilities[calcValues->battlerAtk] != ABILITY_MAJESTY)
            strikesFirst = -1;
        ...
        else
        {
            ...
            for (battler = 0; battler < gBattlersCount; battler++)
            {
                  ...
                  && gChosenActionByBattler[battler] != B_ACTION_THROW_BALL)
                {
                    gActionsByTurnOrder[turnOrderId] = gChosenActionByBattler[battler];
                    gBattlerByTurnOrder[turnOrderId] = battler;
                    quickClawRandom[battler] = 0; // RandomPercentage(RNG_QUICK_CLAW, GetBattlerHoldEffectParam(battler))
                    quickDrawRandom[battler] = 0; // RandomPercentage(RNG_QUICK_DRAW, 30)
                    turnOrderId++;
                }
            }
...
static void TurnValuesCleanUp(bool32 endTurn)
{
    for (enum BattlerId i = 0; i < gBattlersCount; i++)
    {
        if (endTurn)
        {
            ...
            gProtectStructs[i].eatPowerHerb = FALSE;
            gProtectStructs[i].soloFollowMeTimer = FALSE;
        }
        else
        {
            ...
            gBattleStruct->battlerState[i].wasAboveQuarterHp = FALSE;
        }
...
const u8 *GetChargingSetUpScript(enum BattleMoveEffects moveEffect, bool32 inMiddleOfTurn)
{
    ...
    case EFFECT_REFLECT_DAMAGE:
        if (gChosenMoveByBattler[gBattlerAttacker] == MOVE_VITAL_THROW)
            return inMiddleOfTurn ? BattleScript_VitalThrowSetUpEncored : BattleScript_VitalThrowSetUp;
        else
            return NULL;
    default:
        return NULL;
...
static void TryChangingTurnOrderEffects(struct BattleCalcValues *calcValues, u32 *quickClawRandom, u32 *quickDrawRandom)
{
    ...
    // Battler 1
    // Quick Draw
    if (ability1 == ABILITY_QUICK_DRAW && !IsBattleMoveStatus(gChosenMoveByBattler[battler1]) && gBattleStruct->battlerState[gBattlerAttacker].isFirstTurn)
        gProtectStructs[battler1].quickDraw = TRUE;
    // Quick Claw and Custap Berry
    if (!gProtectStructs[battler1].quickDraw
     && ((holdEffectBattler1 == HOLD_EFFECT_QUICK_CLAW && IsClawMove(gChosenMoveByBattler[battler1])) //  && quickClawRandom[battler1]
     || (holdEffectBattler1 == HOLD_EFFECT_CUSTAP_BERRY && HasEnoughHpToEatBerry(battler1, ability1, 3, gBattleMons[battler1].item))))
        gProtectStructs[battler1].usedCustapBerry = TRUE;
    // Power Herb
    if (!gProtectStructs[battler1].eatPowerHerb
     && (holdEffectBattler1 == HOLD_EFFECT_POWER_HERB && (GetBattleMovePriority(battler1, ability1, gChosenMoveByBattler[battler1]) < 0)))
        gProtectStructs[battler1].eatPowerHerb = TRUE;

    // Battler 2
    // Quick Draw
    if (ability2 == ABILITY_QUICK_DRAW && !IsBattleMoveStatus(gChosenMoveByBattler[battler2]) && gBattleStruct->battlerState[gBattlerAttacker].isFirstTurn)
        gProtectStructs[battler2].quickDraw = TRUE;
    // Quick Claw and Custap Berry
    if (!gProtectStructs[battler2].quickDraw
     && ((holdEffectBattler2 == HOLD_EFFECT_QUICK_CLAW && IsClawMove(gChosenMoveByBattler[battler2])) // && quickClawRandom[battler2]
     || (holdEffectBattler2 == HOLD_EFFECT_CUSTAP_BERRY && HasEnoughHpToEatBerry(battler2, ability2, 3, gBattleMons[battler2].item))))
        gProtectStructs[battler2].usedCustapBerry = TRUE;
    // Power Herb
    if (!gProtectStructs[battler2].eatPowerHerb
     && (holdEffectBattler2 == HOLD_EFFECT_POWER_HERB && (GetBattleMovePriority(battler2, ability2, gChosenMoveByBattler[battler2]) < 0)))
        gProtectStructs[battler2].eatPowerHerb = TRUE;
}
    ...
    if (!(gHitMarker & HITMARKER_RUN))
    {
        while (gBattleScripting.battler < gBattlersCount)
        {
            ...
            if (gChosenActionByBattler[battler] == B_ACTION_USE_MOVE
             ...
             && (gProtectStructs[battler].usedCustapBerry || gProtectStructs[battler].quickDraw || gProtectStructs[battler].eatPowerHerb)
             && !(gBattleMons[battler].status1 & STATUS1_SLEEP)
             && !(gBattleMons[gBattlerAttacker].volatiles.truantCounter)
             && !(gProtectStructs[battler].noValidMoves))
            {
                if (gProtectStructs[battler].eatPowerHerb)
                {
...
enum Type GetDynamicMoveType(struct Pokemon *mon, enum Move move, enum BattlerId battler, enum Ability ability, enum HoldEffect holdEffect, enum MonState state)
{
    ...
    case EFFECT_TERRAIN_PULSE:
        if (state == MON_IN_BATTLE)
        {
            if (IsAnyTerrainAffected(battler, gFieldTimers.terrain))
...
void SetTypeBeforeUsingMove(enum Move move, enum BattlerId battler, enum Ability ability, enum HoldEffect holdEffect)
{
    ...
    if (holdEffect == HOLD_EFFECT_GEMS
        ...
        && effect != EFFECT_OHKO) // SPIRIT_AWAY?
    {
