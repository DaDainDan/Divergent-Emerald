...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_COOLTRAINER] = { _("COOLTRAINER"), 20, BALL_PREMIER },
    ...
    [TRAINER_CLASS_INTERVIEWER] = { _("INTERVIEWER"), 16, BALL_PREMIER },
    ...
    [TRAINER_CLASS_POKEMANIAC] = { _("POKéMANIAC"), 6, BALL_LURE },
    ...
    [TRAINER_CLASS_COOLTRAINER_2] = { _("COOLTRAINER"), 20, BALL_PREMIER },
    [TRAINER_CLASS_MAGMA_ADMIN] = { _("MAGMA ADMIN"), 20, BALL_TIMER },
    [TRAINER_CLASS_RIVAL] = { _("{PKMN} TRAINER"), 16, BALL_GREAT },
    ...
    [TRAINER_CLASS_SIS_AND_BRO] = { _("SIS AND BRO"), 4, BALL_DIVE },
...
static void TryChangingTurnOrderEffects(u32 battler1, u32 battler2, u32 *quickClawRandom, u32 *quickDrawRandom)
{
    ...
    if (!gProtectStructs[battler1].quickDraw
     ...
     || (holdEffectBattler1 == HOLD_EFFECT_CUSTAP_BERRY && HasEnoughHpToEatBerry(battler1, 3, gBattleMons[battler1].item))))
    ...
    if (!gProtectStructs[battler2].quickDraw
     ...
     || (holdEffectBattler2 == HOLD_EFFECT_CUSTAP_BERRY && HasEnoughHpToEatBerry(battler2, 3, gBattleMons[battler2].item))))
