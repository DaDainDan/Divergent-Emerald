...
{   // { width, height, offset }
    ...
    [TYPE_TERRA + 1]    = { 32, 12, 0x48 },
    [TYPE_FROST + 1]    = { 32, 12, 0x4C },
    [TYPE_OCEAN + 1]    = { 32, 12, 0x28 },
    [TYPE_FLAME + 1]    = { 32, 12, 0x24 },
    [TYPE_UNDEAD + 1]   = { 32, 12, 0x68 },
    [TYPE_WIND + 1]     = { 32, 12, 0x60 },
    [TYPE_MUD + 1]      = { 32, 12, 0x48 },
    [TYPE_SAND + 1]     = { 32, 12, 0x48 },
