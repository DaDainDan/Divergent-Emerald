...
{
    {.question = sQuizLadyQuestion1,  .answer = EC_WORD_POKEDEX,    .prize = ITEM_WHITE_HERB},
    {.question = sQuizLadyQuestion2,  .answer = EC_WORD_DARK,       .prize = ITEM_MENTAL_HERB},
    {.question = sQuizLadyQuestion3,  .answer = EC_WORD_LEVEL,      .prize = ITEM_MIRROR_HERB},
    {.question = sQuizLadyQuestion4,  .answer = EC_WORD_FLOWERS,    .prize = ITEM_BLUE_SHARD},
    {.question = sQuizLadyQuestion5,  .answer = EC_WORD_EGG,        .prize = ITEM_GREEN_SHARD},
    {.question = sQuizLadyQuestion6,  .answer = EC_WORD_OWN_TEMPO,  .prize = ITEM_YELLOW_SHARD},
    {.question = sQuizLadyQuestion7,  .answer = EC_WORD_ROCK,       .prize = ITEM_RED_SHARD},
    {.question = sQuizLadyQuestion8,  .answer = EC_WORD_SHADOW_TAG, .prize = ITEM_SITRUS_BERRY},
    {.question = sQuizLadyQuestion9,  .answer = EC_WORD_IMMUNITY,   .prize = ITEM_LUM_BERRY},
    {.question = sQuizLadyQuestion10, .answer = EC_WORD_POKEMON,    .prize = ITEM_LUXURY_BALL},
    {.question = sQuizLadyQuestion11, .answer = EC_WORD_PC,         .prize = ITEM_STARDUST},
    ...
    {.question = sQuizLadyQuestion15, .answer = EC_WORD_FIGHTING,   .prize = ITEM_PEARL},
    {.question = sQuizLadyQuestion16, .answer = EC_WORD_DARK,       .prize = ITEM_NUGGET},
};
...
static const struct LilycoveFavorLady sFavorLady[] =
{
    ...
    {.request = COMPOUND_STRING("pointy"),   .acceptedItems = sFavorLadyAcceptedItems_Pointy,   .prize = ITEM_PP_UP},
};
