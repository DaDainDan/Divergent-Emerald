...
static const struct FormChange sKeldeoFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_HP_PERCENT, SPECIES_KELDEO_RESOLUTE, ABILITY_BATTLE_BOND, HP_HIGHER_THAN,   1},
...
static const struct FormChange sGreninjaBattleBondFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_HP_PERCENT, SPECIES_GRENINJA_ASH, ABILITY_BATTLE_BOND, HP_HIGHER_THAN,   1},
...
static const struct FormChange sZygarde50PowerConstructFormChangeTable[] = {
    ...
    {FORM_CHANGE_BATTLE_HP_PERCENT,    SPECIES_ZYGARDE_COMPLETE, ABILITY_POWER_CONSTRUCT, HP_HIGHER_THAN, 50},
    {FORM_CHANGE_TERMINATOR},
};
...
{
    {FORM_CHANGE_BATTLE_SWITCH, SPECIES_PALAFIN_HERO, ITEM_SHED_SHELL},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sTerapagosFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_SWITCH, SPECIES_TERAPAGOS_TERASTAL, 0, ABILITY_TERA_SHIFT},
#if P_TERA_FORMS
