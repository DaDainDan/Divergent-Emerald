...
static const struct FormChange sDialgaFormChangeTable[] =
{
    ...
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DIALGA_ORIGIN, ITEM_ADAMANT_ORB}, // CRYSTAL
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sPalkiaFormChangeTable[] =
{
    ...
    {FORM_CHANGE_ITEM_HOLD, SPECIES_PALKIA_ORIGIN, ITEM_LUSTROUS_ORB}, // GLOBE
    {FORM_CHANGE_TERMINATOR},
};
...
{
    {FORM_CHANGE_MOVE, SPECIES_DARMANITAN_ZEN,      MOVE_CALM_MIND, WHEN_LEARNED},
    {FORM_CHANGE_MOVE, SPECIES_DARMANITAN_STANDARD, MOVE_CALM_MIND, WHEN_FORGOTTEN},
...
{
    {FORM_CHANGE_MOVE, SPECIES_DARMANITAN_GALAR_ZEN,      MOVE_RAGING_FURY, WHEN_LEARNED},
    {FORM_CHANGE_MOVE, SPECIES_DARMANITAN_GALAR_STANDARD, MOVE_RAGING_FURY, WHEN_FORGOTTEN},
...
{
    {FORM_CHANGE_BATTLE_SWITCH_IN,        SPECIES_KELDEO_RESOLUTE, ABILITY_BATTLE_BOND, MAX_FRIENDSHIP},
    {FORM_CHANGE_FAINT,         SPECIES_KELDEO_ORDINARY},
    {FORM_CHANGE_END_BATTLE,    SPECIES_KELDEO_ORDINARY},
...
{
    {FORM_CHANGE_ITEM_USE, SPECIES_MELOETTA_PIROUETTE, ITEM_REVEAL_GLASS},
    {FORM_CHANGE_ITEM_USE, SPECIES_MELOETTA_ARIA,      ITEM_REVEAL_GLASS},
...
static const struct FormChange sZygarde50PowerConstructFormChangeTable[] =
{
    ...
    {FORM_CHANGE_BATTLE_HP_PERCENT_TURN_END, SPECIES_ZYGARDE_10_POWER_CONSTRUCT, ABILITY_POWER_CONSTRUCT, HP_LOWER_EQ_THAN, 25},
    {FORM_CHANGE_BATTLE_HP_PERCENT_TURN_END, SPECIES_ZYGARDE_COMPLETE, ABILITY_POWER_CONSTRUCT, HP_HIGHER_THAN, 50},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sZygarde10PowerConstructFormChangeTable[] =
{
    ...
    {FORM_CHANGE_BATTLE_HP_PERCENT_TURN_END, SPECIES_ZYGARDE_50_POWER_CONSTRUCT, ABILITY_POWER_CONSTRUCT, HP_HIGHER_THAN, 25},
    {FORM_CHANGE_BATTLE_HP_PERCENT_TURN_END, SPECIES_ZYGARDE_COMPLETE, ABILITY_POWER_CONSTRUCT, HP_HIGHER_THAN, 50},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sDiancieFormChangeTable[] =
{
    ...
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DIANCIE_MEGA,   ITEM_LUSTROUS_ORB},
    {FORM_CHANGE_TERMINATOR},
};
...
{
    {FORM_CHANGE_BATTLE_HP_PERCENT_SEND_OUT, SPECIES_WISHIWASHI_SCHOOL, ABILITY_SCHOOLING, HP_HIGHER_THAN,   25, 40},
    // {FORM_CHANGE_BATTLE_HP_PERCENT_SEND_OUT, SPECIES_WISHIWASHI_SOLO,   ABILITY_SCHOOLING, HP_LOWER_EQ_THAN, 25},
    {FORM_CHANGE_BATTLE_HP_PERCENT_TURN_END, SPECIES_WISHIWASHI_SCHOOL, ABILITY_SCHOOLING, HP_HIGHER_THAN,   25, 40},
...
{
    {FORM_CHANGE_BATTLE_SWITCH_OUT, SPECIES_PALAFIN_HERO, ABILITY_ZERO_TO_HERO, ITEM_SHED_SHELL}, // Figure out Jet Punch and Aqua Jet swap on switch out
