...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_BULBASAUR] =
    {
        ...
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_HYDRATION, ABILITY_SYMBIOSIS },
    ...
    [SPECIES_IVYSAUR] =
    {
        ...
        .types = MON_TYPES(TYPE_GRASS, TYPE_DRAGON),
        .catchRate = 60,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 143 : 141,
        .evYield_HP = 2,
        .itemRare = ITEM_MIRACLE_SEED,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 30,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 48, SPECIES_VENUSAUR}),
    },

#if P_UPDATED_EXP_YIELDS >= GEN_8
    #define VENUSAUR_EXP_YIELD 251
    ...
    [SPECIES_VENUSAUR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_FLOWER_GIFT, ABILITY_AROMA_VEIL, ABILITY_SYMBIOSIS },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_CHARMANDER] =
    {
        ...
        .baseSpAttack  = 53,
        .baseSpDefense = 50,
        .types = MON_TYPES(TYPE_FLAME, TYPE_DRAGON),
        .catchRate = 75,
        .expYield = 77, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 62 : 65,
        .evYield_Attack = 1,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 25,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_BLAZE, ABILITY_COMPETITIVE, ABILITY_HUSTLE },
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 22, SPECIES_CHARMELEON}),
    },
    ...
    [SPECIES_CHARMELEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_BLAZE, ABILITY_COMPETITIVE, ABILITY_MOLD_BREAKER },
        .bodyColor = BODY_COLOR_RED,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 48, SPECIES_CHARIZARD}),
    },

#define CHARIZARD_SP_ATK (P_UPDATED_STATS >= GEN_2 ? 109 : 85)

#if P_UPDATED_EXP_YIELDS >= GEN_8
    #define CHARIZARD_EXP_YIELD 243
#elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_SQUIRTLE] =
    {
        ...
        .catchRate = 75,
        .expYield = 73, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 63 : 66,
        .evYield_Defense = 1,
        ...
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_SWIFT_SWIM, ABILITY_RESILIENCE },
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 22, SPECIES_WARTORTLE}),
    },
    ...
    [SPECIES_WARTORTLE] =
    {
        ...
        .types = MON_TYPES(TYPE_WATER, TYPE_NORMAL),
        .catchRate = 60,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 139 : 143,
        .evYield_Defense = 2,
        .itemRare = ITEM_BLACK_GLASSES,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 48, SPECIES_BLASTOISE}),
    },

#define BLASTOISE_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 105 : 85)

#if P_UPDATED_EXP_YIELDS >= GEN_8
    #define BLASTOISE_EXP_YIELD 253
#elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_BLASTOISE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_MEGA_LAUNCHER, ABILITY_STURDY },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_BUTTERFREE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_MIRACLE_EYE, ABILITY_NONE, ABILITY_TINTED_LENS },
    ...
    [SPECIES_WEEDLE] =
    {
        ...
        .catchRate = 255,
        .expYield = 42, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 39 : 52,
        .evYield_Attack = 1,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SHIELD_DUST, ABILITY_POISON_TOUCH, ABILITY_SILK_SPEW },
    ...
    [SPECIES_KAKUNA] =
    {
        ...
        .types = MON_TYPES(TYPE_BUG, TYPE_POISON),
        .catchRate = 180,
        .expYield = 76, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 72 : 71,
        .evYield_Defense = 2,
        .genderRatio = PERCENT_FEMALE(87.5),
        .eggCycles = 15,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_POISON_TOUCH, ABILITY_SHED_SKIN },
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 24, SPECIES_BEEDRILL}),
    },
    ...
    [SPECIES_BEEDRILL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_SNIPER, ABILITY_VENOMOUS },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_PIDGEY] =
    {
        ...
        .airborne = TRUE,
        .catchRate = 255,
        .expYield = 47, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 50 : 55,
        .evYield_Speed = 1,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
        ...
        .abilities = { ABILITY_BIG_PECKS, ABILITY_EARLY_BIRD, ABILITY_RUN_AWAY },
    #else
    ...
    [SPECIES_PIDGEOTTO] =
    {
        ...
        .airborne = TRUE,
        .catchRate = 120,
        .expYield = 138, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 122 : 113,
        .evYield_Speed = 2,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_BIG_PECKS, ABILITY_GALE_WINGS, ABILITY_KEEN_EYE },
    #else
        .abilities = { ABILITY_KEEN_EYE, ABILITY_NONE, ABILITY_BIG_PECKS },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 44, SPECIES_PIDGEOT}),
    },
    ...
    [SPECIES_PIDGEOT] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_BIG_PECKS, ABILITY_GALE_WINGS, ABILITY_DELTA_STREAM },
    #else
        .abilities = { ABILITY_KEEN_EYE, ABILITY_NONE, ABILITY_BIG_PECKS },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_RATTATA] =
    {
        ...
        .catchRate = 210,
        .expYield = 64, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 51 : 57,
        .evYield_Speed = 1,
        ...
        .abilities = { ABILITY_RUN_AWAY, ABILITY_QUICK_FEET, ABILITY_INFILTRATOR },
        ...
        .shinySpecies = SPECIES_RATTATA_ALOLA,
        .evolutions = EVOLUTION({EVO_LEVEL, 22, SPECIES_RATICATE}),
    },
    ...
    [SPECIES_RATICATE] =
    {
        ...
        .types = MON_TYPES(TYPE_DARK, TYPE_NORMAL),
        .catchRate = 120,
        .expYield = 170, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 145 : 116,
        .evYield_Speed = 2,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_DEFIANT, ABILITY_STRONG_JAW, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_PURPLE,
        ...
        .shinySpecies = SPECIES_RATICATE_ALOLA,
    },
    ...
    [SPECIES_SPEAROW] =
    {
        ...
        .baseSpAttack  = 37,
        .baseSpDefense = 58,
        .types = MON_TYPES(TYPE_UNDEAD, TYPE_FLYING),
        .airborne = TRUE,
        .catchRate = 180,
        .expYield = 60, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 52 : 58,
        .evYield_SpAttack = 1,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_SNIPER, ABILITY_UNNERVE, ABILITY_INFILTRATOR },
    ...
    [SPECIES_FEAROW] =
    {
        ...
        .airborne = TRUE,
        .catchRate = 60,
        .expYield = 232, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 155 : 162,
        .evYield_Speed = 1,
        .evYield_SpDefense = 1,
    ...
    [SPECIES_EKANS] =
    {
        ...
        .catchRate = 210,
        .expYield = 68, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 58 : 62,
        .evYield_Attack = 1,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 25,
        .friendship = STANDARD_FRIENDSHIP,
        ...
        .abilities = { ABILITY_INFILTRATOR, ABILITY_SHED_SKIN, ABILITY_RATTLED },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Ekans"),
        .cryId = CRY_EKANS,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_ARBOK}),
    },
    ...
    [SPECIES_ARBOK] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_DRAGON),
        .abilities = { ABILITY_UNNERVE, ABILITY_SHED_SKIN, ABILITY_MERCILESS },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Arbok"),
        .cryId = CRY_ARBOK,
    ...
    [SPECIES_PICHU] =
    {
        ...
        .catchRate = 255,
        .expYield = 44, //(P_UPDATED_EXP_YIELDS >= GEN_5) ? 41 : 42,
        .evYield_Speed = 1,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = 100,
        ...
        .abilities = { ABILITY_RECKLESS, ABILITY_VOLT_ABSORB, ABILITY_ELECTROLIGHT },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Pichu"),
        .cryId = CRY_PICHU,
    ...
    [SPECIES_PICHU_SPIKY_EARED] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_STATIC, ABILITY_ELECTROLIGHT, ABILITY_LIGHTNING_ROD },
        .bodyColor = BODY_COLOR_YELLOW,
        .noFlip = TRUE,
        .speciesName = _("Pichu"),
        .cryId = CRY_PICHU,
...
#define PIKACHU_SP_DEF (P_UPDATED_STATS >= GEN_6 || P_UPDATED_STATS == GEN_1 ? 50 : 40)
    ...
    [SPECIES_PIKACHU] =
    {
        ...
        .abilities = { ABILITY_STATIC, ABILITY_LIGHTNING_ROD, ABILITY_ELECTROLIGHT },
        .bodyColor = BODY_COLOR_YELLOW,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 26, SPECIES_RAICHU},
    ...
    [SPECIES_RAICHU] =
    {
        ...
        .shinySpecies = SPECIES_RAICHU_ALOLA,
    },
    ...
    [SPECIES_SANDSHREW] =
    {
        ...
        .baseSpAttack  = 23,
        .baseSpDefense = 40,
        .types = MON_TYPES(TYPE_TERRA, TYPE_NORMAL),
        .catchRate = 180,
        .expYield = 81, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 60 : 93,
        .evYield_Defense = 1,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_BATTLE_ARMOR, ABILITY_SAND_RUSH },
        .bodyColor = BODY_COLOR_YELLOW,
        ...
        .shinySpecies = SPECIES_SANDSHREW_ALOLA,
        .evolutions = EVOLUTION({EVO_LEVEL, 26, SPECIES_SANDSLASH}),
    },
    ...
    [SPECIES_SANDSLASH] =
    {
        ...
        .types = MON_TYPES(TYPE_TERRA, TYPE_NORMAL),
        .catchRate = 90,
        .expYield = 172, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 158 : 163,
        .evYield_Defense = 1,
        .evYield_Attack = 1,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_ROUGH_SKIN, ABILITY_SAND_RUSH },
        .bodyColor = BODY_COLOR_YELLOW,
        ...
        .shinySpecies = SPECIES_SANDSLASH_ALOLA,
    },
    ...
    [SPECIES_SANDSHREW_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_BATTLE_ARMOR, ABILITY_SLUSH_RUSH },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Sandshrew"),
        .cryId = CRY_SANDSHREW,
        .natDexNum = NATIONAL_DEX_SANDSHREW,
    ...
    [SPECIES_SANDSLASH_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_ROUGH_SKIN, ABILITY_SLUSH_RUSH },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Sandslash"),
        .cryId = CRY_SANDSLASH,
        .natDexNum = NATIONAL_DEX_SANDSLASH,
    ...
    [SPECIES_NIDORAN_F] =
    {
        ...
        .catchRate = 210,
        .expYield = 74, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 55 : 59,
        .evYield_SpDefense = 1,
        .genderRatio = MON_FEMALE,
        .eggCycles = 25,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_TINTED_LENS, ABILITY_RUN_AWAY, ABILITY_OWN_TEMPO },
    #else
        .abilities = { ABILITY_POISON_TOUCH, ABILITY_NONE, ABILITY_HUSTLE },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 17, SPECIES_NIDORINA}),
    },
    ...
    [SPECIES_NIDORINA] =
    {
        ...
        .types = MON_TYPES(TYPE_FAIRY, TYPE_NORMAL),
        .catchRate = 90,
        .expYield = 131, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 128 : 117,
        .evYield_SpDefense = 1,
        .evYield_Attack = 1,
        .itemRare = ITEM_HEAL_POWDER,
        .genderRatio = MON_FEMALE,
        .eggCycles = 25,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_TINTED_LENS, ABILITY_RUN_AWAY, ABILITY_GUTS },
    #else
        .abilities = { ABILITY_POISON_TOUCH, ABILITY_NONE, ABILITY_HUSTLE },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 44, SPECIES_NIDOQUEEN}),
    },
    ...
    [SPECIES_NIDOQUEEN] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_TINTED_LENS, ABILITY_BATTLE_ARMOR, ABILITY_GUTS },
    #else
        .abilities = { ABILITY_POISON_TOUCH, ABILITY_NONE, ABILITY_SHEER_FORCE },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_NIDORAN_M] =
    {
        ...
        .catchRate = 210,
        .expYield = 77, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 55 : 60,
        .evYield_Attack = 1,
        .genderRatio = MON_MALE,
        .eggCycles = 25,
        .friendship = 35,
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_RECKLESS, ABILITY_DEFIANT, ABILITY_IRRITABILITY },
    #else
        .abilities = { ABILITY_POISON_TOUCH, ABILITY_NONE, ABILITY_HUSTLE },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 17, SPECIES_NIDORINO}),
    },
    ...
    [SPECIES_NIDORINO] =
    {
        ...
        .types = MON_TYPES(TYPE_POISON, TYPE_NORMAL),
        .catchRate = 90,
        .expYield = 140, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 128 : 118,
        .evYield_Attack = 2,
        .itemRare = ITEM_POISON_BARB,
        .genderRatio = MON_MALE,
        .eggCycles = 25,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 44, SPECIES_NIDOKING}),
    },
    ...
    [SPECIES_NIDOKING] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SHEER_FORCE, ABILITY_BATTLE_ARMOR, ABILITY_MOXIE },
    #else
        .abilities = { ABILITY_POISON_TOUCH, ABILITY_NONE, ABILITY_SHEER_FORCE },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_CLEFFA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_PACIFIER, ABILITY_COSMIC, ABILITY_SERENE_GRACE },
    #else
...
#endif //!P_DISABLE_CERTAIN_FAMILY_MEMBERS
    ...
    [SPECIES_CLEFAIRY] =
    {
        ...
        .types = MON_TYPES(TYPE_FAIRY),
        .catchRate = 210,
        .expYield = 99, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 113 : 68,
        .evYield_HP = 2,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_MOON_PRESENCE, ABILITY_COSMIC, ABILITY_SERENE_GRACE },
    #else
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_NONE, ABILITY_PACIFIER },
    #endif
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_VULPIX] =
    {
        ...
        .baseSpAttack  = 61,
        .baseSpDefense = 68,
        .types = MON_TYPES(TYPE_FLAME, TYPE_NORMAL),
        .catchRate = 150,
        .expYield = 93, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 60 : 63,
        .evYield_SpDefense = 1,
        .itemRare = ITEM_NOMEL_BERRY,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 25,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_BLAZE, ABILITY_SERENE_GRACE, ABILITY_UNAWARE },
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .shinySpecies = SPECIES_VULPIX_ALOLA,
    ...
    [SPECIES_NINETALES] =
    {
        ...
        .baseSpAttack  = 111,
        .baseSpDefense = 108,
        .types = MON_TYPES(TYPE_FLAME, TYPE_FAIRY),
        .catchRate = 30,
        .expYield = 241, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 177 : 178,
        .evYield_SpAttack = 2,
        .evYield_SpDefense = 1,
        .itemCommon = ITEM_NOMEL_BERRY,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_DROUGHT, ABILITY_SERENE_GRACE, ABILITY_FORBIDDEN },
        .bodyColor = BODY_COLOR_YELLOW,
        ...
        .shinySpecies = SPECIES_NINETALES_ALOLA,
    },
    ...
    [SPECIES_VULPIX_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_SNOW_CLOAK, ABILITY_SERENE_GRACE, ABILITY_UNAWARE },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Vulpix"),
        .cryId = CRY_VULPIX,
        .natDexNum = NATIONAL_DEX_VULPIX,
    ...
    [SPECIES_NINETALES_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_SNOW_WARNING, ABILITY_SERENE_GRACE, ABILITY_ICE_ABSORB },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Ninetales"),
        .cryId = CRY_NINETALES,
        .natDexNum = NATIONAL_DEX_NINETALES,
...
#if P_UPDATED_TYPES >= GEN_6
    #define JIGGLYPUFF_FAMILY_TYPES { TYPE_FAIRY, TYPE_NORMAL}
#else
    ...
    [SPECIES_JIGGLYPUFF] =
    {
        ...
        .types = JIGGLYPUFF_FAMILY_TYPES,
        .catchRate = 210,
        .expYield = 82, //(P_UPDATED_EXP_YIELDS >= GEN_5) ? 95 : 76,
        .evYield_HP = 1,
    ...
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_INFLATE , ABILITY_COMPETITIVE },
    #else
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_NONE, ABILITY_PACIFIER },
    #endif
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_ZUBAT] =
    {
        ...
        .airborne = TRUE,
        .catchRate = 210,
        .expYield = 71, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 49 : 54,
        .evYield_Speed = 1,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INSOMNIA, ABILITY_INFILTRATOR, ABILITY_WICKED },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Zubat"),
        .cryId = CRY_ZUBAT,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 24, SPECIES_GOLBAT}),
    },
    ...
    [SPECIES_GOLBAT] =
    {
        ...
        .airborne = TRUE,
        .catchRate = 90,
        .expYield = 177, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 159 : 171,
        .evYield_Speed = 1,
        .evYield_Attack = 1,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 52, SPECIES_CROBAT}),
    },
    ...
    [SPECIES_ODDISH] =
    {
        ...
        .types = MON_TYPES(TYPE_GRASS, TYPE_POISON),
        .catchRate = 255,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 65 : 78,
        .evYield_SpAttack = 1,
        ...
        .abilities = { ABILITY_RUN_AWAY, ABILITY_RATTLED, ABILITY_INSOMNIA },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 17, SPECIES_GLOOM}),
    },
    ...
    [SPECIES_GLOOM] =
    {
        ...
        .types = MON_TYPES(TYPE_GRASS, TYPE_POISON),
        .catchRate = 120,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 132 : 138,
        .evYield_SpAttack = 1,
        .evYield_SpDefense = 1,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_POTENCY, ABILITY_INSOMNIA },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
        .speciesName = _("Gloom"),
        .cryId = CRY_GLOOM,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 37, SPECIES_VILEPLUME}),
    ...
    [SPECIES_VILEPLUME] =
    {
        ...
        .itemCommon = ITEM_MISTY_SEED,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_RAIN_DISH, ABILITY_POTENCY, ABILITY_INSOMNIA },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_PARAS] =
    {
        ...
        .catchRate = 180,
        .expYield = 69, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 57 : 70,
        .evYield_Defense = 1,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_UNAWARE, ABILITY_DRY_SKIN, ABILITY_SYMBIOSIS },
    #else
        .abilities = { ABILITY_EFFECT_SPORE, ABILITY_NONE, ABILITY_HYDRATION },
    #endif
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Paras"),
        .cryId = CRY_PARAS,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_PARASECT}),
    },
    ...
    [SPECIES_PARASECT] =
    {
        ...
        .types = MON_TYPES(TYPE_BUG, TYPE_GRASS),
        .catchRate = 75,
        .expYield = 205, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 142 : 128,
        .evYield_Attack = 2,
        .evYield_Defense = 1,
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG, EGG_GROUP_GRASS),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_POTENCY, ABILITY_DRY_SKIN, ABILITY_SYMBIOSIS },
    #else
    ...
    [SPECIES_VENONAT] =
    {
        ...
        .types = MON_TYPES(TYPE_BUG, TYPE_POISON),
        .catchRate = 150,
        .expYield = 118, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 61 : 75,
        .evYield_SpDefense = 1,
        .itemRare = ITEM_ENERGY_POWDER,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 15,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_MIRACLE_EYE, ABILITY_POISON_TOUCH, ABILITY_SWARM },
    #else
    ...
    [SPECIES_DIGLETT] =
    {
        ...
        .types = MON_TYPES(TYPE_TERRA, TYPE_NORMAL),
        .catchRate = 255,
        .expYield = 45, //(P_UPDATED_EXP_YIELDS >= GEN_5) ? 53 : 81,
        .evYield_Speed = 1,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_HUSTLE, ABILITY_CULTIVATOR, ABILITY_ARENA_TRAP },
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .shinySpecies = SPECIES_DIGLETT_ALOLA,
        .evolutions = EVOLUTION({EVO_LEVEL, 24, SPECIES_DUGTRIO}),
    },
    ...
    [SPECIES_DUGTRIO] =
    {
        ...
        .shinySpecies = SPECIES_DUGTRIO_ALOLA,
    },
...
#if P_FAMILY_MEOWTH
#if P_UPDATED_ABILITIES >= GEN_4
    #define MEOWTH_ABILITIES { ABILITY_RUN_AWAY, ABILITY_PICKPOCKET, ABILITY_LIMBER }
#else
    ...
    [SPECIES_MEOWTH] =
    {
        ...
        .catchRate = 210,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 60 : 69,
        .evYield_Speed = 1,
        .itemCommon = ITEM_AMULET_COIN,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
        ...
        .shinySpecies = SPECIES_MEOWTH_ALOLA,
    ...
    [SPECIES_PERSIAN] =
    {
        ...
        .types = MON_TYPES(TYPE_NORMAL),
        .catchRate = 75,
        .expYield = 209, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 154 : 148,
        .evYield_Speed = 2,
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_MOXIE, ABILITY_TECHNICIAN, ABILITY_LIMBER },
    #else
        ...
        .shinySpecies = SPECIES_PERSIAN_ALOLA,
    },
    ...
    [SPECIES_PERSIAN_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FLUFFY, ABILITY_TECHNICIAN, ABILITY_RATTLED },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Persian"),
        .cryId = CRY_PERSIAN,
        .natDexNum = NATIONAL_DEX_PERSIAN,
    ...
    [SPECIES_PERRSERKER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_TOUGH_CLAWS, ABILITY_STEELWORKER },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_PSYDUCK] =
    {
        ...
        .catchRate = 180,
        .expYield = 109, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 64 : 80,
        .evYield_SpAttack = 1,
        ...
        .abilities = { ABILITY_SCATTERBRAIN, ABILITY_OBLIVIOUS, ABILITY_PURE_POWER },
        .bodyColor = BODY_COLOR_YELLOW,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 42, SPECIES_GOLDUCK}),
    },
    ...
    [SPECIES_GOLDUCK] =
    {
        ...
        .types = MON_TYPES(TYPE_WATER, TYPE_PSYCHIC),
        .catchRate = 60,
        .expYield = 246, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 175 : 174,
        .evYield_SpAttack = 2,
        .itemRare = ITEM_BIG_PEARL,
        .itemCommon = ITEM_PEARL,
        .genderRatio = PERCENT_FEMALE(50),
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FLYING),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_HYPER_FOCUS, ABILITY_SUPER_LUCK },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_MANKEY] =
    {
        ...
        .catchRate = 180,
        .expYield = 70, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 61 : 74,
        .evYield_Attack = 1,
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_RECKLESS, ABILITY_IRRITABILITY, ABILITY_BERSERK },
    #else
        .abilities = { ABILITY_STEADFAST, ABILITY_NONE, ABILITY_DEFIANT },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 21, SPECIES_PRIMEAPE}),
    },
    ...
    [SPECIES_PRIMEAPE] =
    {
        ...
        .types = MON_TYPES(TYPE_FIGHTING, TYPE_NORMAL),
        .catchRate = 90,
        .expYield = 169, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 159 : 149,
        .evYield_Attack = 2,
        .itemRare = ITEM_LIECHI_BERRY,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_ANNIHILAPE, CONDITIONS({IF_KNOWS_MOVE, MOVE_REVENGE})}), // EVOLUTION({EVO_LEVEL, 0, SPECIES_ANNIHILAPE, CONDITIONS({IF_USED_MOVE_X_TIMES, MOVE_RAGE_FIST, 20})}),
    #endif
    },
    ...
    [SPECIES_ANNIHILAPE] =
    {
        ...
        .baseSpAttack  = 80,
        .baseSpDefense = 92,
        .types = MON_TYPES(TYPE_FIGHTING, TYPE_UNDEAD),
        .catchRate = 60,
        .expYield = 234,
        .evYield_Attack = 3,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_GROWLITHE] =
    {
        ...
        .types = MON_TYPES(TYPE_FLAME, TYPE_NORMAL),
        .catchRate = 150,
        .expYield = 142, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 70 : 91,
        .evYield_Attack = 1,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STEADFAST, ABILITY_COMPETITIVE, ABILITY_GUTS },
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .shinySpecies = SPECIES_GROWLITHE_HISUI,
        .evolutions = EVOLUTION({EVO_LEVEL, 48, SPECIES_ARCANINE}),
    },
    ...
    [SPECIES_ARCANINE] =
    {
        ...
        .types = MON_TYPES(TYPE_FLAME, TYPE_NORMAL),
        .catchRate = 45,
        .expYield = 417, //(P_UPDATED_EXP_YIELDS >= GEN_5) ? 194 : 213,
        .evYield_Attack = 2,
        .evYield_SpAttack = 1,
        .itemRare = ITEM_OCCA_BERRY,
        .genderRatio = PERCENT_FEMALE(50),
        ...
        .shinySpecies = SPECIES_ARCANINE_HISUI,
    },
    ...
    [SPECIES_POLIWAG] =
    {
        ...
        .types = MON_TYPES(TYPE_WATER),
        .catchRate = 255,
        .expYield = 83, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 60 : 77,
        .evYield_SpAttack = 1,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
        ...
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_WATER_ABSORB, ABILITY_RUN_AWAY },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 19, SPECIES_POLIWHIRL}),
    },
    ...
    [SPECIES_POLIWHIRL] =
    {
        ...
        .types = MON_TYPES(TYPE_WATER),
        .catchRate = 150,
        .expYield = 139, //(P_UPDATED_EXP_YIELDS >= GEN_5) ? 135 : 131,
        .evYield_Speed = 2,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_POLIWRATH}
                            #if P_GEN_2_CROSS_EVOS
    ...
    [SPECIES_POLIWRATH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_IRON_FIST, ABILITY_STAMINA },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
    ...
    [SPECIES_POLITOED] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_MINSTREL, ABILITY_SERENE_GRACE, ABILITY_WONDER_SKIN },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
    ...
    [SPECIES_ABRA] =
    {
        ...
        .abilities = { ABILITY_HYPER_FOCUS, ABILITY_MAGIC_BOUNCE, ABILITY_ADAPTABILITY },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Abra"),
        .cryId = CRY_ABRA,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 26, SPECIES_KADABRA}),
    },
    ...
    [SPECIES_KADABRA] =
    {
        ...
        .types = MON_TYPES(TYPE_PSYCHIC),
        .catchRate = 60,
        .expYield = 240, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 140 : 145,
        .evYield_SpAttack = 2,
        .itemRare = ITEM_MENTAL_HERB,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 56, SPECIES_ALAKAZAM},
    ...
    [SPECIES_ALAKAZAM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_HYPER_FOCUS, ABILITY_MAGIC_BOUNCE, ABILITY_PSYCHIC_SURGE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_IRON_FIST, ABILITY_RECKLESS, ABILITY_MOXIE },
    #else
    ...
    [SPECIES_MACHOKE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE, EGG_GROUP_MONSTER),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SHEER_FORCE, ABILITY_RECKLESS, ABILITY_IRRITABILITY },
    #else
        .abilities = { ABILITY_GUTS, ABILITY_NONE, ABILITY_STEADFAST },
    #endif
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_MACHAMP] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE, EGG_GROUP_MONSTER),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_GRAPPLER, ABILITY_RECKLESS, ABILITY_MOXIE },
    #else
        .abilities = { ABILITY_GUTS, ABILITY_NONE, ABILITY_STEADFAST },
    #endif
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_BELLSPROUT] =
    {
        ...
        .types = MON_TYPES(TYPE_GRASS, TYPE_POISON),
        .catchRate = 255,
        .expYield = 49, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 60 : 84,
        .evYield_Speed = 1,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_LIMBER, ABILITY_MERCILESS },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_WEEPINBELL] =
    {
        ...
        .types = MON_TYPES(TYPE_GRASS, TYPE_POISON),
        .catchRate = 150,
        .expYield = 112, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 137 : 151,
        .evYield_Attack = 1,
        .evYield_SpAttack = 1,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_GLUTTONY, ABILITY_MERCILESS },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 34, SPECIES_VICTREEBEL}),
    },
    ...
    [SPECIES_TENTACOOL] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 67,
        .types = MON_TYPES(TYPE_OCEAN, TYPE_POISON),
        .airborne = TRUE,
        .catchRate = 150,
        .expYield = 93, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 67 : 105,
        .evYield_SpAttack = 1,
        .itemRare = ITEM_POISON_BARB,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 25,
        ...
        .abilities = { ABILITY_MERCILESS, ABILITY_SWIFT_SWIM, ABILITY_WATER_ABSORB },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 38, SPECIES_TENTACRUEL}),
    },
    ...
    [SPECIES_TENTACRUEL] =
    {
        ...
        .airborne = TRUE,
        .catchRate = 75,
        .expYield = 241, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 180 : 205,
        .evYield_SpDefense = 1,
        .evYield_SpAttack = 1,
        .itemRare = ITEM_POISON_BARB,
        .genderRatio = PERCENT_FEMALE(50),
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3, EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_MERCILESS, ABILITY_RAIN_DISH, ABILITY_WATER_ABSORB },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_GEODUDE] =
    {
        ...
        .abilities = { ABILITY_IRON_FIST, ABILITY_STURDY, ABILITY_RECKLESS },
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .shinySpecies = SPECIES_GEODUDE_ALOLA,
        .evolutions = EVOLUTION({EVO_LEVEL, 19, SPECIES_GRAVELER}),
    },
    ...
    [SPECIES_GRAVELER] =
    {
        ...
        .types = MON_TYPES(TYPE_ROCK, TYPE_GROUND),
        .catchRate = 90,
        .expYield = 139, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 137 : 134,
        .evYield_Defense = 2,
        .itemRare = ITEM_HARD_STONE,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL, EGG_GROUP_MONSTER),
        .abilities = { ABILITY_SOLID_ROCK, ABILITY_STURDY, ABILITY_RECKLESS },
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .shinySpecies = SPECIES_GRAVELER_ALOLA,
        .evolutions = EVOLUTION({EVO_LEVEL, 33, SPECIES_GOLEM},
    ...
    [SPECIES_GOLEM] =
    {
        ...
        .baseSpAttack  = 53,
        .baseSpDefense = 68,
        .types = MON_TYPES(TYPE_TERRA, TYPE_ROCK),
        .catchRate = 60,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 207,
    #elif P_UPDATED_EXP_YIELDS >= GEN_6
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL, EGG_GROUP_MONSTER),
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_STURDY, ABILITY_RECKLESS },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Golem"),
        .cryId = CRY_GOLEM,
        ...
        .shinySpecies = SPECIES_GOLEM_ALOLA,
    },
    ...
    [SPECIES_GOLEM_ALOLA] =
    {
        ...
        .types = MON_TYPES(TYPE_ROCK, TYPE_ELECTRIC),
        .catchRate = 60,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 207 : 223,
        .evYield_Defense = 3,
    ...
    [SPECIES_PONYTA] =
    {
        ...
        .catchRate = 180,
        .expYield = 106, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 82 : 152,
        .evYield_Speed = 1,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 25,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FLAME_BODY, ABILITY_FLASH_FIRE, ABILITY_HUSTLE },
        .bodyColor = BODY_COLOR_YELLOW,
        ...
        .shinySpecies = SPECIES_PONYTA_GALAR,
        .evolutions = EVOLUTION({EVO_LEVEL, 42, SPECIES_RAPIDASH}),
    },
    ...
    [SPECIES_RAPIDASH] =
    {
        ...
        .types = MON_TYPES(TYPE_FIRE, TYPE_NORMAL),
        .catchRate = 60,
        .expYield = 248, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 175 : 192,
        .evYield_Speed = 2,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 25,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FLAME_BODY, ABILITY_FLASH_FIRE, ABILITY_QUICK_FEET },
        .bodyColor = BODY_COLOR_YELLOW,
        ...
        .shinySpecies = SPECIES_RAPIDASH_GALAR,
    },
    ...
    [SPECIES_SLOWPOKE] =
    {
        ...
        .catchRate = 210,
        .expYield = 109, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 63 : 99,
        .evYield_HP = 1,
        ...
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_TRUANT, ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_PINK,
        ...
        .shinySpecies = SPECIES_SLOWPOKE_GALAR,
        .evolutions = EVOLUTION({EVO_LEVEL_BATTLE_ONLY, 32, SPECIES_SLOWBRO, CONDITIONS({IF_PID_MODULO_100_GT, 19})}
                            #if P_GEN_2_CROSS_EVOS
                                ,{EVO_LEVEL_BATTLE_ONLY, 32, SPECIES_SLOWKING, CONDITIONS({IF_PID_MODULO_100_LT, 20})},
    ...
    [SPECIES_SLOWBRO] =
    {
        ...
        .catchRate = 90,
        .expYield = 218, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 172 : 164,
        .evYield_HP = 2,
        .evYield_Attack = 1,
        .itemRare = ITEM_SHED_SHELL,
        ...
        .shinySpecies = SPECIES_SLOWBRO_GALAR,
    },
    ...
    [SPECIES_SLOWKING] =
    {
        ...
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_WATER),
        .catchRate = 45,
        .expYield = 283, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 172 : 164,
        .evYield_SpAttack = 2,
        .evYield_SpDefense = 1,
        .itemRare = ITEM_KINGS_ROCK,
        .itemCommon = ITEM_PASSHO_BERRY,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_MAJESTY, ABILITY_CRAFTY, ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_PINK,
        ...
        .shinySpecies = SPECIES_SLOWKING_GALAR,
    },
#endif //P_GEN_2_CROSS_EVOS
...
#define MAGNEMITE_FAMILY_TYPE1 (P_UPDATED_TYPES >= GEN_2 ? TYPE_STEEL : TYPE_ELECTRIC)
    ...
    [SPECIES_MAGNEMITE] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 61,
        .types = MON_TYPES(MAGNEMITE_FAMILY_TYPE1, TYPE_ELECTRIC),
        .airborne = TRUE,
        .catchRate = 150,
        .expYield = 87, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 65 : 89,
        .evYield_Defense = 1,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_MAGNET_PULL, ABILITY_LIGHTNING_ROD, ABILITY_ANALYTIC },
        .bodyColor = BODY_COLOR_GRAY,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 22, SPECIES_MAGNETON}),
    },
    ...
    [SPECIES_MAGNETON] =
    {
        ...
        .airborne = TRUE,
        .catchRate = 90,
        .expYield = 151, //(P_UPDATED_EXP_YIELDS >= GEN_5) ? 163 : 161,
        .evYield_SpAttack = 1,
        .evYield_Defense = 1,
        .itemCommon = ITEM_MAGNET,
        .genderRatio = MON_GENDERLESS,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 56, SPECIES_MAGNEZONE}),
    #endif
    },
    ...
    [SPECIES_FARFETCHD] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_KEEN_EYE, ABILITY_EARLY_BIRD, ABILITY_SUPER_LUCK },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
        ...
        .shinySpecies = SPECIES_FARFETCHD_GALAR,
    },
    ...
    [SPECIES_FARFETCHD_GALAR] =
    {
        ...
        .abilities = { ABILITY_STEADFAST, ABILITY_NONE, ABILITY_GUTS },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
        .speciesName = _("Farfetch'd"),
        .cryId = CRY_FARFETCHD,
    ...
    [SPECIES_DODUO] =
    {
        ...
        .catchRate = 180,
        .expYield = 109, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 62 : 96,
        .evYield_Attack = 1,
        .itemRare = ITEM_SHARP_BEAK,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_STAMINA, ABILITY_EARLY_BIRD, ABILITY_TANGLED_FEET },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Doduo"),
        .cryId = CRY_DODUO,
    ...
    [SPECIES_DODRIO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_STAMINA, ABILITY_EARLY_BIRD, ABILITY_ANALYTIC },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
    ...
    [SPECIES_GRIMER] =
    {
        ...
        .catchRate = 150,
        .expYield = 113, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 65 : 90,
        .evYield_HP = 1,
        .itemRare = ITEM_BLACK_SLUDGE,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 30,
        ...
        .abilities = { ABILITY_GUNK_MUNCHER, ABILITY_STICKY_HOLD, ABILITY_POISON_TOUCH },
        .bodyColor = BODY_COLOR_PURPLE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 50, SPECIES_MUK}),
    },
    ...
    [SPECIES_MUK] =
    {
        ...
        .types = MON_TYPES(TYPE_POISON),
        .catchRate = 45,
        .expYield = 289, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 175 : 157,
        .evYield_HP = 1,
        .evYield_Attack = 1,
        .itemRare = ITEM_BLACK_SLUDGE,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_GRIMER_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_POWER_OF_ALCHEMY, ABILITY_GUNK_MUNCHER, ABILITY_CONTRARY },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Grimer"),
        .cryId = CRY_GRIMER,
        .natDexNum = NATIONAL_DEX_GRIMER,
        ...
        .formSpeciesIdTable = sGrimerFormSpeciesIdTable,
        .shinySpecies = SPECIES_GRIMER,
        .evolutions = EVOLUTION({EVO_LEVEL, 50, SPECIES_MUK_ALOLA}),
    },
    ...
    [SPECIES_SHELLDER] =
    {
        ...
        .baseSpAttack  = 52,
        .baseSpDefense = 43,
        .types = MON_TYPES(TYPE_OCEAN, TYPE_ROCK),
        .catchRate = 210,
        .expYield = 67, //(P_UPDATED_EXP_YIELDS >= GEN_5) ? 61 : 97,
        .evYield_Defense = 1,
        .itemCommon = ITEM_PEARL,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_WATER_ABSORB, ABILITY_PROPELLER_TAIL },
    #else
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_NONE, ABILITY_RESILIENCE },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_CLOYSTER}),
    },
    ...
    [SPECIES_CLOYSTER] =
    {
        ...
        .baseSpAttack  = 87,
        .baseSpDefense = 83,
        .types = MON_TYPES(TYPE_OCEAN, TYPE_STEEL),
        .catchRate = 60,
        .expYield = 271, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 184 : 203,
        .evYield_Defense = 3,
        .itemCommon = ITEM_BIG_PEARL,
        .itemRare = ITEM_WATER_STONE,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 25,
        .friendship = STANDARD_FRIENDSHIP,
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3, EGG_GROUP_MINERAL),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_MEGA_LAUNCHER, ABILITY_PROPELLER_TAIL },
    #else
    ...
    [SPECIES_GASTLY] =
    {
        ...
        .airborne = TRUE,
        .catchRate = 150,
        .expYield = 112, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 62 : 95,
        .evYield_SpAttack = 1,
        .itemRare = ITEM_CURSED_ORB,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 25,
        .friendship = 35,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_INFILTRATOR, ABILITY_MALICE, ABILITY_BLACK_FUMES },
        .bodyColor = BODY_COLOR_PURPLE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 24, SPECIES_HAUNTER}),
    },
    ...
    [SPECIES_HAUNTER] =
    {
        ...
        .airborne = TRUE,
        .catchRate = 90,
        .expYield = 179, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 142 : 126,
        .evYield_Attack = 2,
        .itemRare = ITEM_CURSED_ORB,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 25,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_INFILTRATOR, ABILITY_MALICE, ABILITY_TOUGH_CLAWS },
        .bodyColor = BODY_COLOR_PURPLE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 48, SPECIES_GENGAR},
...
#define GENGAR_ABILITIES {ABILITY_INFILTRATOR, ABILITY_MALICE, ABILITY_SHADOW_TAG}
#else
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE}
    ...
    [SPECIES_ONIX] =
    {
        ...
        .catchRate = 60,
        .expYield = 329, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 77 : 108,
        .evYield_Defense = 1,
        .evYield_Attack = 1,
        .itemRare = ITEM_HARD_STONE,
        .itemCommon = ITEM_LAGGING_TAIL,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 35,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL, EGG_GROUP_MONSTER),
        .abilities = { ABILITY_TECTONIC, ABILITY_STURDY, ABILITY_INTIMIDATE },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Onix"),
        .cryId = CRY_ONIX,
        ...
        // {EVO_TRADE, 0, SPECIES_STEELIX, CONDITIONS({IF_HOLD_ITEM, ITEM_METAL_COAT})},
    #endif
    },
    ...
    [SPECIES_STEELIX] =
    {
        ...
        .catchRate = 30,
        .expYield = 476, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 179 : 196,
        .evYield_Defense = 3,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL, EGG_GROUP_MONSTER),
        .abilities = { ABILITY_TECTONIC, ABILITY_HEAT_TREATMENT, ABILITY_CLEAR_BODY },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_DROWZEE] =
    {
        ...
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_NORMAL),
        .catchRate = 150,
        .expYield = 106, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 66 : 102,
        .evYield_SpDefense = 1,
        .itemCommon = ITEM_NANAB_BERRY,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 25,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_INSOMNIA, ABILITY_GLUTTONY, ABILITY_TRUANT },
    #else
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_HYPNO}),
    },
    ...
    [SPECIES_HYPNO] =
    {
        ...
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_NORMAL),
        .catchRate = 75,
        .expYield = 213, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 169 : 165,
        .evYield_SpDefense = 2,
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE, EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_INSOMNIA, ABILITY_UNNERVE, ABILITY_MIRACLE_EYE },
    #else
        .abilities = { ABILITY_INSOMNIA, ABILITY_NONE, ABILITY_INNER_FOCUS },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_KRABBY] =
    {
        ...
        .catchRate = 210,
        .expYield = 74, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 65 : 115,
        .evYield_Attack = 1,
    ...
    [SPECIES_KINGLER] =
    {
        ...
        .types = MON_TYPES(TYPE_WATER, TYPE_ROCK),
        .catchRate = 90,
        .expYield = 179, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 166 : 206,
        .evYield_Attack = 2,
        .itemRare = ITEM_GRIP_CLAW,
    ...
    [SPECIES_VOLTORB] =
    {
        ...
        .types = MON_TYPES(TYPE_ELECTRIC),
        .catchRate = 120,
        .expYield = 99, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 66 : 103,
        .evYield_Speed = 1,
        .itemRare = ITEM_LIGHT_BALL,
        .genderRatio = MON_GENDERLESS,
        .eggCycles = 25,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_AFTERMATH, ABILITY_VOLT_ABSORB, ABILITY_PURE_POWER },
        .bodyColor = BODY_COLOR_RED,
        ...
        .shinySpecies = SPECIES_VOLTORB_HISUI,
        .evolutions = EVOLUTION({EVO_LEVEL, 45, SPECIES_ELECTRODE}),
    },
    ...
    [SPECIES_ELECTRODE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_AFTERMATH, ABILITY_VOLT_ABSORB, ABILITY_ELECTRIC_SURGE },
        .bodyColor = BODY_COLOR_RED,
        ...
        .shinySpecies = SPECIES_ELECTRODE_HISUI,
    },
    ...
    [SPECIES_EXEGGCUTE] =
    {
        ...
        .catchRate = 90,
        .expYield = 87, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 65 : 98,
        .evYield_Defense = 1,
        ...
        .abilities = { ABILITY_SEED_SOWER, ABILITY_HARVEST, ABILITY_SCATTERBRAIN },
        .bodyColor = BODY_COLOR_PINK,
        .noFlip = TRUE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 39, SPECIES_EXEGGUTOR}
                            #if P_ALOLAN_FORMS
    ...
    [SPECIES_EXEGGUTOR] =
    {
        ...
        .shinySpecies = SPECIES_EXEGGUTOR_ALOLA,
    },
    ...
    [SPECIES_EXEGGUTOR_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_SEED_SOWER, ABILITY_HARVEST, ABILITY_TANGLED_FEET },
        .bodyColor = BODY_COLOR_YELLOW,
        .noFlip = TRUE,
        .speciesName = _("Exeggutor"),
        .cryId = CRY_EXEGGUTOR,
    ...
    [SPECIES_CUBONE] =
    {
        ...
        .baseSpAttack  = 23,
        .baseSpDefense = 45,
        .types = MON_TYPES(TYPE_TERRA, TYPE_DRAGON),
        .catchRate = 120,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 63 : 87,
        .evYield_Defense = 1,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_RATTLED, ABILITY_PACIFIER },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 23, SPECIES_MAROWAK}
                            #if P_ALOLAN_FORMS
    ...
    [SPECIES_MAROWAK] =
    {
        ...
        .types = MON_TYPES(TYPE_TERRA, TYPE_DRAGON),
        .catchRate = 75,
        .expYield = 171, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 149 : 124,
        .evYield_Defense = 2,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_GUTS, ABILITY_AVENGER },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
        ...
        .shinySpecies = SPECIES_MAROWAK_ALOLA,
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_KANGASKHAN, CONDITIONS({IF_MIN_FRIENDSHIP, FRIENDSHIP_EVO_THRESHOLD})}),
    },
    ...
    [SPECIES_MAROWAK_ALOLA] =
    {
        ...
        .abilities = { ABILITY_VENGEFUL, ABILITY_LIGHTNING_ROD, ABILITY_ROCK_HEAD },
        .bodyColor = BODY_COLOR_PURPLE,
        .noFlip = TRUE,
        .speciesName = _("Marowak"),
        .cryId = CRY_MAROWAK,
    ...
    [SPECIES_TYROGUE] =
    {
        ...
        .types = MON_TYPES(TYPE_FIGHTING),
        .catchRate = 180,
        .expYield = 70, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 42 : 91,
        .evYield_Attack = 1,
        .itemRare = ITEM_PROTECTIVE_PADS,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_COMPETITIVE, ABILITY_GUTS, ABILITY_RECKLESS },
    #else
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_HITMONCHAN, CONDITIONS({IF_ATK_LT_DEF})},
                                {EVO_LEVEL, 28, SPECIES_HITMONLEE, CONDITIONS({IF_ATK_GT_DEF})},
                                {EVO_LEVEL, 28, SPECIES_HITMONTOP, CONDITIONS({IF_ATK_EQ_DEF})}),
    },
#endif //P_GEN_2_CROSS_EVOS
    ...
    [SPECIES_HITMONLEE] =
    {
        ...
        .types = MON_TYPES(TYPE_FIGHTING),
        .catchRate = 90,
        .expYield = 204, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 159 : 139,
        .evYield_Attack = 2,
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_JET_LEG, ABILITY_LIMBER, ABILITY_RECKLESS },
    #else
    ...
    [SPECIES_HITMONCHAN] =
    {
        ...
        .types = MON_TYPES(TYPE_FIGHTING),
        .catchRate = 90,
        .expYield = 204, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 159 : 140,
        .evYield_Attack = 1,
        .evYield_Defense = 1,
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_KEEN_EYE, ABILITY_IRON_FIST, ABILITY_STAMINA },
    #else
    ...
    [SPECIES_HITMONTOP] =
    {
        ...
        .types = MON_TYPES(TYPE_FIGHTING),
        .catchRate = 90,
        .expYield = 204, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 159 : 138,
        .evYield_Attack = 1,
        .evYield_Speed = 1,
        .itemRare = ITEM_FOCUS_BAND,
        .genderRatio = PERCENT_FEMALE(50),
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_STEADFAST, ABILITY_TECHNICIAN, ABILITY_SPEED_BOOST },
    #else
    ...
    [SPECIES_LICKITUNG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_OWN_TEMPO, ABILITY_OBLIVIOUS, ABILITY_UNAWARE },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_KOFFING] =
    {
        ...
        .airborne = TRUE,
        .catchRate = 150,
        .expYield = 104, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 68 : 114,
        .evYield_SpAttack = 1,
        ...
        .abilities = { ABILITY_POTENCY, ABILITY_GUNK_MUNCHER, ABILITY_BLACK_FUMES },
    #else
    ...
    [SPECIES_WEEZING] =
    {
        ...
        .airborne = TRUE,
        .catchRate = 75,
        .expYield = 208, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 172 : 173,
        .evYield_Defense = 1,
        .evYield_SpAttack = 1,
        .itemRare = ITEM_TOXIC_ORB,
        .itemCommon = ITEM_BLACK_SLUDGE,
        ...
        .shinySpecies = SPECIES_WEEZING_GALAR,
    },
    ...
    [SPECIES_WEEZING_GALAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_POWER_OF_ALCHEMY, ABILITY_GUNK_MUNCHER, ABILITY_WHITE_SMOKE },
        .bodyColor = BODY_COLOR_GRAY,
        .noFlip = TRUE,
        .speciesName = _("Weezing"),
        .cryId = CRY_WEEZING,
    ...
    [SPECIES_RHYHORN] =
    {
        ...
        .types = MON_TYPES(TYPE_ROCK, TYPE_GROUND),
        .catchRate = 90,
        .expYield = 117, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 69 : 135,
        .evYield_Defense = 1,
        .itemRare = ITEM_HARD_STONE,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 30,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_SHEER_FORCE, ABILITY_ROCK_HEAD, ABILITY_SIMPLE },
        .bodyColor = BODY_COLOR_GRAY,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 27, SPECIES_RHYDON}),
    },
    ...
    [SPECIES_RHYDON] =
    {
        ...
        .types = MON_TYPES(TYPE_ROCK, TYPE_GROUND),
        .catchRate = 60,
        .expYield = 185, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 170 : 204,
        .evYield_Defense = 1,
        .evYield_Attack = 1,
        .itemRare = ITEM_HARD_STONE,
        .genderRatio = PERCENT_FEMALE(50),
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_SHEER_FORCE, ABILITY_BATTLE_ARMOR, ABILITY_SIMPLE },
        .bodyColor = BODY_COLOR_GRAY,
        ...
        // {EVO_TRADE, 0, SPECIES_RHYPERIOR, CONDITIONS({IF_HOLD_ITEM, ITEM_PROTECTOR})},
    #endif
    },
    ...
    [SPECIES_HAPPINY] =
    {
        ...
        .types = MON_TYPES(TYPE_FAIRY),
        .catchRate = 210,
        .expYield = 99, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 110 : 255,
        .evYield_SpDefense = 1,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_NATURAL_CURE, ABILITY_SUPER_LUCK, ABILITY_PACIFIER },
        .bodyColor = BODY_COLOR_PINK,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_CHANSEY, CONDITIONS({IF_MIN_FRIENDSHIP, FRIENDSHIP_EVO_THRESHOLD})}),
    ...
    [SPECIES_CHANSEY] =
    {
        ...
        .types = MON_TYPES(TYPE_FAIRY),
        .catchRate = 120,
        .expYield = 239, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 395 : 255,
        .evYield_SpDefense = 2,
        .itemCommon = ITEM_PECHA_BERRY,
        .itemRare = ITEM_LUCKY_EGG,
        .genderRatio = MON_FEMALE,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
        .abilities = { ABILITY_NATURAL_CURE, ABILITY_SUPER_LUCK, ABILITY_HEALER },
        .bodyColor = BODY_COLOR_PINK,
    ...
    #if P_GEN_2_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 60, SPECIES_BLISSEY}),
    #endif
    },
    ...
    [SPECIES_BLISSEY] =
    {
        ...
        .expYield = 255,
    #endif
        .evYield_SpDefense = (P_UPDATED_EVS >= GEN_4) ? 3 : 2,
        .itemCommon = ITEM_PECHA_BERRY,
        .itemRare = ITEM_LUCKY_EGG,
        .genderRatio = MON_FEMALE,
        .eggCycles = 35,
    ...
    [SPECIES_TANGELA] =
    {
        ...
        .catchRate = 210,
        .expYield = 113, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 87 : 166,
        .evYield_HP = 1,
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 44, SPECIES_TANGROWTH}),
    #endif
    },
    ...
    [SPECIES_TANGROWTH] =
    {
        ...
        .types = MON_TYPES(TYPE_GRASS, TYPE_FAIRY),
        .catchRate = 75,
        .expYield = 258, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 187 : 211,
        .evYield_HP = 2,
        .itemRare = ITEM_RINDO_BERRY,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 30,
    ...
    [SPECIES_KANGASKHAN] =
    {
        ...
        .catchRate = 45,
        .expYield = 370, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 172 : 175,
        .evYield_HP = 2,
        .evYield_Attack = 1,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_THICK_FAT, ABILITY_GUTS, ABILITY_STALWART },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_KANGASKHAN_MEGA] =
    {
        ...
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Khan Duo"),
    #if P_MEGA_TO_EVOLUTION
        .cryId = CRY_KANGASKHAN_MEGA,
    #else
        .cryId = CRY_KANGASKHAN,
    #endif // P_MEGA_TO_EVOLUTION
    ...
    [SPECIES_HORSEA] =
    {
        ...
        .baseSpAttack  = 42,
        .baseSpDefense = 50,
        .types = MON_TYPES(TYPE_OCEAN, TYPE_DRAGON),
        .airborne = TRUE,
        .catchRate = 255,
        .expYield = 62, //(P_UPDATED_EXP_YIELDS >= GEN_5) ? 59 : 83,
        .evYield_SpAttack = 1,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_MEGA_LAUNCHER, ABILITY_WATER_ABSORB },
    #else
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 21, SPECIES_SEADRA}),
    },
    ...
    [SPECIES_SEADRA] =
    {
        ...
        .airborne = TRUE,
        .catchRate = 90,
        .expYield = 171, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 154 : 155,
        .evYield_Attack = 1,
        .evYield_SpAttack = 1,
        .itemRare = ITEM_DRAGON_SCALE,
        .genderRatio = PERCENT_FEMALE(50),
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_MEGA_LAUNCHER, ABILITY_POISON_TOUCH },
    #else
    ...
    #if P_GEN_2_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 61, SPECIES_KINGDRA}),
    ...
    [SPECIES_KINGDRA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_ADAPTABILITY, ABILITY_MULTISCALE },
    #else
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_NONE, ABILITY_DAMP },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_GOLDEEN] =
    {
        ...
        .baseSpAttack  = 38,
        .baseSpDefense = 58,
        .types = MON_TYPES(TYPE_OCEAN),
        .catchRate = 255,
        .expYield = 48, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 64 : 111,
        .evYield_Attack = 1,
        ...
        .abilities = { ABILITY_COMPETITIVE, ABILITY_HYDRATION, ABILITY_LIGHTNING_ROD },
        .bodyColor = BODY_COLOR_RED,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 22, SPECIES_SEAKING}),
    },
    ...
    [SPECIES_SEAKING] =
    {
        ...
        .types = MON_TYPES(TYPE_OCEAN),
        .catchRate = 120,
        .expYield = 174, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 158 : 170,
        .evYield_Attack = 2,
        .itemRare = ITEM_KINGS_ROCK,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 15,
    ...
    [SPECIES_STARYU] =
    {
        ...
        .baseSpAttack  = 64,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_OCEAN, TYPE_PSYCHIC),
        .catchRate = 150,
        .expYield = 100, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 68 : 106,
        .evYield_SpDefense = 1,
        .itemCommon = ITEM_STARDUST,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3, EGG_GROUP_MINERAL),
        .abilities = { ABILITY_COSMIC, ABILITY_REGENERATOR, ABILITY_VOLT_ABSORB },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 51, SPECIES_STARMIE}),
    },
    ...
    [SPECIES_STARMIE] =
    {
        ...
        .types = MON_TYPES(TYPE_OCEAN, TYPE_PSYCHIC),
        .catchRate = 60,
        .expYield = 277, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 182 : 207,
        .evYield_Speed = 2,
        .evYield_SpDefense = 1,
        .itemCommon = ITEM_STARDUST,
        .itemRare = ITEM_STAR_PIECE,
    ...
    [SPECIES_MIME_JR] =
    {
    ...
    #endif
        .catchRate = 210,
        .expYield = 71, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 62 : 78,
        .evYield_SpDefense = 1,
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_PRANKSTER, ABILITY_FILTER },
    #else
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_MR_MIME}
                            #if P_GALARIAN_FORMS
    ...
    [SPECIES_MR_MIME] =
    {
    ...
    #endif
        .catchRate = 90,
        .expYield = 199, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 161 : 136,
        .evYield_SpDefense = 2,
        .itemRare = ITEM_MIRROR_HERB,
        ...
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_FILTER, ABILITY_PRANKSTER },
        .bodyColor = BODY_COLOR_PINK,
        ...
        .shinySpecies = SPECIES_MR_MIME_GALAR,
    },
    ...
    [SPECIES_MR_MIME_GALAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_STEADFAST, ABILITY_SCREEN_CLEANER, ABILITY_ICE_BODY },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Mr. Mime"),
        .cryId = CRY_MR_MIME,
        .natDexNum = NATIONAL_DEX_MR_MIME,
    ...
    [SPECIES_SCYTHER] =
    {
        ...
        .airborne = TRUE,
        .catchRate = 75,
        .expYield = 206, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 100 : 187,
        .evYield_Attack = 1,
        .evYield_Speed = 1,
        .itemRare = ITEM_QUICK_CLAW,
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_HYPER_CUTTER, ABILITY_INFILTRATOR, ABILITY_QUICK_DRAW },
    #else
    ...
    [SPECIES_SCIZOR] =
    {
        ...
        .types = MON_TYPES(TYPE_BUG, TYPE_STEEL),
        .catchRate = 60,
        .expYield = 251, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 175 : 200,
        .evYield_Attack = 1,
        .evYield_Defense = 1,
        .itemRare = ITEM_METAL_COAT,
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_SHEER_FORCE, ABILITY_MOLD_BREAKER },
    #else
    ...
    [SPECIES_KLEAVOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_SHEER_FORCE, ABILITY_HYPER_CUTTER },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_SMOOCHUM] =
    {
        ...
        .baseSpAttack  = 45,
        .baseSpDefense = 66,
        .types = MON_TYPES(TYPE_FROST, TYPE_FAIRY),
        .catchRate = 210,
        .expYield = 63, //(P_UPDATED_EXP_YIELDS >= GEN_5) ? 61 : 87,
        .evYield_SpAttack = 1,
        .itemRare = ITEM_QUALOT_BERRY,
        .genderRatio = PERCENT_FEMALE(87.5),
        .eggCycles = 30,
        .friendship = 100,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_COMPETITIVE, ABILITY_CUTE_CHARM, ABILITY_UNAWARE },
    #else
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_JYNX}),
    },
#endif //P_GEN_2_CROSS_EVOS
    ...
    [SPECIES_JYNX] =
    {
        ...
        .baseSpAttack  = 95,
        .baseSpDefense = 106,
        .types = MON_TYPES(TYPE_FROST, TYPE_PSYCHIC),
        .catchRate = 90,
        .expYield = 178, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 159 : 137,
        .evYield_SpAttack = 1,
        .evYield_SpDefense = 1,
        .itemRare = ITEM_BIG_PEARL,
        .itemCommon = ITEM_QUALOT_BERRY,
        .genderRatio = PERCENT_FEMALE(87.5),
        .eggCycles = 30,
        .friendship = 100,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE, EGG_GROUP_FAIRY),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_DANCER, ABILITY_CUTE_CHARM, ABILITY_PURITY },
    #else
    ...
    [SPECIES_ELEKID] =
    {
        ...
        .catchRate = 210,
        .expYield = 67, //(P_UPDATED_EXP_YIELDS >= GEN_5) ? 72 : 106,
        .evYield_Attack = 1,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_STATIC, ABILITY_LIGHTNING_ROD, ABILITY_IRON_FIST },
        .bodyColor = BODY_COLOR_YELLOW,
        .noFlip = TRUE,
    ...
    [SPECIES_ELECTABUZZ] =
    {
        ...
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_FIGHTING),
        .catchRate = 90,
        .expYield = 175, //(P_UPDATED_EXP_YIELDS >= GEN_5) ? 172 : 156,
        .evYield_Attack = 1,
        .evYield_Speed = 1,
        .itemRare = ITEM_THUNDER_STONE,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 52, SPECIES_ELECTIVIRE},
    ...
    [SPECIES_MAGBY] =
    {
        ...
        .catchRate = 210,
        .expYield = 69, //(P_UPDATED_EXP_YIELDS >= GEN_5) ? 73 : 117,
        .evYield_SpAttack = 1,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_FLAME_BODY, ABILITY_FLASH_FIRE, ABILITY_RUN_AWAY },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
        .speciesName = _("Magby"),
        .cryId = CRY_MAGBY,
    ...
    [SPECIES_MAGMAR] =
    {
        ...
        .types = MON_TYPES(TYPE_FIRE),
        .catchRate = 90,
        .expYield = 180, //(P_UPDATED_EXP_YIELDS >= GEN_5) ? 173 : 167,
        .evYield_SpAttack = 2,
        .itemRare = ITEM_FIRE_STONE,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 30,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_FLAME_BODY, ABILITY_FLASH_FIRE, ABILITY_MOXIE },
        .bodyColor = BODY_COLOR_RED,
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 52, SPECIES_MAGMORTAR},
    ...
    [SPECIES_MAGMORTAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_FLAME_BODY, ABILITY_FLASH_FIRE, ABILITY_MEGA_LAUNCHER },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
    ...
    [SPECIES_PINSIR] =
    {
        ...
        .catchRate = 75,
        .expYield = 171, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 175 : 200,
        .evYield_Attack = 1,
        .evYield_Defense = 1,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 40,
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_HYPER_CUTTER, ABILITY_SHEER_FORCE, ABILITY_BERSERK },
    #else
    ...
    [SPECIES_TAUROS] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 63,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_TERRA),
        .catchRate = 75,
        .expYield = 181, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 172 : 211,
        .evYield_Attack = 1,
        .evYield_Speed = 1,
        .genderRatio = MON_MALE,
        .eggCycles = 25,
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SHEER_FORCE, ABILITY_IRRITABILITY, ABILITY_INTIMIDATE },
    #else
        ...
        .shinySpecies = SPECIES_TAUROS_PALDEA_COMBAT,
    },
    ...
    [SPECIES_TAUROS_PALDEA_COMBAT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_IRRITABILITY, ABILITY_CUD_CHEW },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Tauros"),
        .cryId = CRY_TAUROS,
        .natDexNum = NATIONAL_DEX_TAUROS,
    ...
    [SPECIES_MAGIKARP] =
    {
        ...
        .types = MON_TYPES(TYPE_OCEAN),
        .catchRate = 255,
        .expYield = 79, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 40 : 20,
        .evYield_HP = 1,
        .itemRare = ITEM_DRAGON_SCALE,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 35,
        ...
        .abilities = { ABILITY_RATTLED, ABILITY_SIMPLE, ABILITY_IMMUNITY },
        .bodyColor = BODY_COLOR_RED,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 60, SPECIES_GYARADOS}),
    },
    ...
    [SPECIES_GYARADOS] =
    {
        ...
        .airborne = TRUE,
        .catchRate = 30,
        .expYield = 443, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 189 : 214,
        .evYield_Attack = 2,
        .evYield_SpAttack = 1,
        .itemCommon = ITEM_DRAGON_SCALE,
        .genderRatio = PERCENT_FEMALE(50),
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_MOLD_BREAKER, ABILITY_BERSERK },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_LAPRAS] =
    {
        ...
        .baseSpAttack  = 128,
        .baseSpDefense = 128,
        .types = MON_TYPES(TYPE_WATER, TYPE_FROST),
        .catchRate = 60,
        .expYield = 447, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 187 : 219,
        .evYield_HP = 2,
        .itemCommon = ITEM_MYSTIC_WATER,
        .itemRare = ITEM_PRISM_SCALE,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 40,
        .friendship = 100,
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_UNAWARE, ABILITY_NATURAL_CURE, ABILITY_PACIFIER },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_DITTO] =
    {
        ...
        .types = MON_TYPES(TYPE_PSYCHIC),
        .catchRate = 9,
        .expYield = 105, //(P_UPDATED_EXP_YIELDS >= GEN_5) ? 101 : 61,
        .evYield_HP = 1,
        ...
        .abilities = { ABILITY_IMPOSTER, ABILITY_NONE, ABILITY_LIBERO },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Ditto"),
        .cryId = CRY_DITTO,
...
#define EEVEE_SP_ATK (P_UPDATED_STATS >= GEN_2 ? 45 : 65)
...
#if P_UPDATED_ABILITIES >= GEN_4
    #define EEVEE_ABILITIES { ABILITY_LIBERO, ABILITY_ADAPTABILITY, ABILITY_HUSTLE }
#else
    ...
    [SPECIES_EEVEE] =
    {
        ...
        .types = MON_TYPES(TYPE_NORMAL),
        .catchRate = 210,
        .expYield = 62, //(P_UPDATED_EXP_YIELDS >= GEN_5) ? 65 : 92,
        .evYield_SpDefense = 1,
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                                ...
                                ,{EVO_LEVEL, 0, SPECIES_SYLVEON, CONDITIONS({IF_MIN_FRIENDSHIP, FRIENDSHIP_EVO_THRESHOLD})}
                            #endif
                            #if P_GEN_2_CROSS_EVOS
    ...
    [SPECIES_VAPOREON] =
    {
        ...
        .types = MON_TYPES(TYPE_WATER, TYPE_NORMAL),
        .catchRate = 90,
        .expYield = 206, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 184 : 196,
        .evYield_SpAttack = 1,
        .evYield_SpDefense = 1,
        .itemRare = ITEM_PASSHO_BERRY,
        .genderRatio = PERCENT_FEMALE(50),
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_HYDRATION, ABILITY_SWIFT_SWIM, ABILITY_UNAWARE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_JOLTEON] =
    {
        ...
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_NORMAL),
        .catchRate = 90,
        .expYield = 203, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 184 : 197,
        .evYield_Speed = 2,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_STATIC, ABILITY_MOODY },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_FLAREON] =
    {
        ...
        .types = MON_TYPES(TYPE_FLAME, TYPE_NORMAL),
        .catchRate = 90,
        .expYield = 204, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 184 : 198,
        .evYield_SpAttack = 1,
        .evYield_Speed = 1,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FLASH_FIRE, ABILITY_BLAZE, ABILITY_COMPETITIVE },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_ESPEON] =
    {
        ...
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_NORMAL),
        .catchRate = 90,
        .expYield = 199, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 184 : 197,
        .evYield_SpAttack = 1,
        .evYield_SpDefense = 1,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SOLAR_POWER, ABILITY_HYPER_FOCUS, ABILITY_MAGIC_BOUNCE },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_UMBREON] =
    {
        ...
        .types = MON_TYPES(TYPE_DARK, TYPE_NORMAL),
        .catchRate = 90,
        .expYield = 204, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 184 : 197,
        .evYield_SpAttack = 1,
        .evYield_SpDefense = 1,
        .itemRare = ITEM_ROSELI_BERRY,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_MOON_PRESENCE, ABILITY_INSOMNIA, ABILITY_CONTRARY },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_LEAFEON] =
    {
        ...
        .catchRate = 90,
        .expYield = 201, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 184 : 196,
        .evYield_SpDefense = 1,
        .evYield_Speed = 1,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_LEAF_GUARD, ABILITY_NATURAL_CURE, ABILITY_HYPER_CUTTER },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_GLACEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ICE_ABSORB, ABILITY_ICE_BODY, ABILITY_CLEAR_BODY },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SYLVEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_PACIFIER, ABILITY_INNER_FOCUS },
        .bodyColor = BODY_COLOR_PINK,
        .noFlip = TRUE,
    ...
    [SPECIES_PORYGON] =
    {
        ...
        .airborne = TRUE,
        .catchRate = 90,
        .expYield = 175, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 79 : 130,
        .evYield_Defense = 1,
        .genderRatio = MON_GENDERLESS,
        .eggCycles = 30,
        .friendship = STANDARD_FRIENDSHIP,
        ...
        // {EVO_TRADE, 0, SPECIES_PORYGON2, CONDITIONS({IF_HOLD_ITEM, ITEM_UPGRADE})},
    #endif
    },
    ...
    [SPECIES_PORYGON2] =
    {
        ...
        // {EVO_TRADE, 0, SPECIES_PORYGON_Z, CONDITIONS({IF_HOLD_ITEM, ITEM_DUBIOUS_DISC})},
    #endif
    },
    ...
    [SPECIES_PORYGON_Z] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL, EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_TRACE, ABILITY_MOODY, ABILITY_CONTRARY },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_OMANYTE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_SHELL_ARMOR, ABILITY_MERCILESS },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_OMASTAR] =
    {
        ...
        .types = MON_TYPES(TYPE_OCEAN, TYPE_ROCK),
        .catchRate = 75,
        .expYield = 208, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 173 : 199,
        .evYield_Defense = 1,
        .evYield_SpAttack = 1,
        .itemRare = ITEM_DAMP_ROCK,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_KABUTO] =
    {
        ...
        .abilities = { ABILITY_UNNERVE, ABILITY_BATTLE_ARMOR, ABILITY_SWIFT_SWIM },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_KABUTOPS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG, EGG_GROUP_WATER_3),
        .abilities = { ABILITY_HYPER_CUTTER, ABILITY_BATTLE_ARMOR, ABILITY_SWIFT_SWIM },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_AERODACTYL] =
    {
        ...
        .abilities = { ABILITY_ROUGH_SKIN, ABILITY_INTIMIDATE, ABILITY_STRONG_JAW },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_MUNCHLAX] =
    {
        ...
        .types = MON_TYPES(TYPE_NORMAL),
        .catchRate = 180,
        .expYield = 114, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 78 : 94,
        .evYield_HP = 1,
    ...
    [SPECIES_SNORLAX] =
    {
        ...
        .types = MON_TYPES(TYPE_NORMAL),
        .catchRate = 90,
        .expYield = 336, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 189 : 154,
        .evYield_HP = 2,
        .itemCommon = ITEM_LEFTOVERS,
        .itemRare = ITEM_SNACK,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_ARTICUNO] =
    {
        ...
        .baseSpAttack  = 120,
        .baseSpDefense = 106,
        .types = MON_TYPES(TYPE_FROST, TYPE_FLYING),
        .airborne = TRUE,
        .catchRate = 9,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 518,
        ...
        .shinySpecies = SPECIES_ARTICUNO_GALAR,
    },
    ...
    [SPECIES_ZAPDOS] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_DRIZZLE, ABILITY_NONE, ABILITY_STATIC },
    #else
        ...
        .shinySpecies = SPECIES_ZAPDOS_GALAR,
    },
    ...
    [SPECIES_MOLTRES] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_DROUGHT, ABILITY_NONE, ABILITY_FLAME_BODY },
        .bodyColor = BODY_COLOR_YELLOW,
        ...
        .shinySpecies = SPECIES_MOLTRES_GALAR,
    },
    ...
    [SPECIES_DRATINI] =
    {
        ...
        .types = MON_TYPES(TYPE_DRAGON, TYPE_WATER),
        .catchRate = 120,
        .expYield = 137, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 60 : 67,
        .evYield_SpDefense = 1,
        .itemRare = ITEM_DRAGON_SCALE,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 40,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_SHED_SKIN, ABILITY_SERENE_GRACE, ABILITY_WONDER_SKIN },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 24, SPECIES_DRAGONAIR}),
    },
    ...
    [SPECIES_DRAGONAIR] =
    {
        ...
        .types = MON_TYPES(TYPE_DRAGON, TYPE_WATER),
        .catchRate = 75,
        .expYield = 249, // (P_UPDATED_EXP_YIELDS >= GEN_5) ? 147 : 144,
        .evYield_SpDefense = 2,
        .itemRare = ITEM_DRAGON_SCALE,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 40,
    ...
    [SPECIES_DRAGONITE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_GUTS, ABILITY_UNAWARE, ABILITY_MULTISCALE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_MEWTWO] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_MAGIC_GUARD, ABILITY_NONE, ABILITY_UNNERVE },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_MEW] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_LIBERO, ABILITY_NONE, ABILITY_IMPOSTER },
        .bodyColor = BODY_COLOR_PINK,
        .speciesName = _("Mew"),
        .cryId = CRY_MEW,
