...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_MASQUERAIN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_BUG),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_TINTED_LENS, ABILITY_WONDER_SKIN },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_EFFECT_SPORE, ABILITY_QUICK_FEET, ABILITY_IMMUNITY },
    #else
    ...
    [SPECIES_BRELOOM] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_GRASS),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_EFFECT_SPORE, ABILITY_QUICK_FEET, ABILITY_TECHNICIAN },
    #else
    ...
    #define MAWILE_TYPES { TYPE_FAIRY, TYPE_DARK }
#else
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_FORBIDDEN, ABILITY_MALICE, ABILITY_FLUFFY },
    #else
    ...
    [SPECIES_DUSKNOIR] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS, EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_DOOM_DESIRE, ABILITY_MIRACLE_EYE, ABILITY_SHADOW_TAG },
    #else
        .abilities = { ABILITY_PRESSURE, ABILITY_NONE, ABILITY_NONE },
    #endif
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_FROSLASS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_MINERAL),
        .abilities = { ABILITY_SNOW_WARNING, ABILITY_FORBIDDEN, ABILITY_CUTE_CHARM },
        .bodyColor = BODY_COLOR_WHITE,
