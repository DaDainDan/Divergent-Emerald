...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_SEISMITOAD] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_IRON_FIST, ABILITY_HYDRATION, ABILITY_REBOUND },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_DARUMAKA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_DARMANITAN_STANDARD},
                                {EVO_LEVEL, 0, SPECIES_DARMANITAN_ZEN, CONDITIONS({IF_USED_MOVE_X_TIMES, MOVE_CALM_MIND, 20})}),
    },
    ...
    [SPECIES_CRYOGONAL] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_FROST_ARMOR, ABILITY_ICE_ABSORB, ABILITY_NULL },
        .bodyColor = BODY_COLOR_BLUE,
