...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx)   \
    ...
    [SPECIES_HONEDGE] =
    {
        ...
        .abilities = { ABILITY_HYPER_CUTTER, ABILITY_DEFIANT, ABILITY_FORBIDDEN },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_DOUBLADE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_HYPER_CUTTER, ABILITY_TECHNICIAN, ABILITY_FORBIDDEN },
        .bodyColor = BODY_COLOR_BROWN,
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_TREVENANT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_FORBIDDEN, ABILITY_SYMBIOSIS, ABILITY_ARENA_TRAP },
        .bodyColor = BODY_COLOR_BROWN,
