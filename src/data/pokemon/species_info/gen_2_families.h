...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_LEDIAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_SUPER_LUCK, ABILITY_HUGE_POWER, ABILITY_VICTORY_STAR },
        .bodyColor = BODY_COLOR_RED,
...
// #endif //P_MEGA_EVOLUTIONS
    ...
    [SPECIES_STANTLER] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_ICE_STONE, SPECIES_WYRDEER}),
    },
    ...
    [SPECIES_LUGIA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_DELTA_STREAM, ABILITY_NONE, ABILITY_MULTISCALE },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Lugia"),
        .cryId = CRY_LUGIA,
