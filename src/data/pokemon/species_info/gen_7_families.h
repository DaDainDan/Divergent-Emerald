...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_MORELULL] =
    {
        ...
        .abilities = { ABILITY_REGENERATOR, ABILITY_EFFECT_SPORE, ABILITY_INSOMNIA },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SHIINOTIC] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_PRANKSTER, ABILITY_EFFECT_SPORE, ABILITY_INSOMNIA },
        .bodyColor = BODY_COLOR_PURPLE,
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal)          \
    ...
    [SPECIES_TAPU_BULU] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_GRASSY_SURGE, ABILITY_NONE, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_RED,
