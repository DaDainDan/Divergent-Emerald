...
// Medicine
    ...
    {
        .name = _("Hyper Potion"),
        .price = 1200, // (I_PRICE >= GEN_2 && I_PRICE <= GEN_6) ? 1200 : 1500,
        .holdEffectParam = 120,
        .description = COMPOUND_STRING(
            "Restores the HP of\n"
            "a Pokémon by\n"
    ...
    {
        .name = _("Antidote"),
        .price = 250, // (I_PRICE >= GEN_7) ? 200 : 100,
        .description = COMPOUND_STRING(
            "Heals a poisoned\n"
            "Pokémon."),
        .pocket = POCKET_ITEMS,
    ...
    [ITEM_PARALYZE_HEAL] =
    {
        ...
        .price = 250, // (I_PRICE == GEN_7) ? 300 : 200,
        .description = COMPOUND_STRING(
            "Heals a paralyzed\n"
            "Pokémon."),
        .pocket = POCKET_ITEMS,
    ...
    {
        .name = _("Awakening"),
        .price = 250, // (I_PRICE >= GEN_2 && I_PRICE <= GEN_6) ? 250 : ((I_PRICE == GEN_7) ? 100 : 200),
        .description = COMPOUND_STRING(
            "Awakens a sleeping\n"
            "Pokémon."),
        .pocket = POCKET_ITEMS,
    ...
    {
        .name = _("Ether"),
        .price = (I_PRICE >= GEN_2) ? 600 : 1, // 2000
        .holdEffectParam = 255,
        .description = COMPOUND_STRING(
            "Fully restores the\n"
            "PP of a selected\n"
    ...
    {
        .name = _("Elixir"),
        .price = (I_PRICE >= GEN_2) ? 2400 : 1, // 4500
        .holdEffectParam = 255,
        .description = COMPOUND_STRING(
            "Fully restores the\n"
            "PP of a Pokémon's\n"
    ...
    [ITEM_SACRED_ASH] =
    {
        ...
        .price = (I_PRICE >= GEN_7) ? 0 : 200, // 50000
        // .importance = 1,
        .description = COMPOUND_STRING(
            "Fully revives and\n"
            "restores all\n"
...
// Vitamins
    ...
    {
        .name = _("HP Up"),
        .price = 1500, // (I_PRICE >= GEN_7) ? 10000 : 9800,
        .description = COMPOUND_STRING(
            "Raises the base HP\n"
            "of one Pokémon."),
        .pocket = POCKET_ITEMS,
    ...
    {
        .name = _("PP Up"),
        .price = 2500, // (I_PRICE == GEN_1) ? 1 : ((I_PRICE >= GEN_7) ? 10000 : 9800),
        .description = COMPOUND_STRING(
            "Raises the maximum\n"
            "PP of a selected\n"
            "move."),
...
// Ability Modifiers
    ...
    [ITEM_ABILITY_CAPSULE] =
    {
        ...
        .price = 45000, // (I_PRICE < GEN_7) ? 1000 : ((I_PRICE < GEN_9) ? 10000 : 100000),
        .holdEffectParam = 0,
        .description = COMPOUND_STRING(
            "Switches a Poké-\n"
            "mon's ability."),
    ...
    [ITEM_ABILITY_PATCH] =
    {
        ...
        .price = 90000, // (I_PRICE >= GEN_9) ? 250000 : 20,
        .holdEffectParam = 0,
        .description = COMPOUND_STRING(
            "Turns the ability\n"
            "of a Pokémon into\n"
...
// Candy
    ...
    [ITEM_RARE_CANDY] =
    {
        ...
        .price = 1000, // (I_PRICE >= GEN_7) ? 10000 : 4800,
        .description = COMPOUND_STRING(
            "Raises the level\n"
            "of a Pokémon by\n"
            "one."),
...
// Encounter Modifiers
    ...
    {
        .name = _("Repel"),
        .price = 300, // (I_PRICE >= GEN_7) ? 400 : 350,
        .holdEffectParam = 100,
        .description = COMPOUND_STRING(
            "Repels weak wild\n"
            "Pokémon for 100\n"
    ...
    {
        .name = _("Super Repel"),
        .price = 550, // (I_PRICE >= GEN_7) ? 700 : 500,
        .holdEffectParam = 175, // 200
        .description = COMPOUND_STRING(
            "Repels weak wild\n"
            "Pokémon for 200\n"
            "steps."),
    ...
    {
        .name = _("Max Repel"),
        .price = 750, // (I_PRICE >= GEN_7) ? 900 : 700,
        .holdEffectParam = 250,
        .description = COMPOUND_STRING(
            "Repels weak wild\n"
            "Pokémon for 250\n"
...
// Treasures
    ...
    [ITEM_HONEY] =
    {
        .name = _("Honey"),
        .pluralName = _("Honey"),
        .price = (I_PRICE < GEN_5) ? 100 : ((I_PRICE < GEN_8) ? 300 : 200),
        .description = COMPOUND_STRING(
            "Sweet honey that\n"
            "attracts wild\n"
            "Pokémon when used."),
