...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_DRAGON_BREATH] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_RANDOM_FROM_LIST,
            .chance = 20,
            .argument.randomMoveEffects = { MOVE_EFFECT_BURN, MOVE_EFFECT_PARALYSIS },
        }),
        .contestEffect = C_UPDATED_MOVE_EFFECTS >= GEN_6 ? CONTEST_EFFECT_STARTLE_PREV_MON : CONTEST_EFFECT_BADLY_STARTLE_PREV_MONS,
        .contestCategory = CONTEST_CATEGORY_COOL,
    ...
    [MOVE_IRON_HEAD] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_FLINCH,
            .chance = B_UPDATED_MOVE_DATA >= GEN_CHAMPIONS ? 40 : 30,
        }),
        .contestEffect = CONTEST_EFFECT_HIGHLY_APPEALING,
        .contestCategory = CONTEST_CATEGORY_TOUGH,
        .contestComboStarterId = 0,
    ...
    [MOVE_ATTACK_ORDER] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_WRAP,
            .argument.wrapped = B_MSG_WRAPPED_ATTACK_ORDER,
        }),
        .contestEffect = CONTEST_EFFECT_REPETITION_NOT_BORING,
        .contestCategory = CONTEST_CATEGORY_SMART,
    ...
    [MOVE_LUNAR_DANCE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Uses moon-power to restore\n"
            "health and raise Sp. Def."),
        .effect = EFFECT_SOFTBOILED,
        .power = 0,
        .type = TYPE_FAIRY,
        .accuracy = 0,
    ...
    [MOVE_NIGHT_DAZE] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_CHAMPIONS ? 100 : 85,
        .type = TYPE_DARK,
        .accuracy = 0,
        .pp = 10,
        .target = TARGET_FOES_AND_ALLY,
    ...
    [MOVE_GEAR_GRIND] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "that strike twice."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_CHAMPIONS ? 75 : 50,
        .type = TYPE_STEEL,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_CHAMPIONS ? 100 : 85,
        .criticalHitStage = 1,
        .pp = 15,
        .target = TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_DRAGON_ASCENT] =
    {
        ...
        .description = COMPOUND_STRING(
            "Strong attack from the sky.\n"
            "Lowers user's Atk sharply."),
        .effect = EFFECT_HIT,
        .power = 150,
        .type = TYPE_DRAGON,
        .accuracy = 100,
    ...
    [MOVE_ANCHOR_SHOT] =
    {
        ...
        .effect = EFFECT_SMACK_DOWN,
        .power = B_UPDATED_MOVE_DATA >= GEN_CHAMPIONS ? 100 : 80,
        .type = TYPE_STEEL,
        .accuracy = 100,
        .pp = 10,
        .target = TARGET_SELECTED,
    ...
    [MOVE_FIRE_LASH] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_CHAMPIONS ? 75 : 80,
        .type = TYPE_FIRE,
        .accuracy = 100,
        .criticalHitStage = 1,
        .pp = 25,
    ...
    [MOVE_TETHER_VINE] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_WRAP,
            .argument.wrapped = B_MSG_WRAPPED_TETHER_VINE,
        },
        {
            .moveEffect = MOVE_EFFECT_STAT_MINUS,
            .speed = 1,
    ...
    [MOVE_BUGGY_TERRAIN] =
    {
        ...
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
        .argument = { .terrainType = B_TERRAIN_BUGGY },
        .zMove = { .effect = Z_EFFECT_SPDEF_UP_1 },
        .ignoresProtect = TRUE,
        .mirrorMoveBanned = TRUE,
        .skyBattleBanned = TRUE,
    ...
    [MOVE_FAULTY_TERRAIN] =
    {
        ...
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
        .argument = { .terrainType = B_TERRAIN_FAULTY },
        .zMove = { .effect = Z_EFFECT_DEF_UP_1 },
        .ignoresProtect = TRUE,
        .mirrorMoveBanned = TRUE,
        .skyBattleBanned = TRUE,
    ...
    [MOVE_SPOOKY_TERRAIN] =
    {
        ...
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
        .argument = { .terrainType = B_TERRAIN_SPOOKY },
        .zMove = { .effect = Z_EFFECT_SPDEF_UP_1 },
        .ignoresProtect = TRUE,
        .mirrorMoveBanned = TRUE,
        .skyBattleBanned = TRUE,
