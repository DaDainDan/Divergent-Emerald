...
const u8 gText_HOFDexRating[] = _("Spotted POKéMON: {STR_VAR_1}!\nOwned POKéMON: {STR_VAR_2}!\pPROF. BIRCH's POKéDEX rating!\p{SPEAKER NAME_BIRCH}Let's see…\p");
...
const u8 gText_IncenseEffectsLingered[] = _("But the effects of an INCENSE\nlingered from earlier.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnCurseHealed[] = _("{STR_VAR_1}'s curse was cleansed.{PAUSE_UNTIL_PRESS}");
