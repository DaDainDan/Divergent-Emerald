...
{   // Corresponds to gHealthboxElementsGfxTable (and the tables after it) in graphics.c
    ...
    HEALTHBOX_GFX_116,
    HEALTHBOX_GFX_117,
    HEALTHBOX_GFX_STATUS_CRS_BATTLER0,  //status crs
    HEALTHBOX_GFX_124,
    HEALTHBOX_GFX_125,
    ...
    HEALTHBOX_GFX_118,
    HEALTHBOX_GFX_119,
    HEALTHBOX_GFX_STATUS_CRS_BATTLER1,  //status2 crs
    HEALTHBOX_GFX_126,
    HEALTHBOX_GFX_127,
    ...
    HEALTHBOX_GFX_120,
    HEALTHBOX_GFX_121,
    HEALTHBOX_GFX_STATUS_CRS_BATTLER2,  //status3 crs
    HEALTHBOX_GFX_128,
    HEALTHBOX_GFX_129,
    ...
    HEALTHBOX_GFX_122,
    HEALTHBOX_GFX_123,
    HEALTHBOX_GFX_STATUS_CRS_BATTLER3,  //status4 crs
    HEALTHBOX_GFX_130,
    HEALTHBOX_GFX_131,
...
static void UpdateStatusIconInHealthbox(u8 healthboxSpriteId)
{
    ...
    {
        statusGfxPtr = GetHealthboxElementGfxPtr(GetStatusIconForBattlerId(HEALTHBOX_GFX_STATUS_CRS_BATTLER0, battler));
        statusPalId = PAL_STATUS_CRS;
    }
    else
    {
...
static u8 GetStatusIconForBattlerId(u8 statusElementId, enum BattlerId battler)
{
    ...
    case HEALTHBOX_GFX_STATUS_BRN_BATTLER0:
        ...
        break;
    case HEALTHBOX_GFX_STATUS_CRS_BATTLER0:
        if (battler == 0)
            ret = HEALTHBOX_GFX_STATUS_CRS_BATTLER0;
        else if (battler == 1)
            ret = HEALTHBOX_GFX_STATUS_CRS_BATTLER1;
        else if (battler == 2)
            ret = HEALTHBOX_GFX_STATUS_CRS_BATTLER2;
        else
            ret = HEALTHBOX_GFX_STATUS_CRS_BATTLER3;
        break;
    }
    return ret;
}
