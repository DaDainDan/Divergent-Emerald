...
static const struct SearchOptionText sDexSearchTypeOptions[] =
{
    ...
    {sText_DexEmptyString, gTypesInfo[TYPE_WIND].name},
    {sText_DexEmptyString, gTypesInfo[TYPE_POISON].name},
    {sText_DexEmptyString, gTypesInfo[TYPE_GROUND].name},
    {sText_DexEmptyString, gTypesInfo[TYPE_TERRA].name},
    {sText_DexEmptyString, gTypesInfo[TYPE_MUD].name},
    {sText_DexEmptyString, gTypesInfo[TYPE_SAND].name},
    ...
    {sText_DexEmptyString, gTypesInfo[TYPE_UNDEAD].name},
    {sText_DexEmptyString, gTypesInfo[TYPE_STEEL].name},
    {sText_DexEmptyString, gTypesInfo[TYPE_FIRE].name},
    {sText_DexEmptyString, gTypesInfo[TYPE_FLAME].name},
    {sText_DexEmptyString, gTypesInfo[TYPE_WATER].name},
    {sText_DexEmptyString, gTypesInfo[TYPE_OCEAN].name},
    ...
    {sText_DexEmptyString, gTypesInfo[TYPE_FROST].name},
...
bool16 HasAllHoennMons(void)
{
    ...
    for (i = 0; i < HOENN_DEX_COUNT - 1; i++)
    {
        ...
        if (!(IsSpeciesLegendaryAny(j) && !gSpeciesInfo[j].dexForceRequired) && !GetSetPokedexFlag(j, FLAG_GET_CAUGHT))
            return FALSE;
    }
    return TRUE;
}
...
bool16 HasAllMons(void)
{
    ...
    for (i = 1; i < NATIONAL_DEX_COUNT + 1; i++)
    {
        ...
        if (!(IsSpeciesLegendaryAny(j) && !gSpeciesInfo[j].dexForceRequired) && !GetSetPokedexFlag(i, FLAG_GET_CAUGHT))
            return FALSE;
    }
