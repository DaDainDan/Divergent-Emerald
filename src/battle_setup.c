...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_GISELLE] = REMATCH(TRAINER_GISELLE_1, TRAINER_GISELLE_2, SKIP, TRAINER_GISELLE_3, SKIP, TRAINER_GISELLE_4, MAP_ROUTE104),

    // Wattson Split
    [REMATCH_KAREN] = REMATCH(TRAINER_KAREN_1, SKIP, TRAINER_KAREN_2, TRAINER_KAREN_3, SKIP, TRAINER_KAREN_4, MAP_ROUTE116),
    [REMATCH_NICOLE] = REMATCH(TRAINER_NICOLE_1, SKIP, TRAINER_NICOLE_2, TRAINER_NICOLE_3, SKIP, TRAINER_NICOLE_4, MAP_ROUTE116),
    ...
    [REMATCH_KELLY] = REMATCH(TRAINER_KELLY_1, SKIP, TRAINER_KELLY_2, TRAINER_KELLY_3, TRAINER_KELLY_4, TRAINER_KELLY_5, MAP_ROUTE110),
    ...
    [REMATCH_KIRA_AND_DAN] = REMATCH(TRAINER_KIRA_AND_DAN_1, SKIP, SKIP, TRAINER_KIRA_AND_DAN_2, TRAINER_KIRA_AND_DAN_3, TRAINER_KIRA_AND_DAN_4, MAP_ABANDONED_SHIP_ROOMS2_1F),
    ...
    [REMATCH_OSCAR] = REMATCH(TRAINER_OSCAR_1, SKIP, SKIP, SKIP, TRAINER_OSCAR_2, TRAINER_OSCAR_3, MAP_ROUTE115),
    ...
    [REMATCH_SERGIO] = REMATCH(TRAINER_SERGIO_1, SKIP, SKIP, SKIP, SKIP, TRAINER_SERGIO_2, MAP_METEOR_FALLS_1F_2R), // REMOVE?
    ...
    [REMATCH_TATE_AND_LIZA] = REMATCH(TRAINER_TATE_AND_LIZA_1, TRAINER_TATE, TRAINER_LIZA, TRAINER_TATE_AND_LIZA_2, TRAINER_TATE_2, TRAINER_LIZA_2, MAP_MOSSDEEP_CITY),
