...
#define REMATCH(trainer1, trainer2, trainer3, trainer4, trainer5, trainer6, map)  \
{                                                                                 \
    .trainerIds = {trainer1, trainer2, trainer3, trainer4, trainer5, trainer6},   \
    .mapGroup = MAP_GROUP(map),                                                   \
    .mapNum = MAP_NUM(map),                                                       \
}

// REMATCH( INITIAL BATTLE,   GET VS. SEEKER,   BEAT FLANNERY,   BEAT NORMAN,   BEAT ARCHIE,   POST-GAME )

const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    // Roxanne Split
    [REMATCH_CALVIN] = REMATCH(TRAINER_CALVIN_1, TRAINER_CALVIN_2, SKIP, TRAINER_CALVIN_3, SKIP, TRAINER_CALVIN_4, MAP_ROUTE101),

    // REMATCH_LANDON

    [REMATCH_JAMES] = REMATCH(TRAINER_JAMES_1, TRAINER_JAMES_2, SKIP, TRAINER_JAMES_3, SKIP, TRAINER_JAMES_4, MAP_PETALBURG_WOODS),

    [REMATCH_CINDY] = REMATCH(TRAINER_CINDY_1, TRAINER_CINDY_2, SKIP, TRAINER_CINDY_3, SKIP, TRAINER_CINDY_4, MAP_ROUTE104),
    [REMATCH_WINSTON] = REMATCH(TRAINER_WINSTON_1, TRAINER_WINSTON_2, SKIP, TRAINER_WINSTON_3, SKIP, TRAINER_WINSTON_4, MAP_ROUTE104),
    [REMATCH_HALEY] = REMATCH(TRAINER_HALEY_1, TRAINER_HALEY_2, SKIP, TRAINER_HALEY_3, SKIP, TRAINER_HALEY_4, MAP_ROUTE104),

    // Wattson Split
    [REMATCH_KAREN] = REMATCH(TRAINER_KAREN_1, SKIP, TRAINER_KAREN_2, TRAINER_KAREN_3, SKIP, TRAINER_KAREN_4, MAP_ROUTE116),
    [REMATCH_JERRY] = REMATCH(TRAINER_JERRY_1, SKIP, TRAINER_JERRY_2, TRAINER_JERRY_3, SKIP, TRAINER_JERRY_4, MAP_ROUTE116),

    [REMATCH_MIGUEL] = REMATCH(TRAINER_MIGUEL_1, SKIP, TRAINER_MIGUEL_2, TRAINER_MIGUEL_3, TRAINER_MIGUEL_4, TRAINER_MIGUEL_5, MAP_ROUTE103),
    [REMATCH_AMY_AND_LIV] = REMATCH(TRAINER_AMY_AND_LIV_1, SKIP, TRAINER_AMY_AND_LIV_2, TRAINER_AMY_AND_LIV_3, TRAINER_AMY_AND_LIV_4, TRAINER_AMY_AND_LIV_5, MAP_ROUTE103),

    [REMATCH_ISABEL] = REMATCH(TRAINER_ISABEL_1, SKIP, TRAINER_ISABEL_2, TRAINER_ISABEL_3, TRAINER_ISABEL_4, TRAINER_ISABEL_5, MAP_ROUTE110),
    [REMATCH_EDWIN] = REMATCH(TRAINER_EDWIN_1, SKIP, TRAINER_EDWIN_2, TRAINER_EDWIN_3, TRAINER_EDWIN_4, TRAINER_EDWIN_5, MAP_ROUTE110),

    [REMATCH_ROSE] = REMATCH(TRAINER_ROSE_1, SKIP, TRAINER_ROSE_2, TRAINER_ROSE_3, TRAINER_ROSE_4, TRAINER_ROSE_5, MAP_ROUTE118),
    [REMATCH_DALTON] = REMATCH(TRAINER_DALTON_1, SKIP, TRAINER_DALTON_2, TRAINER_DALTON_3, TRAINER_DALTON_4, TRAINER_DALTON_5, MAP_ROUTE118),

    // Flannery Split
    [REMATCH_ANNA_AND_MEG] = REMATCH(TRAINER_ANNA_AND_MEG_1, SKIP, TRAINER_ANNA_AND_MEG_2, TRAINER_ANNA_AND_MEG_3, TRAINER_ANNA_AND_MEG_4, TRAINER_ANNA_AND_MEG_5, MAP_ROUTE117),
    [REMATCH_MARIA] = REMATCH(TRAINER_MARIA_1, SKIP, TRAINER_MARIA_2, TRAINER_MARIA_3, TRAINER_MARIA_4, TRAINER_MARIA_5, MAP_ROUTE117),
    [REMATCH_LYDIA] = REMATCH(TRAINER_LYDIA_1, SKIP, TRAINER_LYDIA_2, TRAINER_LYDIA_3, TRAINER_LYDIA_4, TRAINER_LYDIA_5, MAP_ROUTE117),
    [REMATCH_ISAAC] = REMATCH(TRAINER_ISAAC_1, SKIP, TRAINER_ISAAC_2, TRAINER_ISAAC_3, TRAINER_ISAAC_4, TRAINER_ISAAC_5, MAP_ROUTE117),
    [REMATCH_DYLAN] = REMATCH(TRAINER_DYLAN_1, SKIP, TRAINER_DYLAN_2, TRAINER_DYLAN_3, TRAINER_DYLAN_4, TRAINER_DYLAN_5, MAP_ROUTE117),

    [REMATCH_TRENT] = REMATCH(TRAINER_TRENT_1, SKIP, SKIP, TRAINER_TRENT_2, TRAINER_TRENT_3, TRAINER_TRENT_4, MAP_ROUTE112),

    [REMATCH_SHELBY] = REMATCH(TRAINER_SHELBY_1, SKIP, SKIP, TRAINER_SHELBY_2, TRAINER_SHELBY_3, TRAINER_SHELBY_4, MAP_MT_CHIMNEY),
    [REMATCH_SAWYER] = REMATCH(TRAINER_SAWYER_1, SKIP, SKIP, TRAINER_SAWYER_2, TRAINER_SAWYER_3, TRAINER_SAWYER_4, MAP_MT_CHIMNEY),

    [REMATCH_ETHAN] = REMATCH(TRAINER_ETHAN_1, SKIP, SKIP, TRAINER_ETHAN_2, TRAINER_ETHAN_3, TRAINER_ETHAN_4, MAP_JAGGED_PASS),
    [REMATCH_DIANA] = REMATCH(TRAINER_DIANA_1, SKIP, SKIP, TRAINER_DIANA_2, TRAINER_DIANA_3, TRAINER_DIANA_4, MAP_JAGGED_PASS),

    // Winona Split
    [REMATCH_DUSTY] = REMATCH(TRAINER_DUSTY_1, SKIP, SKIP, TRAINER_DUSTY_2, TRAINER_DUSTY_3, TRAINER_DUSTY_4, MAP_ROUTE111),

    [REMATCH_CATHERINE] = REMATCH(TRAINER_CATHERINE_1, SKIP, SKIP, TRAINER_CATHERINE_2, TRAINER_CATHERINE_3, TRAINER_CATHERINE_4, MAP_ROUTE119),
    [REMATCH_JACKSON] = REMATCH(TRAINER_JACKSON_1, SKIP, SKIP, TRAINER_JACKSON_2, TRAINER_JACKSON_3, TRAINER_JACKSON_4, MAP_ROUTE119),

    // Norman Split
    [REMATCH_BROOKE] = REMATCH(TRAINER_BROOKE_1, SKIP, SKIP, SKIP, TRAINER_BROOKE_2, TRAINER_BROOKE_3, MAP_ROUTE111),
    [REMATCH_WILTON] = REMATCH(TRAINER_WILTON_1, SKIP, SKIP, SKIP, TRAINER_WILTON_2, TRAINER_WILTON_3, MAP_ROUTE111),

    [REMATCH_LAO] = REMATCH(TRAINER_LAO_1, SKIP, SKIP, SKIP, TRAINER_LAO_2, TRAINER_LAO_3, MAP_ROUTE113),
    [REMATCH_MADELINE] = REMATCH(TRAINER_MADELINE_1, SKIP, SKIP, SKIP, TRAINER_MADELINE_2, TRAINER_MADELINE_3, MAP_ROUTE113),

    [REMATCH_STEVE] = REMATCH(TRAINER_STEVE_1, SKIP, SKIP, SKIP, TRAINER_STEVE_2, TRAINER_STEVE_3, MAP_ROUTE114),
    [REMATCH_BERNIE] = REMATCH(TRAINER_BERNIE_1, SKIP, SKIP, SKIP, TRAINER_BERNIE_2, TRAINER_BERNIE_3, MAP_ROUTE114),

    [REMATCH_NOB] = REMATCH(TRAINER_NOB_1, SKIP, SKIP, SKIP, TRAINER_NOB_2, TRAINER_NOB_3, MAP_ROUTE115),
    [REMATCH_TIMOTHY] = REMATCH(TRAINER_TIMOTHY_1, SKIP, SKIP, SKIP, TRAINER_TIMOTHY_2, TRAINER_TIMOTHY_3, MAP_ROUTE115),
    [REMATCH_CYNDY] = REMATCH(TRAINER_CYNDY_1, SKIP, SKIP, SKIP, TRAINER_CYNDY_2, TRAINER_CYNDY_3, MAP_ROUTE115),

    // Brawly Split
    [REMATCH_ANDRES] = REMATCH(TRAINER_ANDRES_1, SKIP, SKIP, SKIP, TRAINER_ANDRES_2, TRAINER_ANDRES_3, MAP_ROUTE105),

    [REMATCH_ELLIOT] = REMATCH(TRAINER_ELLIOT_1, SKIP, SKIP, SKIP, TRAINER_ELLIOT_2, TRAINER_ELLIOT_3, MAP_ROUTE106),

    [REMATCH_TONY] = REMATCH(TRAINER_TONY_1, SKIP, SKIP, SKIP, TRAINER_TONY_2, TRAINER_TONY_3, MAP_ROUTE107),

    [REMATCH_CORY] = REMATCH(TRAINER_CORY_1, SKIP, SKIP, SKIP, TRAINER_CORY_2, TRAINER_CORY_3, MAP_ROUTE108),

    [REMATCH_THALIA] = REMATCH(TRAINER_THALIA_1, SKIP, SKIP, SKIP, TRAINER_THALIA_2, TRAINER_THALIA_3, MAP_ABANDONED_SHIP_ROOMS_1F),
    [REMATCH_KIRA_AND_DAN] = REMATCH(TRAINER_KIRA_AND_DAN_1, SKIP, SKIP, SKIP, TRAINER_KIRA_AND_DAN_2, TRAINER_KIRA_AND_DAN_3, MAP_ABANDONED_SHIP_ROOMS2_1F),

    [REMATCH_LOLA] = REMATCH(TRAINER_LOLA_1, SKIP, SKIP, SKIP, TRAINER_LOLA_2, TRAINER_LOLA_3, MAP_ROUTE109),
    [REMATCH_RICKY] = REMATCH(TRAINER_RICKY_1, SKIP, SKIP, SKIP, TRAINER_RICKY_2, TRAINER_RICKY_3, MAP_ROUTE109),

    [REMATCH_ABIGAIL] = REMATCH(TRAINER_ABIGAIL_1, SKIP, SKIP, SKIP, TRAINER_ABIGAIL_2, TRAINER_ABIGAIL_3, MAP_ROUTE110),
    [REMATCH_BENJAMIN] = REMATCH(TRAINER_BENJAMIN_1, SKIP, SKIP, SKIP, TRAINER_BENJAMIN_2, TRAINER_BENJAMIN_3, MAP_ROUTE110),
    
    // Tate & Liza Split
    [REMATCH_JEFFREY] = REMATCH(TRAINER_JEFFREY_1, SKIP, SKIP, SKIP, TRAINER_JEFFREY_2, TRAINER_JEFFREY_3, MAP_ROUTE120),
    [REMATCH_ROBERT] = REMATCH(TRAINER_ROBERT_1, SKIP, SKIP, SKIP, TRAINER_ROBERT_2, TRAINER_ROBERT_3, MAP_ROUTE120),

    [REMATCH_CRISTIN] = REMATCH(TRAINER_CRISTIN_1, SKIP, SKIP, SKIP, TRAINER_CRISTIN_2, TRAINER_CRISTIN_3, MAP_ROUTE121),
    [REMATCH_JESSICA] = REMATCH(TRAINER_JESSICA_1, SKIP, SKIP, SKIP, TRAINER_JESSICA_2, TRAINER_JESSICA_3, MAP_ROUTE121),
    [REMATCH_WALTER] = REMATCH(TRAINER_WALTER_1, SKIP, SKIP, SKIP, TRAINER_WALTER_2, TRAINER_WALTER_3, MAP_ROUTE121),

    [REMATCH_GABRIELLE] = REMATCH(TRAINER_GABRIELLE_1, SKIP, SKIP, SKIP, TRAINER_GABRIELLE_2, TRAINER_GABRIELLE_3, MAP_MT_PYRE_3F),
    [REMATCH_VALERIE] = REMATCH(TRAINER_VALERIE_1, SKIP, SKIP, SKIP, TRAINER_VALERIE_2, TRAINER_VALERIE_3, MAP_MT_PYRE_6F),

    [REMATCH_FERNANDO] = REMATCH(TRAINER_FERNANDO_1, SKIP, SKIP, SKIP, TRAINER_FERNANDO_2, TRAINER_FERNANDO_3, MAP_ROUTE123),
    [REMATCH_CAMERON] = REMATCH(TRAINER_CAMERON_1, SKIP, SKIP, SKIP, TRAINER_CAMERON_2, TRAINER_CAMERON_3, MAP_ROUTE123),
    [REMATCH_JACKI] = REMATCH(TRAINER_JACKI_1, SKIP, SKIP, SKIP, TRAINER_JACKI_2, TRAINER_JACKI_3, MAP_ROUTE123),

    [REMATCH_LILA_AND_ROY] = REMATCH(TRAINER_LILA_AND_ROY_1, SKIP, SKIP, SKIP, TRAINER_LILA_AND_ROY_2, TRAINER_LILA_AND_ROY_3, MAP_ROUTE124),
    [REMATCH_JENNY] = REMATCH(TRAINER_JENNY_1, SKIP, SKIP, SKIP, TRAINER_JENNY_2, TRAINER_JENNY_3, MAP_ROUTE124),

    [REMATCH_ERNEST] = REMATCH(TRAINER_ERNEST_1, SKIP, SKIP, SKIP, TRAINER_ERNEST_2, TRAINER_ERNEST_3, MAP_ROUTE125),

    // Juan / Endgame
    [REMATCH_PABLO] = REMATCH(TRAINER_PABLO_1, SKIP, SKIP, SKIP, TRAINER_PABLO_2, TRAINER_PABLO_3, MAP_ROUTE126),

    [REMATCH_KOJI] = REMATCH(TRAINER_KOJI_1, SKIP, SKIP, SKIP, TRAINER_KOJI_2, TRAINER_KOJI_3, MAP_ROUTE127),

    [REMATCH_ISAIAH] = REMATCH(TRAINER_ISAIAH_1, SKIP, SKIP, SKIP, TRAINER_ISAIAH_2, TRAINER_ISAIAH_3, MAP_ROUTE128),
    [REMATCH_KATELYN] = REMATCH(TRAINER_KATELYN_1, SKIP, SKIP, SKIP, TRAINER_KATELYN_2, TRAINER_KATELYN_3, MAP_ROUTE128),

    [REMATCH_JOHN_AND_JAY] = REMATCH(TRAINER_JOHN_AND_JAY_1, SKIP, SKIP, SKIP, SKIP, TRAINER_JOHN_AND_JAY_2, MAP_METEOR_FALLS_1F_2R), // REMOVE?
    [REMATCH_NICOLAS] = REMATCH(TRAINER_NICOLAS_1, SKIP, SKIP, SKIP, SKIP, TRAINER_NICOLAS_2, MAP_METEOR_FALLS_1F_2R), // REMOVE?

    // Special Trainers
    [REMATCH_WALLY_VR] = REMATCH(TRAINER_WALLY_VR_2, TRAINER_WALLY_VR_3, TRAINER_WALLY_VR_4, TRAINER_WALLY_VR_5, TRAINER_WALLY_VR_5, TRAINER_WALLY_VR_5, MAP_VICTORY_ROAD_1F),
    [REMATCH_ROXANNE] = REMATCH(TRAINER_ROXANNE_1, TRAINER_ROXANNE_2, TRAINER_ROXANNE_3, TRAINER_ROXANNE_4, TRAINER_ROXANNE_3, TRAINER_ROXANNE_4, MAP_RUSTBORO_CITY),
    [REMATCH_BRAWLY] = REMATCH(TRAINER_BRAWLY_1, TRAINER_BRAWLY_2, TRAINER_BRAWLY_3, TRAINER_BRAWLY_4, TRAINER_BRAWLY_3, TRAINER_BRAWLY_4, MAP_DEWFORD_TOWN),
    [REMATCH_WATTSON] = REMATCH(TRAINER_WATTSON_1, TRAINER_WATTSON_2, TRAINER_WATTSON_3, TRAINER_WATTSON_4, TRAINER_WATTSON_3, TRAINER_WATTSON_4, MAP_MAUVILLE_CITY),
    [REMATCH_FLANNERY] = REMATCH(TRAINER_FLANNERY_1, TRAINER_FLANNERY_2, TRAINER_FLANNERY_3, TRAINER_FLANNERY_4, TRAINER_FLANNERY_3, TRAINER_FLANNERY_4, MAP_LAVARIDGE_TOWN),
    [REMATCH_NORMAN] = REMATCH(TRAINER_NORMAN_1, TRAINER_NORMAN_2, TRAINER_NORMAN_3, TRAINER_NORMAN_4, TRAINER_NORMAN_3, TRAINER_NORMAN_4, MAP_PETALBURG_CITY),
    [REMATCH_WINONA] = REMATCH(TRAINER_WINONA_1, TRAINER_WINONA_2, TRAINER_WINONA_3, TRAINER_WINONA_4, TRAINER_WINONA_3, TRAINER_WINONA_4, MAP_FORTREE_CITY),
    [REMATCH_TATE_AND_LIZA] = REMATCH(TRAINER_TATE_AND_LIZA_1, TRAINER_TATE_AND_LIZA_2, TRAINER_TATE_AND_LIZA_3, TRAINER_TATE_AND_LIZA_4, TRAINER_TATE_AND_LIZA_3, TRAINER_TATE_AND_LIZA_4, MAP_MOSSDEEP_CITY),
    [REMATCH_JUAN] = REMATCH(TRAINER_JUAN_1, TRAINER_JUAN_2, TRAINER_JUAN_3, TRAINER_JUAN_4, TRAINER_JUAN_3, TRAINER_JUAN_4, MAP_SOOTOPOLIS_CITY),

    [REMATCH_SIDNEY] = REMATCH(TRAINER_SIDNEY, TRAINER_SIDNEY, TRAINER_SIDNEY, TRAINER_SIDNEY, TRAINER_SIDNEY, TRAINER_SIDNEY, MAP_EVER_GRANDE_CITY),
    [REMATCH_PHOEBE] = REMATCH(TRAINER_PHOEBE, TRAINER_PHOEBE, TRAINER_PHOEBE, TRAINER_PHOEBE, TRAINER_PHOEBE, TRAINER_PHOEBE, MAP_EVER_GRANDE_CITY),
    [REMATCH_GLACIA] = REMATCH(TRAINER_GLACIA, TRAINER_GLACIA, TRAINER_GLACIA, TRAINER_GLACIA, TRAINER_GLACIA, TRAINER_GLACIA, MAP_EVER_GRANDE_CITY),
    [REMATCH_DRAKE] = REMATCH(TRAINER_DRAKE, TRAINER_DRAKE, TRAINER_DRAKE, TRAINER_DRAKE, TRAINER_DRAKE, TRAINER_DRAKE, MAP_EVER_GRANDE_CITY),
    [REMATCH_WALLACE] = REMATCH(TRAINER_WALLACE, TRAINER_WALLACE, TRAINER_WALLACE, TRAINER_WALLACE, TRAINER_WALLACE, TRAINER_WALLACE, MAP_EVER_GRANDE_CITY),
};
...
{
    CreateMaleMon(&gParties[B_TRAINER_OPPONENT_A][0], SPECIES_RALTS, 6);
    LockPlayerFieldControls();
...
s32 TrainerIdToRematchTableId(const struct RematchTrainer *table, u16 trainerId)
{
    ...
    for (i = 0; i < REMATCH_TABLE_ENTRIES; i++)
    {
        for (j = 0; j < REMATCHES_COUNT; j++)
        {
            ...
            if (table[i].trainerIds[j] == SKIP) continue;
...
u16 GetRematchTrainerIdFromTable(const struct RematchTrainer *table, u16 firstBattleTrainerId)
{
    ...
    lastValidId = trainerEntry->trainerIds[0];
    for (i = 1; i < REMATCHES_COUNT; i++)
    {
        if (trainerEntry->trainerIds[i] == 0)
            return lastValidId;
        if (trainerEntry->trainerIds[i] == SKIP)
            continue;
        if (!HasTrainerBeenFought(trainerEntry->trainerIds[i]))
            return trainerEntry->trainerIds[i];
        lastValidId = trainerEntry->trainerIds[i];
    }

    return lastValidId; // already beaten at max stage
}
...
static bool8 WasSecondRematchWon(const struct RematchTrainer *table, u16 firstBattleTrainerId)
{
    ...
    // Find the first real (non-SKIP) rematch slot and check if it's been fought
    for (i = 1; i < REMATCHES_COUNT; i++)
    {
        if (table[tableId].trainerIds[i] == 0)
            return FALSE;
        if (table[tableId].trainerIds[i] == SKIP)
            continue;
        if (!HasTrainerBeenFought(table[tableId].trainerIds[i]))
            return FALSE;
        break;
    }
...
u16 CountBattledRematchTeams(u16 trainerId)
{
    ...
    for (u32 i = 1; i < REMATCHES_COUNT; i++)
    {
        if (gRematchTable[trainerId].trainerIds[i] == 0)
            return i;
        if (gRematchTable[trainerId].trainerIds[i] == SKIP)
            continue;
