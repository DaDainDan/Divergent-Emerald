...
const struct FacilityClass gTowerMaleFacilityClasses[FACILITY_CLASSES_MALE] =
{
    ...
    {FACILITY_CLASS_POKEMANIAC, OBJ_EVENT_GFX_MAN_5},
    ...
    {FACILITY_CLASS_KINDLER, OBJ_EVENT_GFX_BLACK_BELT},
    ...
    {FACILITY_CLASS_SCHOOL_KID_M, OBJ_EVENT_GFX_LITTLE_BOY_3},
    ...
    {FACILITY_CLASS_BIRD_KEEPER, OBJ_EVENT_GFX_MAN_3},
...
const struct FacilityClass gTowerFemaleFacilityClasses[FACILITY_CLASSES_FEMALE] =
{
    ...
    {FACILITY_CLASS_PSYCHIC_F, OBJ_EVENT_GFX_PSYCHIC_M},
    {FACILITY_CLASS_SCHOOL_KID_F, OBJ_EVENT_GFX_TWIN},
    ...
    {FACILITY_CLASS_PKMN_BREEDER_F, OBJ_EVENT_GFX_GIRL_2},
